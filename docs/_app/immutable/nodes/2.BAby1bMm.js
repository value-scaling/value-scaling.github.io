...
var Li = (a, e, t) =>
  e in a
    ? qi(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (a[e] = t);
var he = (a, e, t) => (Li(a, typeof e != "symbol" ? e + "" : e, t), t),
  Fi = (a, e, t) => {
...
var nt = (a, e, t) => (Fi(a, e, "access private method"), t);
import {
  s as T0,
  n as Fe,
  o as bt,
...
import { e as Je, u as nn, o as sn } from "../chunks/each.BXdS67XN.js";
import { p as Vi } from "../chunks/stores.BMNdcd62.js";
var ln = "Compute-Optimal Scaling for Value-Based Deep RL",
  on = "https://arxiv.org/abs/2508.14881",
  un = new Date(17518464e5),
  hn = !0,
  cn = "/assets/images/model_scaling_before.png",
  mn = "/assets/images/model_scaling_3d.mp4",
  dn = [
  ...
  fn = `[Preston Fu](https://www.prestonfu.com/)\\*,
...
var gn = "Value-Based Deep RL Scales Predictably",
  vn = "https://arxiv.org/abs/2502.04327",
  bn = new Date(17388e8),
  yn = !0,
  wn = "/assets/images/qscaled_before.png",
  xn = "/assets/images/qscaled_after.gif",
  kn = [
  ...
  Sn = `[Oleh Rybkin](https://olehrybkin.com/),
[Michal Nauman](https://scholar.google.com/citations?user=GnEVRtQAAAAJ&hl=en),
...
function Yi(a) {
  ...
  return (
    (document.title = e = a[0]),
    {
      ...
      l(s) {
        const o = Ui("svelte-1u7ey3", document.head);
      ...
      h() {
        E(t, "name", "description"),
          E(t, "content", a[2]),
          E(r, "property", "og:title"),
          E(r, "content", (n = a[1] ?? a[0])),
          E(i, "property", "og:description"),
          E(i, "content", a[2]);
      },
      m(s, o) {
...
class Wi extends A0 {
  constructor(e) {
    super(), D0(this, e, Xi, Yi, T0, { title: 0, ogTitle: 1, description: 2 });
  }
}
class Re {
  constructor(e, t, r) {
...
var Zi = function (e, t) {
  ...
  Qi = /([A-Z])/g,
  Ki = function (e) {
    return e.replace(Qi, "-$1").toLowerCase();
  },
  es = { "&": "&amp;", ">": "&gt;", "<": "&lt;", '"': "&quot;", "'": "&#x27;" },
  ts = /[&><"']/g;
function rs(a) {
  return String(a).replace(ts, (e) => es[e]);
}
var Mn = function a(e) {
  ...
  constructor(e) {
    ...
    for (var t in gt)
      if (gt.hasOwnProperty(t)) {
        var r = gt[t];
        this[t] =
          e[t] !== void 0 ? (r.processor ? r.processor(e[t]) : e[t]) : ss(r);
      }
  }
...
class c0 {
  ...
  sup() {
    return je[ls[this.id]];
  }
  sub() {
    return je[os[this.id]];
  }
  fracNum() {
    return je[us[this.id]];
  }
  fracDen() {
    return je[hs[this.id]];
  }
  cramp() {
    return je[cs[this.id]];
  }
  text() {
    return je[ms[this.id]];
  }
  isTight() {
    return this.size >= 2;
  }
...
var zr = 0,
  ...
  ls = [Y0, qe, Y0, qe, $0, Te, $0, Te],
  os = [qe, qe, qe, qe, Te, Te, Te, Te],
  us = [E0, a0, Y0, qe, $0, Te, $0, Te],
  hs = [a0, a0, qe, qe, Te, Te, Te, Te],
  cs = [wt, wt, a0, a0, qe, qe, Te, Te],
  ms = [zr, wt, E0, a0, E0, a0, E0, a0],
  G = { DISPLAY: je[zr], TEXT: je[E0], SCRIPT: je[Y0], SCRIPTSCRIPT: je[$0] },
  sr = [
    {
      name: "latin",
      blocks: [
...
function ds(a) {
  for (var e = 0; e < sr.length; e++)
    for (var t = sr[e], r = 0; r < t.blocks.length; r++) {
      var n = t.blocks[r];
...
var vt = [];
sr.forEach((a) => a.blocks.forEach((e) => vt.push(...e)));
function Tn(a) {
  for (var e = 0; e < vt.length; e += 2)
    if (a >= vt[e] && a <= vt[e + 1]) return !0;
  return !1;
}
var R0 = 80,
  fs = function (e, t) {
...
function Mr(a, e, t) {
  if (!Ye[e]) throw new Error("Font metrics not found for font: " + e + ".");
  var r = a.charCodeAt(0),
    n = Ye[e][r];
  if (
    (!n && a[0] in ta && ((r = ta[a[0]].charCodeAt(0)), (n = Ye[e][r])),
    !n && t === "text" && Tn(r) && (n = Ye[e][77]),
    n)
  )
...
function Ms(a) {
  var e;
  if ((a >= 5 ? (e = 0) : a >= 3 ? (e = 1) : (e = 2), !Ht[e])) {
    var t = (Ht[e] = { cssEmPerMu: it.quad[e] / 18 });
    for (var r in it) it.hasOwnProperty(r) && (t[r] = it[r][e]);
  }
  return Ht[e];
}
var Ts = [
  ...
  aa = function (e, t) {
    return t.size < 2 ? e : Ts[e - 1][t.size - 1];
  };
class r0 {
  constructor(e) {
    (this.style = void 0),
  ...
  havingStyle(e) {
    return this.style === e
      ? this
      : this.extend({ style: e, size: aa(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  havingSize(e) {
    return this.size === e && this.textSize === e
      ...
      : this.extend({
          ...
          size: e,
          textSize: e,
          sizeMultiplier: ra[e - 1],
        });
  }
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = aa(r0.BASESIZE, e);
  ...
  fontMetrics() {
    return (
      this._fontMetrics || (this._fontMetrics = Ms(this.size)),
      this._fontMetrics
    );
  }
  getColor() {
...
var lr = {
  ...
  An = function (e) {
    return (
      typeof e != "string" && (e = e.unit), e in lr || e in As || e === "ex"
    );
  },
  de = function (e, t) {
    var r;
    if (e.unit in lr)
      r = lr[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier;
      ...
      else throw new B("Invalid unit: '" + e.unit + "'");
  ...
  Bn = function (e) {
    var t = "<" + e;
    this.classes.length && (t += ' class="' + P.escape(f0(this.classes)) + '"');
    var r = "";
    for (var n in this.style)
      this.style.hasOwnProperty(n) &&
        (r += P.hyphenate(n) + ":" + this.style[n] + ";");
    r && (t += ' style="' + P.escape(r) + '"');
    for (var i in this.attributes)
      if (this.attributes.hasOwnProperty(i)) {
        if (Ds.test(i)) throw new B("Invalid attribute name '" + i + "'");
        t += " " + i + '="' + P.escape(this.attributes[i]) + '"';
      }
    t += ">";
...
class J0 {
  ...
  toNode() {
    return _n.call(this, "span");
  }
  toMarkup() {
    return Bn.call(this, "span");
  }
}
class Tr {
  constructor(e, t, r, n) {
...
class _s {
  ...
  toMarkup() {
    var e =
        ...
        P.escape(this.src) +
        '"' +
        (' alt="' + P.escape(this.alt) + '"'),
      t = "";
    for (var r in this.style)
      this.style.hasOwnProperty(r) &&
        (t += P.hyphenate(r) + ":" + this.style[r] + ";");
    return t && (e += ' style="' + P.escape(t) + '"'), (e += "'/>"), e;
  }
}
var Bs = { î: "ı̂", ï: "ı̈", í: "ı́", ì: "ı̀" };
class Oe {
  constructor(e, t, r, n, i, s, o, u) {
    (this.text = void 0),
      ...
      (this.style = u || {}),
      (this.maxFontSize = 0);
    var m = ds(this.text.charCodeAt(0));
    m && this.classes.push(m + "_fallback"),
      /[îïíì]/.test(this.text) && (this.text = Bs[this.text]);
  }
  hasClass(e) {
    return P.contains(this.classes, e);
  }
  toNode() {
    ...
    this.italic > 0 &&
      ...
      (t.style.marginRight = R(this.italic))),
  ...
  toMarkup() {
    ...
    for (var n in this.style)
      this.style.hasOwnProperty(n) &&
        (r += P.hyphenate(n) + ":" + this.style[n] + ";");
    r && ((e = !0), (t += ' style="' + P.escape(r) + '"'));
    var i = P.escape(this.text);
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        (e += " " + t + '="' + P.escape(this.attributes[t]) + '"');
    e += ">";
  ...
  toNode() {
    ...
    return (
      this.alternate
        ...
        : t.setAttribute("d", ea[this.pathName]),
      t
    );
  }
  toMarkup() {
    return this.alternate
      ? '<path d="' + P.escape(this.alternate) + '"/>'
      : '<path d="' + P.escape(ea[this.pathName]) + '"/>';
  }
}
class or {
  constructor(e) {
...
function Cs(a) {
  if (a instanceof J0) return a;
  throw new Error("Expected span<HtmlDomNode> but got " + String(a) + ".");
}
var Rs = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
...
l(h, c, b, "⋈", "\\bowtie", !0);
l(h, c, b, "⌣", "\\smile", !0);
l(h, c, b, "⊑", "\\sqsubseteq", !0);
l(h, c, b, "⊒", "\\sqsupseteq", !0);
l(h, c, b, "≐", "\\doteq", !0);
l(h, c, b, "⌢", "\\frown", !0);
l(h, c, b, "∋", "\\ni", !0);
l(h, c, b, "∝", "\\propto", !0);
...
l(h, c, L, "⨿", "\\amalg");
l(h, c, L, "&", "\\And");
l(h, c, b, "⟵", "\\longleftarrow", !0);
l(h, c, b, "⇐", "\\Leftarrow", !0);
l(h, c, b, "⟸", "\\Longleftarrow", !0);
l(h, c, b, "⟶", "\\longrightarrow", !0);
l(h, c, b, "⇒", "\\Rightarrow", !0);
l(h, c, b, "⟹", "\\Longrightarrow", !0);
l(h, c, b, "↔", "\\leftrightarrow", !0);
l(h, c, b, "⟷", "\\longleftrightarrow", !0);
l(h, c, b, "⇔", "\\Leftrightarrow", !0);
l(h, c, b, "⟺", "\\Longleftrightarrow", !0);
l(h, c, b, "↦", "\\mapsto", !0);
l(h, c, b, "⟼", "\\longmapsto", !0);
l(h, c, b, "↗", "\\nearrow", !0);
l(h, c, b, "↩", "\\hookleftarrow", !0);
l(h, c, b, "↪", "\\hookrightarrow", !0);
l(h, c, b, "↘", "\\searrow", !0);
l(h, c, b, "↼", "\\leftharpoonup", !0);
l(h, c, b, "⇀", "\\rightharpoonup", !0);
l(h, c, b, "↙", "\\swarrow", !0);
l(h, c, b, "↽", "\\leftharpoondown", !0);
l(h, c, b, "⇁", "\\rightharpoondown", !0);
l(h, c, b, "↖", "\\nwarrow", !0);
l(h, c, b, "⇌", "\\rightleftharpoons", !0);
l(h, v, b, "≮", "\\nless", !0);
l(h, v, b, "", "\\@nleqslant");
l(h, v, b, "", "\\@nleqq");
l(h, v, b, "⪇", "\\lneq", !0);
...
l(h, v, b, "⋬", "\\ntrianglelefteq", !0);
l(h, v, b, "⊊", "\\subsetneq", !0);
l(h, v, b, "", "\\@varsubsetneq");
l(h, v, b, "⫋", "\\subsetneqq", !0);
l(h, v, b, "", "\\@varsubsetneqq");
l(h, v, b, "≯", "\\ngtr", !0);
l(h, v, b, "", "\\@ngeqslant");
l(h, v, b, "", "\\@ngeqq");
l(h, v, b, "⪈", "\\gneq", !0);
...
l(h, v, b, "⋡", "\\nsucceq", !0);
l(h, v, b, "⋩", "\\succnsim", !0);
l(h, v, b, "⪺", "\\succnapprox", !0);
l(h, v, b, "≆", "\\ncong", !0);
l(h, v, b, "", "\\@nshortparallel");
l(h, v, b, "∦", "\\nparallel", !0);
l(h, v, b, "⊯", "\\nVDash", !0);
l(h, v, b, "⋫", "\\ntriangleright");
l(h, v, b, "⋭", "\\ntrianglerighteq", !0);
l(h, v, b, "", "\\@nsupseteqq");
l(h, v, b, "⊋", "\\supsetneq", !0);
l(h, v, b, "", "\\@varsupsetneq");
l(h, v, b, "⫌", "\\supsetneqq", !0);
l(h, v, b, "", "\\@varsupsetneqq");
l(h, v, b, "⊮", "\\nVdash", !0);
l(h, v, b, "⪵", "\\precneqq", !0);
l(h, v, b, "⪶", "\\succneqq", !0);
l(h, v, b, "", "\\@nsubseteqq");
...
l(h, v, y, "®", "\\circledR");
l(T, v, y, "®", "\\circledR");
l(h, v, y, "∡", "\\measuredangle", !0);
l(h, v, y, "∄", "\\nexists");
l(h, v, y, "℧", "\\mho");
l(h, v, y, "Ⅎ", "\\Finv", !0);
l(h, v, y, "⅁", "\\Game", !0);
l(h, v, y, "‵", "\\backprime");
l(h, v, y, "▲", "\\blacktriangle");
l(h, v, y, "▼", "\\blacktriangledown");
l(h, v, y, "■", "\\blacksquare");
l(h, v, y, "⧫", "\\blacklozenge");
l(h, v, y, "★", "\\bigstar");
l(h, v, y, "∢", "\\sphericalangle", !0);
l(h, v, y, "∁", "\\complement", !0);
l(h, v, y, "ð", "\\eth", !0);
l(T, c, y, "ð", "ð");
l(h, v, y, "╱", "\\diagup");
l(h, v, y, "╲", "\\diagdown");
...
l(h, v, b, "≦", "\\leqq", !0);
l(h, v, b, "⩽", "\\leqslant", !0);
l(h, v, b, "⪕", "\\eqslantless", !0);
l(h, v, b, "≲", "\\lesssim", !0);
l(h, v, b, "⪅", "\\lessapprox", !0);
l(h, v, b, "≊", "\\approxeq", !0);
l(h, v, L, "⋖", "\\lessdot");
l(h, v, b, "⋘", "\\lll", !0);
l(h, v, b, "≶", "\\lessgtr", !0);
l(h, v, b, "⋚", "\\lesseqgtr", !0);
l(h, v, b, "⪋", "\\lesseqqgtr", !0);
l(h, v, b, "≑", "\\doteqdot");
l(h, v, b, "≓", "\\risingdotseq", !0);
l(h, v, b, "≒", "\\fallingdotseq", !0);
l(h, v, b, "∽", "\\backsim", !0);
l(h, v, b, "⋍", "\\backsimeq", !0);
l(h, v, b, "⫅", "\\subseteqq", !0);
l(h, v, b, "⋐", "\\Subset", !0);
l(h, v, b, "⊏", "\\sqsubset", !0);
l(h, v, b, "≼", "\\preccurlyeq", !0);
l(h, v, b, "⋞", "\\curlyeqprec", !0);
l(h, v, b, "≾", "\\precsim", !0);
l(h, v, b, "⪷", "\\precapprox", !0);
l(h, v, b, "⊲", "\\vartriangleleft");
l(h, v, b, "⊴", "\\trianglelefteq");
l(h, v, b, "⊨", "\\vDash", !0);
l(h, v, b, "⊪", "\\Vvdash", !0);
l(h, v, b, "⌣", "\\smallsmile");
l(h, v, b, "⌢", "\\smallfrown");
...
l(h, v, b, "⋑", "\\Supset", !0);
l(h, v, b, "⊐", "\\sqsupset", !0);
l(h, v, b, "≽", "\\succcurlyeq", !0);
l(h, v, b, "⋟", "\\curlyeqsucc", !0);
l(h, v, b, "≿", "\\succsim", !0);
l(h, v, b, "⪸", "\\succapprox", !0);
l(h, v, b, "⊳", "\\vartriangleright");
l(h, v, b, "⊵", "\\trianglerighteq");
l(h, v, b, "⊩", "\\Vdash", !0);
l(h, v, b, "∣", "\\shortmid");
l(h, v, b, "∥", "\\shortparallel");
l(h, v, b, "≬", "\\between", !0);
l(h, v, b, "⋔", "\\pitchfork", !0);
l(h, v, b, "∝", "\\varpropto");
l(h, v, b, "◀", "\\blacktriangleleft");
l(h, v, b, "∴", "\\therefore", !0);
l(h, v, b, "∍", "\\backepsilon");
l(h, v, b, "▶", "\\blacktriangleright");
l(h, v, b, "∵", "\\because", !0);
l(h, v, b, "⋘", "\\llless");
l(h, v, b, "⋙", "\\gggtr");
l(h, v, L, "⊲", "\\lhd");
...
l(h, v, b, "≑", "\\Doteq", !0);
l(h, v, L, "∔", "\\dotplus", !0);
l(h, v, L, "∖", "\\smallsetminus");
l(h, v, L, "⋒", "\\Cap", !0);
l(h, v, L, "⋓", "\\Cup", !0);
l(h, v, L, "⩞", "\\doublebarwedge", !0);
l(h, v, L, "⊟", "\\boxminus", !0);
l(h, v, L, "⊞", "\\boxplus", !0);
l(h, v, L, "⋇", "\\divideontimes", !0);
l(h, v, L, "⋉", "\\ltimes", !0);
l(h, v, L, "⋊", "\\rtimes", !0);
l(h, v, L, "⋋", "\\leftthreetimes", !0);
l(h, v, L, "⋌", "\\rightthreetimes", !0);
l(h, v, L, "⋏", "\\curlywedge", !0);
l(h, v, L, "⋎", "\\curlyvee", !0);
l(h, v, L, "⊝", "\\circleddash", !0);
l(h, v, L, "⊛", "\\circledast", !0);
l(h, v, L, "⋅", "\\centerdot");
l(h, v, L, "⊺", "\\intercal", !0);
l(h, v, L, "⋒", "\\doublecap");
l(h, v, L, "⋓", "\\doublecup");
l(h, v, L, "⊠", "\\boxtimes", !0);
l(h, v, b, "⇢", "\\dashrightarrow", !0);
l(h, v, b, "⇠", "\\dashleftarrow", !0);
l(h, v, b, "⇇", "\\leftleftarrows", !0);
l(h, v, b, "⇆", "\\leftrightarrows", !0);
l(h, v, b, "⇚", "\\Lleftarrow", !0);
l(h, v, b, "↞", "\\twoheadleftarrow", !0);
l(h, v, b, "↢", "\\leftarrowtail", !0);
l(h, v, b, "↫", "\\looparrowleft", !0);
l(h, v, b, "⇋", "\\leftrightharpoons", !0);
l(h, v, b, "↶", "\\curvearrowleft", !0);
l(h, v, b, "↺", "\\circlearrowleft", !0);
l(h, v, b, "↰", "\\Lsh", !0);
l(h, v, b, "⇈", "\\upuparrows", !0);
l(h, v, b, "↿", "\\upharpoonleft", !0);
l(h, v, b, "⇃", "\\downharpoonleft", !0);
l(h, c, b, "⊶", "\\origof", !0);
l(h, c, b, "⊷", "\\imageof", !0);
l(h, v, b, "⊸", "\\multimap", !0);
l(h, v, b, "↭", "\\leftrightsquigarrow", !0);
l(h, v, b, "⇉", "\\rightrightarrows", !0);
l(h, v, b, "⇄", "\\rightleftarrows", !0);
l(h, v, b, "↠", "\\twoheadrightarrow", !0);
l(h, v, b, "↣", "\\rightarrowtail", !0);
l(h, v, b, "↬", "\\looparrowright", !0);
l(h, v, b, "↷", "\\curvearrowright", !0);
l(h, v, b, "↻", "\\circlearrowright", !0);
l(h, v, b, "↱", "\\Rsh", !0);
l(h, v, b, "⇊", "\\downdownarrows", !0);
l(h, v, b, "↾", "\\upharpoonright", !0);
l(h, v, b, "⇂", "\\downharpoonright", !0);
l(h, v, b, "⇝", "\\rightsquigarrow", !0);
l(h, v, b, "⇝", "\\leadsto");
l(h, v, b, "⇛", "\\Rrightarrow", !0);
l(h, v, b, "↾", "\\restriction");
l(h, c, y, "‘", "`");
l(h, c, y, "$", "\\$");
l(T, c, y, "$", "\\$");
...
l(h, c, V, "ψ", "\\psi", !0);
l(h, c, V, "ω", "\\omega", !0);
l(h, c, V, "ε", "\\varepsilon", !0);
l(h, c, V, "ϑ", "\\vartheta", !0);
l(h, c, V, "ϖ", "\\varpi", !0);
l(h, c, V, "ϱ", "\\varrho", !0);
l(h, c, V, "ς", "\\varsigma", !0);
l(h, c, V, "φ", "\\varphi", !0);
l(h, c, L, "∗", "*", !0);
l(h, c, L, "+", "+");
l(h, c, L, "−", "-", !0);
...
l(h, c, ye, "⨆", "\\bigsqcup");
l(h, c, ye, "∫", "\\smallint");
l(T, c, L0, "…", "\\textellipsis");
l(h, c, L0, "…", "\\mathellipsis");
l(T, c, L0, "…", "\\ldots", !0);
l(h, c, L0, "…", "\\ldots", !0);
l(h, c, L0, "⋯", "\\@cdots", !0);
l(h, c, L0, "⋱", "\\ddots", !0);
...
l(T, v, y, "✠", "\\maltese");
var ia = '0123456789/@."';
for (var Pt = 0; Pt < ia.length; Pt++) {
  var sa = ia.charAt(Pt);
  l(h, c, y, sa, sa);
}
var la = '0123456789!@*()-=+";:?/.,';
for (var Ut = 0; Ut < la.length; Ut++) {
  var oa = la.charAt(Ut);
  l(T, c, y, oa, oa);
}
...
l(T, c, V, "h", "ℎ");
var j = "";
for (var Me = 0; Me < xt.length; Me++) {
  var fe = xt.charAt(Me);
  (j = String.fromCharCode(55349, 56320 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56372 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56424 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56580 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56684 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56736 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56788 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56840 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    (j = String.fromCharCode(55349, 56944 + Me)),
    l(h, c, V, fe, j),
    l(T, c, y, fe, j),
    Me < 26 &&
      ((j = String.fromCharCode(55349, 56632 + Me)),
      l(h, c, V, fe, j),
      l(T, c, y, fe, j),
      (j = String.fromCharCode(55349, 56476 + Me)),
      l(h, c, V, fe, j),
      l(T, c, y, fe, j));
}
j = "𝕜";
...
var ur = "ÐÞþ";
for (var Gt = 0; Gt < ur.length; Gt++) {
  var lt = ur.charAt(Gt);
  l(h, c, V, lt, lt), l(T, c, y, lt, lt);
}
var ot = [
  ...
  Es = function (e, t) {
    ...
    if (119808 <= i && i < 120484) {
      ...
      return [ot[o][2], ot[o][s]];
    } else if (120782 <= i && i <= 120831) {
      var u = Math.floor((i - 120782) / 10);
      return [ua[u][2], ua[u][s]];
    } else {
      if (i === 120485 || i === 120486) return [ot[0][2], ot[0][s]];
  ...
  Ns = function (e, t, r, n) {
    return (
      ...
      r.font === "boldsymbol" && Bt(e, "Main-Bold", t).metrics
        ? Ue(e, "Main-Bold", t, r, n.concat(["mathbf"]))
        : e === "\\" || ue[t][e].font === "main"
          ? Ue(e, "Main-Regular", t, r, n)
          : Ue(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
    );
  },
  ...
  qs = function (e, t, r) {
    var n = e.mode,
      ...
      m = "",
      f = "";
    if ((i.charCodeAt(0) === 55349 && ([m, f] = Es(i, n)), m.length > 0))
      return Ue(i, m, n, t, s.concat(f));
    if (u) {
      var p, g;
      if (u === "boldsymbol") {
        var w = $s(i, n, t, s, r);
        ...
        o
          ? ((p = En[u].fontName), (g = [u]))
          : ((p = ut(u, t.fontWeight, t.fontShape)),
            (g = [u, t.fontWeight, t.fontShape]));
      if (Bt(i, p, n).metrics) return Ue(i, p, n, t, s.concat(g));
      if (Cn.hasOwnProperty(i) && p.slice(0, 10) === "Typewriter") {
        for (var M = [], x = 0; x < i.length; x++)
          M.push(Ue(i[x], p, n, t, s.concat(g)));
        return In(M);
      }
    }
    if (r === "mathord")
      return Ue(i, "Math-Italic", n, t, s.concat(["mathnormal"]));
    if (r === "textord") {
      var S = ue[n][i] && ue[n][i].font;
      if (S === "ams") {
        var z = ut("amsrm", t.fontWeight, t.fontShape);
        return Ue(i, z, n, t, s.concat("amsrm", t.fontWeight, t.fontShape));
      } else if (S === "main" || !S) {
        var D = ut("textrm", t.fontWeight, t.fontShape);
        return Ue(i, D, n, t, s.concat(t.fontWeight, t.fontShape));
      } else {
        var A = ut(S, t.fontWeight, t.fontShape);
        return Ue(i, A, n, t, s.concat(A, t.fontWeight, t.fontShape));
      }
  ...
  De = function (e, t, r, n) {
    var i = new J0(e, t, r, n);
    return Ar(i), i;
  },
  Rn = (a, e, t, r) => new J0(a, e, t, r),
  Os = function (e, t, r) {
    var n = De([e], [], t);
    return (
      (n.height = Math.max(
      ...
      (n.style.borderBottomWidth = R(n.height)),
      (n.maxFontSize = 1),
      n
    );
  },
  Hs = function (e, t, r, n) {
    var i = new Tr(e, t, r, n);
    return Ar(i), i;
  },
  In = function (e) {
    var t = new Z0(e);
  ...
  Ps = function (e, t) {
    return e instanceof Z0 ? De([], [e], t) : e;
  },
  Us = function (e) {
  ...
  Vs = function (e, t) {
    for (
      var { children: r, depth: n } = Us(e), i = 0, s = 0;
      s < r.length;
      s++
    ) {
      var o = r[s];
    ...
    var m = De(["pstrut"], []);
    m.style.height = R(i);
    for (var f = [], p = n, g = n, w = n, M = 0; M < r.length; M++) {
      var x = r[M];
      if (x.type === "kern") w += x.size;
      else {
        var S = x.elem,
          z = x.wrapperClasses || [],
          D = x.wrapperStyle || {},
          A = De(z, [m, S], void 0, D);
        (A.style.top = R(-i - w - S.depth)),
          x.marginLeft && (A.style.marginLeft = x.marginLeft),
          x.marginRight && (A.style.marginRight = x.marginRight),
          f.push(A),
          (w += S.height + S.depth);
      }
    ...
    if (p < 0) {
      ...
      I = [De(["vlist-r"], [N, Q]), De(["vlist-r"], [Y])];
    } else I = [De(["vlist-r"], [N])];
    var Z = De(["vlist-t"], I);
    return (
      I.length === 2 && Z.classes.push("vlist-t2"),
      (Z.height = g),
      (Z.depth = -p),
      Z
    );
  ...
  Gs = (a, e) => {
    var t = De(["mspace"], [], e),
      r = de(a, e);
    return (t.style.marginRight = R(r)), t;
  },
  ut = function (e, t, r) {
    var n = "";
    switch (e) {
  ...
  js = function (e, t) {
    var [r, n, i] = Nn[e],
      ...
      u = Rn(["overlay"], [o], t);
    return (u.height = i), (u.style.height = R(i)), (u.style.width = R(n)), u;
  },
  k = {
    fontMap: En,
    makeSymbol: Ue,
...
var zt = function (e) {
  ...
  s0 = k.makeSpan,
  Ws = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
  Zs = ["rightmost", "mrel", "mclose", "mpunct"],
  Js = {
    display: G.DISPLAY,
    text: G.TEXT,
    script: G.SCRIPT,
  ...
  xe = function (e, t, r, n) {
    ...
    if ((k.tryCombineChars(i), !r)) return i;
    var m = t;
    if (e.length === 1) {
      var f = e[0];
      f.type === "sizing"
        ? (m = t.havingSize(f.size))
        : f.type === "styling" && (m = t.havingStyle(Js[f.style]));
    }
    var p = s0([n[0] || "leftmost"], [], t),
      g = s0([n[1] || "rightmost"], [], t),
      w = r === "root";
    return (
      ha(
        i,
        (M, x) => {
          var S = x.classes[0],
            z = M.classes[0];
          S === "mbin" && P.contains(Zs, z)
            ? (x.classes[0] = "mord")
            : z === "mbin" && P.contains(Ws, S) && (M.classes[0] = "mord");
        },
        { node: p },
        g,
        w,
      ...
      ha(
        ...
        (M, x) => {
          var S = hr(x),
            z = hr(M),
            D = S && z ? (M.hasClass("mtight") ? Xs[S][z] : Ys[S][z]) : null;
          if (D) return k.makeGlue(D, m);
        },
        { node: p },
        g,
        w,
  ...
  qn = function (e) {
    return e instanceof Z0 ||
      e instanceof Tr ||
      (e instanceof J0 && e.hasClass("enclosing"))
      ? e
      : null;
  },
  Ks = function a(e, t) {
  ...
  hr = function (e, t) {
    return e ? (t && (e = Ks(e, t)), Qs[e.classes[0]] || null) : null;
  },
  X0 = function (e, t) {
  ...
  ae = function (e, t, r) {
    ...
    if (kt[e.type]) {
      ...
      return n;
    } else throw new B("Got group of unknown type: '" + e.type + "'");
  };
function ht(a, e) {
  var t = s0(["base"], a, e),
    r = s0(["strut"]);
  return (
    (r.style.height = R(t.height + t.depth)),
    t.depth && (r.style.verticalAlign = R(-t.depth)),
  ...
  for (var i = [], s = [], o = 0; o < r.length; o++)
    if (
      ...
      r[o].hasClass("newline") &&
        (s.pop(), s.length > 0 && (i.push(ht(s, e)), (s = [])), i.push(r[o]));
  s.length > 0 && i.push(ht(s, e));
  var m;
  t
    ? ((m = ht(xe(t, e, !0))), (m.classes = ["tag"]), i.push(m))
    : n && i.push(n);
  var f = s0(["katex-html"], i);
  if ((f.setAttribute("aria-hidden", "true"), m)) {
    var p = m.children[0];
    (p.style.height = R(f.height + f.depth)),
      f.depth && (p.style.verticalAlign = R(-f.depth));
  }
  return f;
}
function Ln(a) {
...
class Ee {
  ...
  toNode() {
    ...
    for (var r = 0; r < this.children.length; r++)
      if (
        this.children[r] instanceof Xe &&
        this.children[r + 1] instanceof Xe
      ) {
        for (
  ...
  toMarkup() {
    ...
    for (var t in this.attributes)
      Object.prototype.hasOwnProperty.call(this.attributes, t) &&
        ((e += " " + t + '="'),
        (e += P.escape(this.attributes[t])),
        (e += '"'));
    this.classes.length > 0 &&
      (e += ' class ="' + P.escape(f0(this.classes)) + '"'),
      (e += ">");
    for (var r = 0; r < this.children.length; r++)
      e += this.children[r].toMarkup();
...
var _ = { MathNode: Ee, TextNode: Xe, SpaceNode: el, newDocumentFragment: Ln },
  He = function (e, t, r) {
    return (
      ue[t][e] &&
        ue[t][e].replace &&
  ...
  Dr = function (e) {
    return e.length === 1 ? e[0] : new _.MathNode("mrow", e);
  },
  _r = function (e, t) {
    ...
    var i = e.text;
    if (P.contains(["\\imath", "\\jmath"], i)) return null;
    ue[n][i] && ue[n][i].replace && (i = ue[n][i].replace);
    var s = k.fontMap[r].fontName;
    return Mr(i, s, n) ? k.fontMap[r].variant : null;
  };
function jt(a) {
  if (!a) return !1;
  if (a.type === "mi" && a.children.length === 1) {
    var e = a.children[0];
    return e instanceof Xe && e.text === ".";
  } else if (
    a.type === "mo" &&
    a.children.length === 1 &&
...
var Ce = function (e, t, r) {
    ...
    for (var i = [], s, o = 0; o < e.length; o++) {
      ...
      if (u instanceof Ee && s instanceof Ee) {
        if (
          ...
          s.children.push(...u.children);
          continue;
        } else if (jt(u) && s.type === "mn") {
          s.children.push(...u.children);
          continue;
        } else if (u.type === "mn" && jt(s))
  ...
  oe = function (e, t) {
    if (!e) return new _.MathNode("mrow");
    if (St[e.type]) {
      var r = St[e.type](e, t);
      return r;
    } else throw new B("Got group of unknown type: '" + e.type + "'");
  };
function ca(a, e, t, r, n) {
  var i = Ce(a, t),
    s;
  i.length === 1 &&
  i[0] instanceof Ee &&
  P.contains(["mrow", "mtable"], i[0].type)
    ? (s = i[0])
    : (s = new _.MathNode("mrow", i));
  var o = new _.MathNode("annotation", [new _.TextNode(e)]);
  o.setAttribute("encoding", "application/x-tex");
  var u = new _.MathNode("semantics", [s, o]),
    m = new _.MathNode("math", [u]);
  m.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"),
    r && m.setAttribute("display", "block");
  var f = n ? "katex" : "katex-mathml";
  return k.makeSpan([f], [m]);
}
var Fn = function (e) {
    return new r0({
  ...
  tl = function (e, t, r) {
    var n = Fn(r),
      i;
    if (r.output === "mathml") return ca(e, t, n, r.displayMode, !0);
    if (r.output === "html") {
      var s = cr(e, n);
      i = k.makeSpan(["katex"], [s]);
    } else {
      var o = ca(e, t, n, r.displayMode, !1),
        u = cr(e, n);
      i = k.makeSpan(["katex"], [o, u]);
    }
    return On(i, r);
  },
  rl = function (e, t, r) {
  ...
  nl = function (e) {
    var t = new _.MathNode("mo", [new _.TextNode(al[e.replace(/^\\/, "")])]);
  ...
  ll = function (e, t) {
      ...
      if (P.contains(["widehat", "widecheck", "widetilde", "utilde"], u)) {
        ...
        if (f > 5)
          u === "widehat" || u === "widecheck"
            ? ((p = 420), (o = 2364), (w = 0.42), (g = u + "4"))
            : ((p = 312), (o = 2340), (w = 0.34), (g = "tilde4"));
        else {
          var M = [1, 1, 2, 2, 3, 3][f];
          u === "widehat" || u === "widecheck"
        ...
        return { span: k.makeSvgSpan([], [S], t), minWidth: 0, height: w };
      } else {
        var z = [],
          D = il[u],
          [A, N, I] = D,
        ...
        for (var $ = 0; $ < Y; $++) {
          var F = new p0(A[$]),
            ...
            C = k.makeSvgSpan([Q[$]], [X], t);
          if (Y === 1) return { span: C, minWidth: N, height: O };
          (C.style.height = R(O)), z.push(C);
        }
        return { span: k.makeSpan(["stretchy"], z, t), minWidth: N, height: O };
      }
    }
    ...
    return (
      (n.height = s),
      (n.style.height = R(s)),
      i > 0 && (n.style.minWidth = R(i)),
      n
    );
  },
  ol = function (e, t, r, n, i) {
    var s,
    ...
    if (/fbox|color|angl/.test(t)) {
      ...
      var f = new i0(m, { width: "100%", height: R(o) });
      s = k.makeSvgSpan([], [f], i);
    }
    return (s.height = o), (s.style.height = R(o)), s;
  },
  l0 = { encloseSpan: ol, mathMLnode: nl, svgSpan: ll };
function J(a, e) {
  if (!a || a.type !== e)
    throw new Error(
...
var Cr = (a, e) => {
    ...
    var i = ae(t, e.havingCrampedStyle()),
      s = r.isShifty && P.isCharacterBox(t),
      o = 0;
    if (s) {
      var u = P.getBaseElem(t),
    ...
    if (r.isStretchy)
      ...
      var w, M;
      r.label === "\\vec"
        ? ((w = k.staticSvg("vec", e)), (M = k.svgData.vec[1]))
        : ((w = k.makeOrd({ mode: r.mode, text: r.label }, e, "textord")),
          (w = na(w)),
          (w.italic = 0),
          (M = w.width),
          f && (p += w.depth)),
        (g = k.makeSpan(["accent-body"], [w]));
      var x = r.label === "\\textcircled";
      x && (g.classes.push("accent-full"), (p = i.height));
      var S = o;
      x || (S -= M / 2),
        (g.style.left = R(S)),
        r.label === "\\textcircled" && (g.style.top = ".2em"),
        (g = k.makeVList(
          {
            positionType: "firstBaseline",
            children: [
    ...
    var z = k.makeSpan(["mord", "accent"], [g], e);
    return n
      ? ((n.children[0] = z),
  ...
  Hn = (a, e) => {
    var t = a.isStretchy
        ...
        : new _.MathNode("mo", [He(a.label, a.mode)]),
      r = new _.MathNode("mover", [oe(a.base, e), t]);
...
q({
  ...
  mathmlBuilder: (a, e) => {
    var t = l0.mathMLnode(a.label),
      r = new _.MathNode("munder", [oe(a.base, e), t]);
    return r.setAttribute("accentunder", "true"), r;
  },
});
var ct = (a) => {
  var e = new _.MathNode("mpadded", a ? [a] : []);
  return (
...
q({
  ...
  mathmlBuilder(a, e) {
    ...
    var r;
    if (a.body) {
      var n = ct(oe(a.body, e));
      if (a.below) {
        var i = ct(oe(a.below, e));
        r = new _.MathNode("munderover", [t, i, n]);
      } else r = new _.MathNode("mover", [t, n]);
    } else if (a.below) {
      var s = ct(oe(a.below, e));
      r = new _.MathNode("munder", [t, s]);
    } else (r = ct()), (r = new _.MathNode("mover", [t, r]));
    return r;
  },
});
var hl = k.makeSpan;
...
function Un(a, e) {
  ...
  return (
    a.mclass === "minner"
      ? (t = new _.MathNode("mpadded", r))
      : a.mclass === "mord"
        ? a.isCharacterBox
          ? ((t = r[0]), (t.type = "mi"))
          : (t = new _.MathNode("mi", r))
        : (a.isCharacterBox
            ? ((t = r[0]), (t.type = "mo"))
            : (t = new _.MathNode("mo", r)),
          a.mclass === "mbin"
...
q({
  ...
  handler(a, e) {
    ...
    return {
      ...
      mclass: "m" + r.slice(5),
      body: be(n),
      isCharacterBox: P.isCharacterBox(n),
    };
  },
  htmlBuilder: Pn,
  mathmlBuilder: Un,
...
q({
  ...
  handler(a, e) {
    var { parser: t } = a;
    return { type: "pmb", mode: t.mode, mclass: Rt(e[0]), body: be(e[0]) };
  },
  htmlBuilder(a, e) {
    var t = xe(a.body, e, !0),
      r = k.makeSpan([a.mclass], t, e);
    return (r.style.textShadow = "0.02em 0.01em 0.04px"), r;
  },
  mathmlBuilder(a, e) {
    var t = Ce(a.body, e),
      r = new _.MathNode("mstyle", t);
...
var cl = {
  ...
  ma = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
  da = (a) => a.type === "textord" && a.text === "@",
  ml = (a, e) => (a.type === "mathord" || a.type === "atom") && a.text === e;
function dl(a, e, t) {
  var r = cl[a];
  switch (r) {
    case "\\\\cdrightarrow":
...
function fl(a) {
  ...
  for (
    ...
    if (t === "&" || t === "\\\\") a.consume();
      ...
      break;
    } else throw new B("Expected \\\\ or \\cr or \\end", a.nextToken);
  }
  for (var r = [], n = [r], i = 0; i < e.length; i++) {
    for (var s = e[i], o = ma(), u = 0; u < s.length; u++)
      if (!da(s[u])) o.body.push(s[u]);
      else {
        r.push(o), (u += 1);
        var m = Br(s[u]).text,
          f = new Array(2);
        if (
          ...
          if ("<>AV".indexOf(m) > -1)
            for (var p = 0; p < 2; p++) {
              for (var g = !0, w = u + 1; w < s.length; w++) {
                if (ml(s[w], m)) {
                  (g = !1), (u = w);
                  break;
                }
          ...
          else throw new B('Expected one of "<>AV=|." after @', s[u]);
        var M = dl(m, f, a),
          x = { type: "styling", body: [M], mode: "math", style: "display" };
        r.push(x), (o = ma());
      }
...
q({
  ...
  htmlBuilder(a, e) {
    var t = e.havingStyle(e.style.sup()),
      r = k.wrapFragment(ae(a.label, t, e), e);
    return (
      r.classes.push("cd-label-" + a.side),
      (r.style.bottom = R(0.8 - r.depth)),
      (r.height = 0),
      (r.depth = 0),
      r
    );
  ...
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mrow", [oe(a.label, e)]);
    return (
      (t = new _.MathNode("mpadded", [t])),
      t.setAttribute("width", "0"),
      a.side === "left" && t.setAttribute("lspace", "-1width"),
      t.setAttribute("voffset", "0.7em"),
      (t = new _.MathNode("mstyle", [t])),
...
q({
  ...
  mathmlBuilder(a, e) {
    return new _.MathNode("mrow", [oe(a.fragment, e)]);
  },
});
q({
  type: "textord",
  ...
  handler(a, e) {
    ...
    var u = parseInt(i),
      m;
    if (isNaN(u)) throw new B("\\@char has non-numeric argument " + i);
    if (u < 0 || u >= 1114111)
...
var Vn = (a, e) => {
  ...
  Gn = (a, e) => {
    var t = Ce(a.body, e.withColor(a.color)),
      r = new _.MathNode("mstyle", t);
  ...
  htmlBuilder(a, e) {
    ...
    return (
      a.newLine &&
        ...
        a.size && (t.style.marginTop = R(de(a.size, e)))),
      t
    );
  },
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mspace");
    return (
      a.newLine &&
        (t.setAttribute("linebreak", "newline"),
        a.size && t.setAttribute("height", R(de(a.size, e)))),
      t
    );
  },
});
...
q({
  ...
  handler(a) {
    ...
    if (mr[r.text])
      return (
        (t === "\\global" || t === "\\\\globallong") && (r.text = mr[r.text]),
  ...
  handler(a) {
    ...
    for (var i = 0, s, o = [[]]; e.gullet.future().text !== "{"; )
      if (((r = e.gullet.popToken()), r.text === "#")) {
        ...
        if (r.text === "EOF") throw new B("Expected a macro definition");
        o[i].push(r.text);
      }
...
q({
  ...
  handler(a) {
    var { parser: e, funcName: t } = a,
      r = jn(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = pl(e);
    return (
      Yn(e, r, n, t === "\\\\globallet"), { type: "internal", mode: e.mode }
    );
  },
});
q({
...
var H0 = function (e, t, r) {
  ...
  Rr = function (e, t, r, n) {
    var i = r.havingBaseStyle(t),
      s = k.makeSpan(n.concat(i.sizingClasses(r)), [e], r),
  ...
  gl = function (e, t, r, n, i, s) {
    var o = k.makeSymbol(e, "Main-Regular", i, n),
      u = Rr(o, t, n, s);
    return r && Xn(u, n, t), u;
  },
  vl = function (e, t, r, n) {
  ...
  Wn = function (e, t, r, n, i, s) {
    var o = vl(e, t, i, n),
      u = Rr(k.makeSpan(["delimsizing", "size" + t], [o], n), G.TEXT, n, s);
    return r && Xn(u, n, G.TEXT), u;
  },
  Yt = function (e, t, r) {
    var n;
    ...
    var i = k.makeSpan(
      ["delimsizinginner", n],
      [k.makeSpan([], [k.makeSymbol(e, t, r)])],
    );
    return { type: "elem", elem: i };
  },
  Xt = function (e, t, r) {
    var n = Ye["Size4-Regular"][e.charCodeAt(0)]
        ? Ye["Size4-Regular"][e.charCodeAt(0)][4]
        : Ye["Size1-Regular"][e.charCodeAt(0)][4],
      i = new p0("inner", ks(e, Math.round(1e3 * t))),
      s = new i0([i], {
        width: R(n),
        height: R(t),
        style: "width:" + R(n),
  ...
  dr = 0.008,
  mt = { type: "kern", size: -1 * dr },
  bl = ["|", "\\lvert", "\\rvert", "\\vert"],
  yl = ["\\|", "\\lVert", "\\rVert", "\\Vert"],
  Zn = function (e, t, r, n, i, s) {
    var o,
      u,
      m,
      f,
    ...
    if (u !== null) {
      var O = H0(u, w, i);
      (N = O.height + O.depth), (I = 2);
    }
    var Y = x + A + N,
      Q = Math.max(0, Math.ceil((t - Y) / (I * z))),
      Z = Y + Q * I * z,
    ...
    if (p.length > 0) {
      var X = Z - x - A,
        C = Math.round(Z * 1e3),
        U = Ss(p, Math.round(X * 1e3)),
        ke = new p0(p, U),
        re = (g / 1e3).toFixed(3) + "em",
        se = (C / 1e3).toFixed(3) + "em",
        Se = new i0([ke], {
          width: re,
          height: se,
          viewBox: "0 0 " + g + " " + C,
        }),
        pe = k.makeSvgSpan([], [Se], n);
      (pe.height = C / 1e3),
        (pe.style.width = re),
        (pe.style.height = se),
        F.push({ type: "elem", elem: pe });
    } else {
      if ((F.push(Yt(f, w, i)), F.push(mt), u === null)) {
        var ze = Z - x - A + 2 * dr;
        F.push(Xt(m, ze, n));
      } else {
        var ge = (Z - x - A - N) / 2 + 2 * dr;
        F.push(Xt(m, ge, n)),
          F.push(mt),
          F.push(Yt(u, w, i)),
          F.push(mt),
      ...
      F.push(mt), F.push(Yt(o, w, i));
    }
    var ve = n.havingBaseStyle(G.TEXT),
      $e = k.makeVList(
        { positionType: "bottom", positionData: $, children: F },
        ve,
      );
    return Rr(k.makeSpan(["delimsizing", "mult"], [$e], ve), G.TEXT, n, s);
  },
  Wt = 80,
  Zt = 0.08,
  ...
  wl = function (e, t) {
    var r = t.havingBaseSizing(),
      n = ei("\\surd", e * r.sizeMultiplier, Kn, r),
      i = r.sizeMultiplier,
      ...
      n.type === "small"
        ...
        : n.type === "large"
          ? ((f = (1e3 + Wt) * P0[n.size]),
            (m = (P0[n.size] + s) / i),
            (u = (P0[n.size] + s + Zt) / i),
            (o = Jt("sqrtSize" + n.size, u, f, s, t)),
            (o.style.minWidth = "1.02em"),
            (p = 1 / i))
          : ((u = e + s + Zt),
            (m = e + s),
            (f = Math.floor(1e3 * e + s) + Wt),
            (o = Jt("sqrtTall", u, f, s, t)),
  ...
  Qn = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
  P0 = [0, 1.2, 1.8, 2.4, 3],
  kl = function (e, t, r, n, i) {
    if (
      (e === "<" || e === "\\lt" || e === "⟨"
        ? (e = "\\langle")
        : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"),
      P.contains(Jn, e) || P.contains(Qn, e))
    )
      return Wn(e, t, !1, r, n, i);
    if (P.contains(xl, e)) return Zn(e, P0[t], !1, r, n, i);
  ...
  ti = function (e, t, r, n, i, s) {
    e === "<" || e === "\\lt" || e === "⟨"
      ...
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var o;
    P.contains(Qn, e) ? (o = Sl) : P.contains(Jn, e) ? (o = Kn) : (o = zl);
    var u = ei(e, t, o, n);
    return u.type === "small"
      ? gl(e, u.style, r, n, i, s)
      : u.type === "large"
        ? Wn(e, u.size, r, n, i, s)
        : Zn(e, t, r, n, i, s);
  },
  Tl = function (e, t, r, n, i, s) {
    var o = n.fontMetrics().axisHeight * n.sizeMultiplier,
      u = 901,
      m = 5 / n.fontMetrics().ptPerEm,
      f = Math.max(t - o, r + o),
      p = Math.max((f / 500) * u, 2 * f - m);
    return ti(e, p, !0, n, i, s);
  },
  n0 = {
    sqrtImage: wl,
    sizedDelim: kl,
...
function It(a, e) {
  var t = Ct(a);
  if (t && P.contains(Al, t.text)) return t;
  throw t
    ? new B("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", a)
    : new B("Invalid delimiter type '" + a.type + "'", a);
}
q({
  type: "delimsizing",
  names: [
  ...
  mathmlBuilder: (a) => {
    var e = [];
    a.delim !== "." && e.push(He(a.delim, a.mode));
    var t = new _.MathNode("mo", e);
    a.mclass === "mopen" || a.mclass === "mclose"
      ? t.setAttribute("fence", "true")
      : t.setAttribute("fence", "false"),
      t.setAttribute("stretchy", "true");
    var r = R(n0.sizeToMaxHeight[a.size]);
...
q({
  ...
  htmlBuilder: (a, e) => {
    pa(a);
    for (
      var t = xe(a.body, e, !0, ["mopen", "mclose"]),
        r = 0,
        n = 0,
        i = !1,
        s = 0;
    ...
    var p;
    if (a.right === ".") p = X0(e, ["mclose"]);
    else {
      var g = a.rightColor ? e.withColor(a.rightColor) : e;
      p = n0.leftRightDelim(a.right, r, n, g, a.mode, ["mclose"]);
    }
  ...
  mathmlBuilder: (a, e) => {
    ...
    var t = Ce(a.body, e);
    if (a.left !== ".") {
      var r = new _.MathNode("mo", [He(a.left, a.mode)]);
      r.setAttribute("fence", "true"), t.unshift(r);
    }
    if (a.right !== ".") {
      var n = new _.MathNode("mo", [He(a.right, a.mode)]);
...
var Ir = (a, e) => {
    var t = k.wrapFragment(ae(a.body, e), e),
      r = a.label.slice(1),
      n = e.sizeMultiplier,
      i,
      s = 0,
      o = P.isCharacterBox(a.body);
    if (r === "sout")
      ...
      t.style.paddingLeft = R(p / 2 + u);
      var g = Math.floor(1e3 * p * n),
        w = ys(g),
      ...
      /box/.test(r)
        ? ((z = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
          (x = e.fontMetrics().fboxsep + (r === "colorbox" ? 0 : z)),
          (S = x))
        : r === "angl"
          ? ((z = Math.max(
          ...
          : ((x = o ? 0.2 : 0), (S = x)),
        (i = l0.encloseSpan(t, r, x, S, e)),
        /fbox|boxed|fcolorbox/.test(r)
          ? ((i.style.borderStyle = "solid"), (i.style.borderWidth = R(z)))
          : r === "angl" &&
            z !== 0.049 &&
            ((i.style.borderTopWidth = R(z)),
            (i.style.borderRightWidth = R(z))),
        (s = t.depth + S),
        a.backgroundColor &&
      ...
      D = k.makeVList(
        {
          ...
          children: [
            { type: "elem", elem: t, shift: 0 },
            { type: "elem", elem: i, shift: s, wrapperClasses: A },
          ],
        },
        e,
      );
    ...
    return (
      /cancel/.test(r) && ((D.height = t.height), (D.depth = t.depth)),
      /cancel/.test(r) && !o
        ? k.makeSpan(["mord", "cancel-lap"], [D], e)
        : k.makeSpan(["mord"], [D], e)
    );
  },
  Er = (a, e) => {
  ...
  function N() {
    D &&
      (a.gullet.macros.get("\\df@tag")
        ? (D.push(a.subparse([new Le("\\df@tag")])),
          a.gullet.macros.set("\\df@tag", void 0, !0))
        : D.push(!!u && a.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (A(), z.push(ga(a)); ; ) {
    var I = a.parseExpression(!1, m ? "\\end" : "\\\\");
    a.gullet.endGroup(),
      a.gullet.beginGroup(),
      (I = { type: "ordgroup", mode: a.mode, body: I }),
      t && (I = { type: "styling", mode: a.mode, style: t, body: [I] }),
      M.push(I);
    var O = a.fetch().text;
    if (O === "&") {
      if (p && M.length === p) {
        if (m || o) throw new B("Too many tab characters: &", a.nextToken);
      ...
      N(),
        M.length === 1 &&
          I.type === "styling" &&
          I.body[0].body.length === 0 &&
          (x.length > 1 || !f) &&
          x.pop(),
        z.length < x.length + 1 && z.push([]);
      break;
    } else if (O === "\\\\") {
      a.consume();
      var Y = void 0;
      a.gullet.future().text !== " " && (Y = a.parseSizeGroup(!0)),
        ...
        x.push(M),
        A();
    } else throw new B("Expected & or \\\\ or \\cr or \\end", a.nextToken);
  }
  return (
    a.gullet.endGroup(),
    a.gullet.endGroup(),
...
var Ke = function (e, t) {
    ...
    function N(rt) {
      for (var at = 0; at < rt.length; ++at)
        at > 0 && (A += 0.25), m.push({ pos: A, isDashed: rt[at] });
    }
    for (N(s[0]), r = 0; r < e.body.length; ++r) {
      var I = e.body[r],
        O = z,
        Y = D;
    ...
    var F = A / 2 + t.fontMetrics().axisHeight,
      X = e.cols || [],
      C = [],
      U,
      ke,
    ...
    if (e.tags && e.tags.some((rt) => rt))
      for (r = 0; r < i; ++r) {
        var se = u[r],
          ...
          ze = void 0;
        pe === !0
          ? (ze = k.makeSpan(["eqn-num"], [], t))
          : pe === !1
            ? (ze = k.makeSpan([], [], t))
            : (ze = k.makeSpan([], xe(pe, t, !0), t)),
          (ze.depth = se.depth),
          (ze.height = se.height),
          re.push({ type: "elem", elem: ze, shift: Se });
      }
    for (n = 0, ke = 0; n < o || ke < X.length; ++n, ++ke) {
      for (var ge = X[ke] || {}, ve = !0; ge.type === "separator"; ) {
        if (
          (ve ||
            ((U = k.makeSpan(["arraycolsep"], [])),
            (U.style.width = R(t.fontMetrics().doubleRuleSep)),
            C.push(U)),
          ge.separator === "|" || ge.separator === ":")
        ) {
          var $e = ge.separator === "|" ? "solid" : "dashed",
            Pe = k.makeSpan(["vertical-separator"], [], t);
          (Pe.style.height = R(A)),
            (Pe.style.borderRightWidth = R(f)),
            (Pe.style.borderRightStyle = $e),
            (Pe.style.margin = "0 " + R(-f / 2));
          var b0 = A - F;
          b0 && (Pe.style.verticalAlign = R(-b0)), C.push(Pe);
        } else throw new B("Invalid separator type: " + ge.separator);
        ke++, (ge = X[ke] || {}), (ve = !1);
      }
      if (!(n >= o)) {
        var u0 = void 0;
        (n > 0 || e.hskipBeforeAndAfter) &&
          ((u0 = P.deflt(ge.pregap, g)),
          u0 !== 0 &&
            ((U = k.makeSpan(["arraycolsep"], [])),
            (U.style.width = R(u0)),
            C.push(U)));
        ...
        for (r = 0; r < i; ++r) {
          ...
          if (tt) {
            ...
            (tt.depth = C0.depth),
              (tt.height = C0.height),
              h0.push({ type: "elem", elem: tt, shift: Ei });
          }
        }
        (h0 = k.makeVList(
          ...
          (h0 = k.makeSpan(["col-align-" + (ge.align || "c")], [h0])),
          C.push(h0),
          (n < o - 1 || e.hskipBeforeAndAfter) &&
            ((u0 = P.deflt(ge.postgap, g)),
            u0 !== 0 &&
              ((U = k.makeSpan(["arraycolsep"], [])),
              (U.style.width = R(u0)),
              C.push(U)));
    ...
    if (((u = k.makeSpan(["mtable"], C)), m.length > 0)) {
      for (
        var Ni = k.makeLineSpan("hline", t, f),
          $i = k.makeLineSpan("hdashline", t, f),
          qt = [{ type: "elem", elem: u, shift: 0 }];
        m.length > 0;
        ...
        var Zr = m.pop(),
          Jr = Zr.pos - F;
        Zr.isDashed
          ? qt.push({ type: "elem", elem: $i, shift: Jr })
          : qt.push({ type: "elem", elem: Ni, shift: Jr });
      }
      u = k.makeVList({ positionType: "individualShift", children: qt }, t);
    }
    if (re.length === 0) return k.makeSpan(["mord"], [u], t);
    var Lt = k.makeVList({ positionType: "individualShift", children: re }, t);
    return (Lt = k.makeSpan(["tag"], [Lt], t)), k.makeFragment([u, Lt]);
  },
  Dl = { c: "center ", l: "left ", r: "right " },
  e0 = function (e, t) {
    for (
      var r = [],
        n = new _.MathNode("mtd", [], ["mtr-glue"]),
        i = new _.MathNode("mtd", [], ["mml-eqn-num"]),
        s = 0;
      s < e.body.length;
      s++
    ) {
      for (var o = e.body[s], u = [], m = 0; m < o.length; m++)
        u.push(new _.MathNode("mtd", [oe(o[m], t)]));
      e.tags &&
        e.tags[s] &&
        (u.unshift(n), u.push(n), e.leqno ? u.unshift(i) : u.push(i)),
        r.push(new _.MathNode("mtr", u));
    }
    var f = new _.MathNode("mtable", r),
      p =
        e.arraystretch === 0.5
          ? 0.1
          : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
    f.setAttribute("rowspacing", R(p));
    var g = "",
      w = "";
    if (e.cols && e.cols.length > 0) {
      var M = e.cols,
        ...
        z = 0,
        D = M.length;
      M[0].type === "separator" && ((g += "top "), (z = 1)),
        M[M.length - 1].type === "separator" && ((g += "bottom "), (D -= 1));
      for (var A = z; A < D; A++)
        M[A].type === "align"
          ? ((w += Dl[M[A].align]), S && (x += "none "), (S = !0))
          : M[A].type === "separator" &&
            S &&
            ((x += M[A].separator === "|" ? "solid " : "dashed "), (S = !1));
      f.setAttribute("columnalign", w.trim()),
        /[sd]/.test(x) && f.setAttribute("columnlines", x.trim());
    }
    if (e.colSeparationType === "align") {
      for (var N = e.cols || [], I = "", O = 1; O < N.length; O++)
        I += O % 2 ? "0em " : "1em ";
    ...
    var Y = "",
      Q = e.hLinesBeforeRow;
    (g += Q[0].length > 0 ? "left " : ""),
      (g += Q[Q.length - 1].length > 0 ? "right " : "");
    for (var Z = 1; Z < Q.length - 1; Z++)
      Y += Q[Z].length === 0 ? "none " : Q[Z][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test(Y) && f.setAttribute("rowlines", Y.trim()),
      g !== "" &&
        ((f = new _.MathNode("menclose", [f])),
        f.setAttribute("notation", g.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((f = new _.MathNode("mstyle", [f])),
        f.setAttribute("scriptlevel", "1")),
      f
    );
  },
  ni = function (e, t) {
    e.envName.indexOf("ed") === -1 && Et(e);
    var r = [],
    ...
    s.body.forEach(function (z) {
      for (var D = 1; D < z.length; D += 2) {
        var A = J(z[D], "styling"),
          N = J(A.body[0], "ordgroup");
        N.body.unshift(m);
      }
      if (w) u < z.length && (u = z.length);
        ...
        if (o < I)
          throw new B(
            "Too many math in a row: " + ("expected " + o + ", but got " + I),
            z[0],
          );
      }
    });
    for (var M = 0; M < u; ++M) {
      var x = "r",
        S = 0;
      M % 2 === 1 ? (x = "l") : M > 0 && w && (S = 1),
        (r[M] = { type: "align", align: x, pregap: S, postgap: 0 });
    }
  ...
  handler(a, e) {
    var t = Ct(e[0]),
      ...
      n = r.map(function (s) {
        ...
        if (u === ":") return { type: "separator", separator: ":" };
        throw new B("Unknown column alignment: " + u, s);
      }),
      i = { cols: n, hskipBeforeAndAfter: !0, maxNumCols: n.length };
    return v0(a.parser, i, $r(a.envName));
  },
  htmlBuilder: Ke,
  mathmlBuilder: e0,
});
Qe({
  ...
  handler(a) {
    ...
    var i = v0(a.parser, r, $r(a.envName)),
...
Qe({
  ...
  props: { numArgs: 0 },
  handler(a) {
    P.contains(["gather", "gather*"], a.envName) && Et(a);
    var e = {
      cols: [{ type: "align", align: "c" }],
      addJot: !0,
      colSeparationType: "gather",
      autoTag: Nr(a.envName),
      emptySingleRow: !0,
...
q({
  ...
  handler(a, e) {
    var { parser: t, funcName: r } = a,
      n = e[0];
    if (n.type !== "ordgroup") throw new B("Invalid environment name", n);
    for (var i = "", s = 0; s < n.body.length; ++s)
      i += J(n.body[s], "textord").text;
    if (r === "\\begin") {
      if (!va.hasOwnProperty(i)) throw new B("No such environment: " + i, n);
      var o = va[i],
...
var li = (a, e) => {
  ...
  qr = (a, e) => {
    ...
    a.hasBarLine
      ? (a.barSize
          ? ((p = de(a.barSize, e)), (f = k.makeLineSpan("frac-line", e, p)))
          : (f = k.makeLineSpan("frac-line", e)),
        (p = f.height),
        (g = f.height))
      : ((f = null), (p = 0), (g = e.fontMetrics().defaultRuleThickness));
    var w, M, x;
    t.size === G.DISPLAY.size || a.size === "display"
      ...
      : (p > 0
          ? ((w = e.fontMetrics().num2), (M = g))
          : ((w = e.fontMetrics().num3), (M = 3 * g)),
        (x = e.fontMetrics().denom2));
    var S;
    if (f) {
      var D = e.fontMetrics().axisHeight;
      w - s.depth - (D + 0.5 * p) < M &&
        (w += M - (w - s.depth - (D + 0.5 * p))),
        D - 0.5 * p - (m.height - x) < M &&
          (x += M - (D - 0.5 * p - (m.height - x)));
      var A = -(D - 0.5 * p);
      S = k.makeVList(
        {
          positionType: "individualShift",
          children: [
            { type: "elem", elem: m, shift: x },
            { type: "elem", elem: f, shift: A },
      ...
      var z = w - s.depth - (m.height - x);
      z < M && ((w += 0.5 * (M - z)), (x += 0.5 * (M - z))),
        (S = k.makeVList(
          {
            positionType: "individualShift",
            children: [
    ...
    t.size === G.DISPLAY.size
      ? (N = e.fontMetrics().delim1)
      : t.size === G.SCRIPTSCRIPT.size
        ? (N = e.havingStyle(G.SCRIPT).fontMetrics().delim2)
        : (N = e.fontMetrics().delim2);
    var I, O;
    return (
      a.leftDelim == null
        ? (I = X0(e, ["mopen"]))
        : (I = n0.customSizedDelim(
            a.leftDelim,
            N,
            !0,
            e.havingStyle(t),
      ...
      k.makeSpan(
        ...
        [I, k.makeSpan(["mfrac"], [S]), O],
        e,
      )
    );
  },
  Lr = (a, e) => {
    var t = new _.MathNode("mfrac", [oe(a.numer, e), oe(a.denom, e)]);
    if (!a.hasBarLine) t.setAttribute("linethickness", "0px");
    else if (a.barSize) {
      var r = de(a.barSize, e);
      t.setAttribute("linethickness", R(r));
    }
    var n = li(a.size, e.style);
    ...
    if (a.leftDelim != null || a.rightDelim != null) {
      var s = [];
      if (a.leftDelim != null) {
        var o = new _.MathNode("mo", [
          new _.TextNode(a.leftDelim.replace("\\", "")),
        ]);
        o.setAttribute("fence", "true"), s.push(o);
      }
      if ((s.push(t), a.rightDelim != null)) {
        var u = new _.MathNode("mo", [
          new _.TextNode(a.rightDelim.replace("\\", "")),
        ]);
...
var ya = ["display", "text", "script", "scriptscript"],
  wa = function (e) {
    var t = null;
...
q({
  ...
  handler(a, e) {
    var { parser: t } = a,
      ...
      n = e[5],
      i = zt(e[0]),
      s = i.type === "atom" && i.family === "open" ? wa(i.text) : null,
      o = zt(e[1]),
      u = o.type === "atom" && o.family === "close" ? wa(o.text) : null,
      m = J(e[2], "size"),
      f,
      p = null;
    ...
    } else (w = J(w, "textord")), (g = ya[Number(w.text)]);
    return {
      type: "genfrac",
      mode: t.mode,
      numer: r,
...
var oi = (a, e) => {
    ...
    if (
      ...
      var u = k.makeSpan(["mord", n.isOver ? "mover" : "munder"], [o], e);
      n.isOver
        ? (o = k.makeVList(
            {
              positionType: "firstBaseline",
  ...
  _l = (a, e) => {
    var t = l0.mathMLnode(a.label);
    return new _.MathNode(a.isOver ? "mover" : "munder", [oe(a.base, e), t]);
  };
q({
  type: "horizBrace",
...
q({
  ...
  mathmlBuilder(a, e) {
    return new _.MathNode("mrow", Ce(a.body, e));
  },
});
q({
  type: "html",
...
q({
        ...
        if (p.length === 2) {
          ...
          switch (p[0].trim()) {
            ...
            case "totalheight":
              ...
              break;
            default:
              throw new B("Invalid key: '" + p[0] + "' in \\includegraphics.");
          }
        }
      }
    var w = J(e[0], "url").url;
  ...
  htmlBuilder: (a, e) => {
    ...
    var i = { height: R(t + r) };
    n > 0 && (i.width = R(n)), r > 0 && (i.verticalAlign = R(-r));
    var s = new _s(a.src, a.alt, i);
    return (s.height = t), (s.depth = r), s;
  },
  mathmlBuilder: (a, e) => {
    var t = new _.MathNode("mglyph", []);
    t.setAttribute("alt", a.alt);
    var r = de(a.height, e),
      n = 0;
    if (
      (a.totalheight.number > 0 &&
        ((n = de(a.totalheight, e) - r), t.setAttribute("valign", R(-n))),
      t.setAttribute("height", R(r + n)),
      a.width.number > 0)
    ) {
      var i = de(a.width, e);
...
q({
  ...
  htmlBuilder: (a, e) => {
    var t;
    a.alignment === "clap"
      ? ((t = k.makeSpan([], [ae(a.body, e)])),
        (t = k.makeSpan(["inner"], [t], e)))
      : (t = k.makeSpan(["inner"], [ae(a.body, e)]));
    var r = k.makeSpan(["fix"], []),
      n = k.makeSpan([a.alignment], [t, r], e),
      i = k.makeSpan(["strut"]);
    return (
      (i.style.height = R(n.height + n.depth)),
      n.depth && (i.style.verticalAlign = R(-n.depth)),
      n.children.unshift(i),
      (n = k.makeSpan(["thinbox"], [n], e)),
      k.makeSpan(["mord", "vbox"], [n], e)
    );
  },
  mathmlBuilder: (a, e) => {
    var t = new _.MathNode("mpadded", [oe(a.body, e)]);
    if (a.alignment !== "rlap") {
...
var ui = (a, e, t, r, n, i, s) => {
    a = k.makeSpan([], [a]);
    var o = t && P.isCharacterBox(t),
      u,
      m;
    if (e) {
      ...
      g = k.makeVList(
        {
          ...
          children: [
            ...
            { type: "elem", elem: m.elem, marginLeft: R(i) },
            { type: "kern", size: r.fontMetrics().bigOpSpacing5 },
          ],
        },
        r,
    ...
    var S = [g];
    if (u && i !== 0 && !o) {
      var z = k.makeSpan(["mspace"], [], r);
      (z.style.marginRight = R(i)), S.unshift(z);
    }
    return k.makeSpan(["mop", "op-limits"], S, r);
  },
  hi = ["\\smallint"],
  F0 = (a, e) => {
    var t,
    ...
    if (i.symbol) {
      ...
      if (
        ...
        (u = k.makeSymbol(i.name, m, "math", e, [
          "mop",
          "op-symbol",
          o ? "large-op" : "small-op",
        ])),
        ...
        var p = u.italic,
          g = k.staticSvg(f + "Size" + (o ? "2" : "1"), e);
        (u = k.makeVList(
          {
            positionType: "individualShift",
            children: [
              { type: "elem", elem: u, shift: 0 },
              { type: "elem", elem: g, shift: o ? 0.08 : 0 },
            ],
          },
          e,
        )),
      ...
      w.length === 1 && w[0] instanceof Oe
        ...
        : (u = k.makeSpan(["mop"], w, e));
    } else {
      for (var M = [], x = 1; x < i.name.length; x++)
        M.push(k.mathsym(i.name[x], i.mode, e));
      u = k.makeSpan(["mop"], M, e);
    }
    var S = 0,
      z = 0;
    return (
      ...
      n
        ? ui(u, t, r, e, s, z, S)
        : (S && ((u.style.position = "relative"), (u.style.top = R(S))), u)
    );
  },
  Q0 = (a, e) => {
    var t;
    if (a.symbol)
      (t = new Ee("mo", [He(a.name, a.mode)])),
        P.contains(hi, a.name) && t.setAttribute("largeop", "false");
    else if (a.body) t = new Ee("mo", Ce(a.body, e));
    else {
      t = new Ee("mi", [new Xe(a.name.slice(1))]);
      var r = new Ee("mo", [He("⁡", "text")]);
      a.parentIsSupSub ? (t = new Ee("mrow", [t, r])) : (t = Ln([t, r]));
    }
    return t;
  },
  Bl = {
...
var ci = (a, e) => {
      ...
      for (
        var o = i.body.map((p) => {
            ...
            return typeof g == "string"
              ? { type: "textord", mode: p.mode, text: g }
              : p;
          }),
          u = xe(o, e.withFont("mathrm"), !0),
          m = 0;
        m < u.length;
        m++
      ) {
    ...
    return n ? ui(s, t, r, e, e.style, 0, 0) : s;
  },
  Rl = (a, e) => {
    for (
      var t = Ce(a.body, e.withFont("mathrm")), r = !0, n = 0;
      n < t.length;
      n++
    ) {
      var i = t[n];
      if (!(i instanceof _.SpaceNode))
        if (i instanceof _.MathNode)
          switch (i.type) {
            case "mi":
            case "mn":
            case "ms":
            ...
            case "mo": {
              var s = i.children[0];
              i.children.length === 1 && s instanceof _.TextNode
                ? (s.text = s.text
                    .replace(/\u2212/, "-")
                    .replace(/\u2217/, "*"))
                : (r = !1);
    ...
    var u = new _.MathNode("mi", t);
    u.setAttribute("mathvariant", "normal");
    var m = new _.MathNode("mo", [He("⁡", "text")]);
    return a.parentIsSupSub
      ? new _.MathNode("mrow", [u, m])
      : _.newDocumentFragment([u, m]);
  };
q({
  type: "operatorname",
...
_0({
  ...
  htmlBuilder(a, e) {
    return a.semisimple
      ? k.makeFragment(xe(a.body, e, !1))
      : k.makeSpan(["mord"], xe(a.body, e, !0), e);
  },
  mathmlBuilder(a, e) {
...
q({
  ...
  htmlBuilder(a, e) {
    var t = ae(a.body, e.havingCrampedStyle()),
      r = k.makeLineSpan("overline-line", e),
  ...
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mo", [new _.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var r = new _.MathNode("mover", [oe(a.body, e), t]);
    return r.setAttribute("accent", "true"), r;
  },
});
q({
  ...
  mathmlBuilder: (a, e) => {
    var t = Ce(a.body, e);
    return new _.MathNode("mphantom", t);
  },
});
q({
  type: "hphantom",
  ...
  mathmlBuilder: (a, e) => {
    var t = Ce(be(a.body), e),
      r = new _.MathNode("mphantom", t),
      n = new _.MathNode("mpadded", [r]);
...
q({
  ...
  htmlBuilder: (a, e) => {
    var t = k.makeSpan(["inner"], [ae(a.body, e.withPhantom())]),
      r = k.makeSpan(["fix"], []);
...
q({
  ...
  htmlBuilder(a, e) {
    ...
    return (
      (t.style.borderRightWidth = R(r)),
      (t.style.borderTopWidth = R(n)),
      (t.style.bottom = R(i)),
      (t.width = r),
      (t.height = n + i),
      (t.depth = -i),
  ...
  mathmlBuilder(a, e) {
    var t = de(a.width, e),
      ...
      s = new _.MathNode("mspace");
    s.setAttribute("mathbackground", i),
      s.setAttribute("width", R(t)),
      s.setAttribute("height", R(r));
    var o = new _.MathNode("mpadded", [s]);
    return (
      n >= 0
        ? o.setAttribute("height", R(n))
        : (o.setAttribute("height", R(n)), o.setAttribute("depth", R(-n))),
      o.setAttribute("voffset", R(n)),
      o
    );
  },
});
function mi(a, e, t) {
  for (
    var r = xe(a, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, i = 0;
    i < r.length;
    i++
  ) {
...
q({
  ...
  handler: (a, e) => {
    ...
    return { type: "sizing", mode: n.mode, size: ka.indexOf(r) + 1, body: i };
  },
  htmlBuilder: Il,
  mathmlBuilder: (a, e) => {
    var t = e.havingSize(a.size),
      r = Ce(a.body, t),
      n = new _.MathNode("mstyle", r);
    return n.setAttribute("mathsize", R(t.sizeMultiplier)), n;
  },
});
q({
  type: "smash",
...
q({
  ...
  htmlBuilder(a, e) {
    ...
    var g = u.height - t.height - s - m;
    t.style.paddingLeft = R(f);
    var w = k.makeVList(
      {
        positionType: "firstBaseline",
        children: [
          { type: "elem", elem: t, wrapperClasses: ["svg-align"] },
          { type: "kern", size: -(t.height + g) },
          { type: "elem", elem: u },
          { type: "kern", size: m },
        ],
      },
        ...
        z = k.makeVList(
          {
            positionType: "shift",
            positionData: -S,
            children: [{ type: "elem", elem: x }],
          },
          e,
        ),
        D = k.makeSpan(["root"], [z]);
      return k.makeSpan(["mord", "sqrt"], [D, w], e);
    } else return k.makeSpan(["mord", "sqrt"], [w], e);
  },
  mathmlBuilder(a, e) {
    var { body: t, index: r } = a;
    return r
      ? new _.MathNode("mroot", [oe(t, e), oe(r, e)])
      : new _.MathNode("msqrt", [oe(t, e)]);
  },
});
var Sa = {
  display: G.DISPLAY,
...
q({
  ...
  htmlBuilder(a, e) {
    ...
    return mi(a.body, r, e);
  },
  mathmlBuilder(a, e) {
    var t = Sa[a.style],
      r = e.havingStyle(t),
      n = Ce(a.body, r),
      i = new _.MathNode("mstyle", n),
      s = {
        display: ["0", "true"],
        text: ["0", "false"],
        script: ["1", "false"],
...
var El = function (e, t) {
  ...
  if (r)
    if (r.type === "op") {
      ...
      if (r.type === "accent") return P.isCharacterBox(r.base) ? Cr : null;
      if (r.type === "horizBrace") {
        var s = !e.sub;
        return s === r.isOver ? oi : null;
      } else return null;
    }
  else return null;
};
_0({
  ...
  htmlBuilder(a, e) {
    ...
    if (u) {
      ...
      (s instanceof Oe || A) && (D = R(-s.italic));
    }
    var N;
    if (o && u) {
      (f = Math.max(f, x, o.depth + 0.25 * m.xHeight)),
        (p = Math.max(p, m.sub2));
      var I = m.defaultRuleThickness,
        O = 4 * I;
      if (f - o.depth - (u.height - p) < O) {
        p = O - (f - o.depth) + u.height;
        var Y = 0.8 * m.xHeight - (f - o.depth);
        Y > 0 && ((f += Y), (p -= Y));
      }
      var Q = [
        { type: "elem", elem: u, shift: p, marginRight: z, marginLeft: D },
        { type: "elem", elem: o, shift: -f, marginRight: z },
      ];
      N = k.makeVList({ positionType: "individualShift", children: Q }, e);
    } else if (u) {
      p = Math.max(p, m.sub1, u.height - 0.8 * m.xHeight);
      var Z = [{ type: "elem", elem: u, marginLeft: D, marginRight: z }];
      N = k.makeVList(
    ...
    var K = hr(s, "right") || "mord";
    return k.makeSpan([K], [s, k.makeSpan(["msupsub"], [N])], e);
  },
  mathmlBuilder(a, e) {
    var t = !1,
      r,
...
_0({
  ...
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mo", [He(a.text, a.mode)]);
    if (a.family === "bin") {
      var r = _r(a, e);
...
var di = { mi: "italic", mn: "normal", mtext: "normal" };
_0({
  type: "mathord",
  htmlBuilder(a, e) {
  ...
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mi", [He(a.text, a.mode, e)]),
      r = _r(a, e) || "italic";
    return r !== di[t.type] && t.setAttribute("mathvariant", r), t;
  },
});
_0({
  type: "textord",
  ...
  mathmlBuilder(a, e) {
    var t = He(a.text, a.mode, e),
      r = _r(a, e) || "normal",
      n;
    return (
      a.mode === "text"
        ? (n = new _.MathNode("mtext", [t]))
        : /[0-9]/.test(a.text)
          ? (n = new _.MathNode("mn", [t]))
          : a.text === "\\prime"
            ? (n = new _.MathNode("mo", [t]))
            : (n = new _.MathNode("mi", [t])),
      r !== di[n.type] && n.setAttribute("mathvariant", r),
      n
    );
  },
});
...
_0({
  type: "spacing",
  htmlBuilder(a, e) {
    if (er.hasOwnProperty(a.text)) {
      var t = er[a.text].className || "";
      if (a.mode === "text") {
      ...
      if (Kt.hasOwnProperty(a.text))
        return k.makeSpan(["mspace", Kt[a.text]], [], e);
  ...
  mathmlBuilder(a, e) {
    var t;
    if (er.hasOwnProperty(a.text))
      t = new _.MathNode("mtext", [new _.TextNode(" ")]);
    else {
      if (Kt.hasOwnProperty(a.text)) return new _.MathNode("mspace");
      throw new B('Unknown type of space "' + a.text + '"');
    }
    return t;
  },
...
var za = () => {
  var a = new _.MathNode("mtd", []);
  return a.setAttribute("width", "50%"), a;
};
_0({
  type: "tag",
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mtable", [
      new _.MathNode("mtr", [
        za(),
        new _.MathNode("mtd", [g0(a.body, e)]),
        za(),
        new _.MathNode("mtd", [g0(a.tag, e)]),
      ]),
    ]);
...
var Ma = {
  ...
  Ta = { "\\textbf": "textbf", "\\textmd": "textmd" },
  Nl = { "\\textit": "textit", "\\textup": "textup" },
  Aa = (a, e) => {
    var t = a.font;
    if (t) {
      if (Ma[t]) return e.withTextFontFamily(Ma[t]);
      if (Ta[t]) return e.withTextFontWeight(Ta[t]);
      if (t === "\\emph")
...
q({
  ...
  htmlBuilder(a, e) {
    var t = ae(a.body, e),
      r = k.makeLineSpan("underline-line", e),
      n = e.fontMetrics().defaultRuleThickness,
      i = k.makeVList(
        {
          positionType: "top",
  ...
  mathmlBuilder(a, e) {
    var t = new _.MathNode("mo", [new _.TextNode("‾")]);
    t.setAttribute("stretchy", "true");
    var r = new _.MathNode("munder", [oe(a.body, e), t]);
    return r.setAttribute("accentunder", "true"), r;
  },
});
q({
  ...
  mathmlBuilder(a, e) {
    return new _.MathNode("mpadded", [oe(a.body, e)], ["vcenter"]);
  },
});
q({
  type: "verb",
  ...
  htmlBuilder(a, e) {
    for (
      var t = Da(a), r = [], n = e.havingStyle(e.style.text()), i = 0;
      i < t.length;
      i++
    ) {
      var s = t[i];
      s === "~" && (s = "\\textasciitilde"),
        r.push(
          k.makeSymbol(s, "Typewriter-Regular", a.mode, n, ["mord", "texttt"]),
        );
    }
    return k.makeSpan(
  ...
  mathmlBuilder(a, e) {
    var t = new _.TextNode(Da(a)),
      r = new _.MathNode("mtext", [t]);
    return r.setAttribute("mathvariant", "monospace"), r;
  },
});
var Da = (a) => a.body.replace(/ /g, a.star ? "␣" : " "),
  d0 = $n,
  fi = `[ \r
	]`,
  $l = "\\\\[a-zA-Z@]+",
...
class _a {
  constructor(e, t) {
    (this.input = void 0),
      ...
      (this.input = e),
      (this.settings = t),
      (this.tokenRegex = new RegExp(Hl, "g")),
      (this.catcodes = { "%": 14, "~": 13 });
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
...
d("\\char", function (a) {
  ...
  if (e.text === "'") (t = 8), (e = a.popToken());
    ...
    if (((e = a.popToken()), e.text[0] === "\\")) r = e.text.charCodeAt(1);
      ...
      if (e.text === "EOF") throw new B("\\char` missing argument");
      r = e.text.charCodeAt(0);
    }
  else t = 10;
  if (t) {
    if (((r = Ba[e.text]), r == null || r >= t))
      throw new B("Invalid base-" + t + " digit " + e.text);
    for (var n; (n = Ba[a.future().text]) != null && n < t; )
      (r *= t), (r += n), a.popToken();
  }
  return "\\@char{" + r + "}";
});
var Fr = (a, e, t, r) => {
  ...
  if (((n = a.consumeArg().tokens), n.length === 1 && n[0].text === "[")) {
    ...
    if (!u.match(/^\s*[0-9]+\s*$/))
      throw new B("Invalid number of arguments: " + u);
...
d("\\dots", function (a) {
  ...
  return (
    t in Ca
      ? (e = Ca[t])
      : (t.slice(0, 4) === "\\not" ||
          (t in ue.math && P.contains(["bin", "rel"], ue.math[t].group))) &&
        (e = "\\dotsb"),
    e
  );
});
...
d("\\tag@literal", (a) => {
  if (a.macros.get("\\df@tag")) throw new B("Multiple \\tag");
...
var pi = R(Ye["Main-Regular"][84][1] - 0.7 * Ye["Main-Regular"][65][1]);
d(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" +
    ("L\\kern-.36em\\raisebox{" + pi + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{LaTeX}}",
);
d(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" +
    ("K\\kern-.17em\\raisebox{" + pi + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{KaTeX}}",
);
...
var gi = (a) => (e) => {
  ...
  e.macros.beginGroup();
  var u = (p) => (g) => {
    a && (g.macros.set("|", s), n.length && g.macros.set("\\|", o));
    var w = p;
    if (!p && n.length) {
      var M = g.future();
      M.text === "|" && (g.popToken(), (w = !0));
    }
...
class Vl {
  constructor(e, t, r) {
    (this.settings = void 0),
      ...
      this.feed(e),
      (this.macros = new Pl(Ul, t.macros)),
      (this.mode = r),
      (this.stack = []);
  }
  feed(e) {
    this.lexer = new _a(e, this.settings);
  }
  switchMode(e) {
    this.mode = e;
  }
  ...
  consumeArgs(e, t) {
    if (t) {
      ...
      for (var r = t[0], n = 0; n < r.length; n++) {
        var i = this.popToken();
        if (r[n] !== i.text)
          throw new B("Use of the macro doesn't match its definition", i);
      }
    }
    for (var s = [], o = 0; o < e; o++)
  ...
  expandOnce(e) {
    ...
    if (n.numArgs) {
      ...
      for (var o = i.length - 1; o >= 0; --o) {
        ...
        if (u.text === "#") {
          if (o === 0)
            throw new B("Incomplete placeholder at end of macro body", u);
          if (((u = i[--o]), u.text === "#")) i.splice(o + 1, 1);
          else if (/^[1-9]$/.test(u.text)) i.splice(o, 2, ...s[+u.text - 1]);
          else throw new B("Not a valid argument number", u);
        }
      }
    }
    ...
    if (typeof n == "string") {
      ...
      if (n.indexOf("#") !== -1)
        for (var s = n.replace(/##/g, ""); s.indexOf("#" + (i + 1)) !== -1; )
          ++i;
      for (
        var o = new _a(n, this.settings), u = [], m = o.lex();
        m.text !== "EOF";
...
class Nt {
  constructor(e, t) {
    (this.mode = void 0),
      ...
      (this.mode = "math"),
      (this.gullet = new Vl(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var r = []; ; ) {
      ...
      var n = this.fetch();
      if (
        Nt.endOfExpression.indexOf(n.text) !== -1 ||
        (t && n.text === t) ||
  ...
  parseAtom(e) {
    ...
    for (var r, n; ; ) {
      ...
      if (i.text === "\\limits" || i.text === "\\nolimits") {
        ...
        else throw new B("Limit controls must follow a math operator", i);
        this.consume();
      } else if (i.text === "^") {
        if (r) throw new B("Double superscript", i);
        r = this.handleSupSubscript("superscript");
      } else if (i.text === "_") {
        if (n) throw new B("Double subscript", i);
        ...
        var m = Ra.test(i.text),
          f = [];
        for (f.push(new Le(dt[i.text])), this.consume(); ; ) {
          var p = this.fetch().text;
          if (!dt[p] || Ra.test(p) !== m) break;
          f.unshift(new Le(dt[p])), this.consume();
        }
        var g = this.subparse(f);
        m
          ? (n = { type: "ordgroup", mode: "math", body: g })
          : (r = { type: "ordgroup", mode: "math", body: g });
      } else break;
    }
    return r || n
  ...
  parseGroupOfType(e, t, r) {
    switch (t) {
      ...
      case "primitive": {
        ...
        if (s == null) throw new B("Expected group as " + e, this.fetch());
        return s;
      }
      case "original":
      case null:
  ...
  parseRegexGroup(e, t) {
    ...
    if (i === "") throw new B("Invalid " + t + ": '" + r.text + "'", r);
    return r.range(n, i);
  }
  parseColorGroup(e) {
  ...
  parseSizeGroup(e) {
    ...
    if (!An(i)) throw new B("Invalid unit: '" + i.unit + "'", t);
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      i == null && n[0] === "\\" && !vi.hasOwnProperty(n))
    ) {
  ...
  parseSymbol() {
    ...
    if ((this.consume(), i))
      for (var p = 0; p < i[0].length; p++) {
        var g = i[0][p];
        if (!tr[g]) throw new B("Unknown accent ' " + g + "'", e);
        var w = tr[g][this.mode] || tr[g].text;
        if (!w)
          throw new B(
            "Accent " + g + " unsupported in " + this.mode + " mode",
            e,
          );
        s = {
          type: "accent",
...
Nt.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
var Hr = function (e, t) {
    ...
    if (
      ...
      if (!t.displayMode) throw new B("\\tag works only in display equations");
      n = [
        {
          type: "tag",
          mode: "text",
...
var Gl = function (e, t) {
  ...
  yi = function (e, t, r) {
    ...
    var n = k.makeSpan(["katex-error"], [new Oe(t)]);
    return (
...
const xi = /[&<>"']/,
  Jl = new RegExp(xi.source, "g"),
  ki = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  Ql = new RegExp(ki.source, "g"),
  Kl = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  Ea = (a) => Kl[a];
function Ie(a, e) {
  if (e) {
    if (xi.test(a)) return a.replace(Jl, Ea);
  } else if (ki.test(a)) return a.replace(Ql, Ea);
  return a;
}
const eo = /&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;
function to(a) {
  return a.replace(
    eo,
    (e, t) => (
...
function le(a, e) {
  ...
  const r = {
    replace: (n, i) => {
      ...
      return (s = s.replace(ro, "$1")), (t = t.replace(n, s)), r;
    },
...
function qa(a, e, t, r) {
  ...
  return { type: "image", raw: t, href: n, title: i, text: Ie(s) };
}
function no(a, e) {
  const t = a.match(/^(\s+)(?:```)/);
  if (t === null) return e;
...
`),
          ...
          const z = new RegExp(
            ...
            A = new RegExp(`^ {0,${Math.min(3, w - 1)}}(?:\`\`\`|~~~)`),
            N = new RegExp(`^ {0,${Math.min(3, w - 1)}}#`);
          for (; e; ) {
            const I = e.split(
              `
`,
            ...
            if (
              ...
              this.options.pedantic &&
                (g = g.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")),
              A.test(g) || N.test(g) || z.test(g) || D.test(e))
            )
              break;
...
`
  ...
  escape(e) {
    ...
    if (t) return { type: "escape", raw: t[0], text: Ie(t[1]) };
  }
  tag(e) {
  ...
  emStrong(e, t, r = "") {
    ...
    if (!(n[1] || n[2] || "") || !r || this.rules.inline.punctuation.exec(r)) {
      ...
      for (
        ...
        if (((m -= u), m > 0)) continue;
        u = Math.min(u, u + m + f);
        const g = [...n[0]][0].length,
          w = e.slice(0, s + n.index + g + u);
        if (Math.min(s, u) % 2) {
          const x = w.slice(1, -1);
          return {
            type: "em",
          ...
          (s = t[0]),
            (t[0] =
              ((r = this.rules.inline._backpedal.exec(t[0])) == null
                ...
                : r[0]) ?? "");
        while (s !== t[0]);
        (n = Ie(t[0])), t[1] === "www." ? (i = "http://" + t[0]) : (i = t[0]);
      }
      return {
        type: "link",
        raw: t[0],
  ...
  inlineText(e) {
    ...
    if (t) {
      let r;
      return (
        this.lexer.state.inRawBlock ? (r = t[0]) : (r = Ie(t[0])),
...
const io = /^(?: *(?:\n|$))+/,
  ...
  bo =
    /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,
  et = "\\p{P}\\p{S}",
  yo = le(/^((?![*_])[\spunctuation])/, "u")
    .replace(/punctuation/g, et)
    .getRegex(),
  wo = /\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,
  xo = le(
  ...
  Co = {
    ...pr,
    br: le(Ai).replace("{2,}", "*").getRegex(),
    text: le(pr.text)
      .replace("\\b_", "\\b_| {2,}\\n")
      .replace(/\{2,\}/g, "*")
      .getRegex(),
  },
  pt = { normal: Yr, gfm: po, pedantic: go },
  O0 = { normal: Xr, gfm: pr, breaks: Co, pedantic: Bo };
class We {
  constructor(e) {
    he(this, "tokens");
    he(this, "options");
    ...
    (this.tokens = []),
      ...
      (this.options = e || B0),
      (this.options.tokenizer = this.options.tokenizer || new Mt()),
      (this.tokenizer = this.options.tokenizer),
      (this.tokenizer.options = this.options),
      (this.tokenizer.lexer = this),
      (this.inlineQueue = []),
      (this.state = { inLink: !1, inRawBlock: !1, top: !0 });
    const t = { block: pt.normal, inline: O0.normal };
    this.options.pedantic
      ? ((t.block = pt.pedantic), (t.inline = O0.pedantic))
      : this.options.gfm &&
        ((t.block = pt.gfm),
        ...
        if (
          ...
          this.options.extensions.startInline.forEach((w) => {
            (g = w.call({ lexer: this }, p)),
              typeof g == "number" && g >= 0 && (f = Math.min(f, g));
          }),
      ...
      switch (i.type) {
        ...
        case "heading": {
          ...
          r += this.renderer.heading(
            ...
            s.depth,
            to(this.parseInline(s.tokens, this.textRenderer)),
          );
          continue;
        }
        case "code": {
        ...
        case "table": {
          ...
          for (let f = 0; f < s.rows.length; f++) {
            ...
            for (let g = 0; g < p.length; g++)
              u += this.renderer.tablecell(this.parseInline(p[g].tokens), {
                header: !1,
                align: s.align[g],
              });
            ...
            if (g.task) {
              ...
              m
                ? g.tokens.length > 0 && g.tokens[0].type === "paragraph"
                  ? ((g.tokens[0].text = S + " " + g.tokens[0].text),
                    g.tokens[0].tokens &&
                      g.tokens[0].tokens.length > 0 &&
                      g.tokens[0].tokens[0].type === "text" &&
                      (g.tokens[0].tokens[0].text =
                        S + " " + g.tokens[0].tokens[0].text))
                  : g.tokens.unshift({ type: "text", text: S + " " })
                : (x += S + " ");
            }
            (x += this.parse(g.tokens, m)),
              (f += this.renderer.listitem(x, M, !!w));
          }
...
class Ro {
  constructor(...e) {
    ...
    he(this, "parse", nt(this, W0, gr).call(this, We.lex, Ze.parse));
    he(
      this,
      "parseInline",
      nt(this, W0, gr).call(this, We.lexInline, Ze.parseInline),
    );
    he(this, "Parser", Ze);
    he(this, "Renderer", At);
    he(this, "TextRenderer", Wr);
    he(this, "Lexer", We);
    he(this, "Tokenizer", Mt);
    he(this, "Hooks", V0);
    this.use(...e);
  }
  walkTokens(e, t) {
  ...
  use(...e) {
    ...
    return (
      e.forEach((r) => {
        ...
        if (r.tokenizer) {
          const i = this.defaults.tokenizer || new Mt(this.defaults);
        ...
        if (r.hooks) {
          const i = this.defaults.hooks || new V0();
          for (const s in r.hooks) {
            ...
            const o = s,
              u = r.hooks[o],
              m = i[o];
            V0.passThroughHooks.has(s)
              ? (i[o] = (f) => {
                  if (this.defaults.async)
                    return Promise.resolve(u.call(i, f)).then((g) =>
                      m.call(i, g),
                    );
                  const p = u.call(i, f);
                  return m.call(i, p);
  ...
  (gr = function (e, t) {
    return (r, n) => {
      ...
      this.defaults.async === !0 &&
        ...
        (s.async = !0));
      const o = nt(this, Dt, Bi).call(this, !!s.silent, !!s.async);
...
Please report this to https://github.com/markedjs/marked.`),
        ...
        const n =
          "<p>An error occurred:</p><pre>" + Ie(r.message + "", !0) + "</pre>";
...
ie.options = ie.setOptions = function (a) {
  return M0.setOptions(a), (ie.defaults = M0.defaults), wi(ie.defaults), ie;
};
ie.getDefaults = Ur;
ie.defaults = B0;
ie.use = function (...a) {
  return M0.use(...a), (ie.defaults = M0.defaults), wi(ie.defaults), ie;
};
ie.walkTokens = function (a, e) {
  return M0.walkTokens(a, e);
};
ie.parseInline = M0.parseInline;
ie.Parser = Ze;
ie.parser = Ze.parse;
ie.Renderer = At;
ie.TextRenderer = Wr;
...
(function (a) {
  (function () {
    ...
    function n(x, S, z) {
      ...
      function Q(K, $, F, X) {
        for (
          var C = "", U = null, ke = !1, re = K.length, se = !1, Se = 0;
          Se < re;
          Se++
        ) {
          ...
          if (ke === !0) {
            ...
            switch (pe) {
              ...
              case 66:
                ...
                break;
              case 67:
                C += i(Math.floor($.getFullYear() / 100), U);
                break;
              case 68:
                C += Q(F.formats.D, $, F, X);
                break;
              ...
              case 90:
                ...
                break;
              case 97:
                C += F.shortDays[$.getDay()];
                break;
              case 98:
                C += F.shortMonths[$.getMonth()];
                break;
              case 99:
                C += Q(F.formats.c, $, F, X);
                break;
              ...
              case 104:
                ...
                break;
              case 106:
                var ge = new Date($.getFullYear(), 0, 1),
                  ve = Math.ceil(
                    ($.getTime() - ge.getTime()) / (1e3 * 60 * 60 * 24),
                  );
                C += s(ve);
                break;
              case 107:
...
`;
              ...
              case 111:
                var ve = $.getDate();
                F.ordinalSuffixes
                  ? (C += String(ve) + (F.ordinalSuffixes[ve - 1] || m(ve)))
                  : (C += String(ve) + m(ve));
                break;
              case 112:
                C += $.getHours() < 12 ? F.AM : F.PM;
              ...
              case 120:
                ...
                break;
              case 121:
                let C0 = $.getFullYear() % 100;
                C += i(C0, U);
                break;
              case 122:
                if (N && A === 0) C += se ? "+00:00" : "+0000";
                else {
                  var $e;
                  A !== 0
                    ? ($e = A / (60 * 1e3))
      ...
      return (
        ...
        (Z.timezone = function (K) {
          ...
          if (X === "number" || X === "string")
            if (((F = !0), X === "string")) {
              var C = K[0] === "-" ? -1 : 1,
                U = parseInt(K.slice(1, 3), 10),
                ke = parseInt(K.slice(3, 5), 10);
              $ = C * (60 * U + ke) * 60 * 1e3;
            } else X === "number" && ($ = K * 60 * 1e3);
          return new n(D, $, F);
        }),
        (Z.utc = function () {
          return new n(D, A, !0);
    ...
    function u(x, S) {
      ...
      var z = x.getDay();
      S === "monday" && (z === 0 ? (z = 6) : z--);
      var D = Date.UTC(x.getFullYear(), 0, 1),
        A = Date.UTC(x.getFullYear(), x.getMonth(), x.getDate()),
        N = Math.floor((A - D) / 864e5),
        I = (N + 7 - z) / 7;
      return Math.floor(I);
    }
    function m(x) {
  ...
  return {
    ...
    l(u) {
      ...
      (t = te(m, "SPAN", { class: !0, "data-svelte-h": !0 })),
        an(t) !== "svelte-a7fxhe" && (t.textContent = r),
        (n = j0(m, " Our paper: ")),
        (i = te(m, "EM", {}));
      var f = ne(i);
      (s = j0(f, a[1])), f.forEach(H), m.forEach(H), this.h();
    },
    h() {
      E(t, "class", "text-neutral-500"),
        E(e, "href", (o = "#" + a[0])),
        E(
          e,
          "class",
    ...
    m(u, m) {
      we(u, e, m), W(e, t), W(e, n), W(e, i), W(i, s);
    },
    p(u, [m]) {
      m & 1 && o !== (o = "#" + u[0]) && E(e, "href", o);
    },
    i: Fe,
    o: Fe,
    d(u) {
...
function Lo(a, e, t) {
  ...
  const i = Object.entries(
    Object.assign({
      "../../projects/model_scaling.md": pn,
      "../../projects/utd_scaling.md": zn,
    }),
  ).reduce((u, [m, f]) => {
    const p = vr(m) || m;
  ...
  return {
    ...
    l(u) {
      ...
      (t = te(m, "DIV", { class: !0, "data-svelte-h": !0 })),
        an(t) !== "svelte-8vdxxn" && (t.textContent = r),
        (n = Be(m)),
        (i = te(m, "DIV", { class: !0 }));
      var f = ne(i);
      s = te(f, "DIV", { class: !0 });
      var p = ne(s);
      (o = yr(p, !1)), p.forEach(H), f.forEach(H), m.forEach(H), this.h();
    },
    h() {
      E(
        t,
        ...
        (o.a = null),
        E(s, "class", "md-output"),
        E(i, "class", "prose max-w-none mt-1"),
        E(
          e,
          "class",
    ...
    m(u, m) {
      we(u, e, m), W(e, t), W(e, n), W(e, i), W(i, s), o.m(a[0], s);
    },
    p(u, [m]) {
      m & 1 && o.p(u[0]);
    },
...
class Po extends A0 {
  constructor(e) {
    super(), D0(this, e, Ho, Oo, T0, { html: 0 });
  }
}
function Oa(a, e, t) {
  const r = a.slice();
  return (r[5] = e[t]), (r[7] = t), r;
}
function Uo(a) {
  let e,
    t,
  ...
  return {
    c() {
      (e = ee("div")), (t = new br(!1)), this.h();
    },
    l(n) {
      e = te(n, "DIV", { class: !0 });
      var i = ne(e);
      (t = yr(i, !1)), i.forEach(H), this.h();
    },
    h() {
      (t.a = null), E(e, "class", "md-output text-sm sm-block svelte-1edusnx");
    },
    m(n, i) {
      we(n, e, i), t.m(r, e);
    },
    p(n, i) {
      i & 2 && r !== (r = q0(n[5].content) + "") && t.p(r);
    },
    i: Fe,
    o: Fe,
    d(n) {
...
function Vo(a) {
  let e, t;
  return (
    (e = new Po({ props: { html: q0(a[5].content) } })),
    {
      c() {
        x0(e.$$.fragment);
      },
      ...
      p(r, n) {
        const i = {};
        n & 2 && (i.html = q0(r[5].content)), e.$set(i);
      },
      i(r) {
...
function Go(a) {
  let e, t;
  return (
    (e = new Fo({ props: { id: a[5].id, label: a[5].label } })),
    {
      c() {
        x0(e.$$.fragment);
      },
      ...
      p(r, n) {
        const i = {};
        n & 2 && (i.id = r[5].id), n & 2 && (i.label = r[5].label), e.$set(i);
      },
      i(r) {
        t || (Ve(e.$$.fragment, r), (t = !0));
      },
...
function jo(a) {
  ...
  return {
    ...
    h() {
      (t.a = null), E(e, "class", "md-output svelte-1edusnx");
    },
    m(n, i) {
      we(n, e, i), t.m(r, e);
    },
...
function Ha(a, e) {
  ...
  return (
    ~(r = m(e)) && (n = u[r] = o[r](e)),
    {
      ...
      first: null,
      c() {
        (t = I0()), n && n.c(), (i = I0()), this.h();
      },
      l(f) {
        (t = I0()), n && n.l(f), (i = I0()), this.h();
      },
      h() {
        this.first = t;
      },
      m(f, p) {
        we(f, t, p), ~r && u[r].m(f, p), we(f, i, p), (s = !0);
      },
      p(f, p) {
        e = f;
        let g = r;
...
function Yo(a) {
  ...
  return {
    ...
    h() {
      E(e, "class", "md-output space-y-6 svelte-1edusnx");
    },
    m(o, u) {
      we(o, e, u);
    ...
    p(o, [u]) {
      u & 2 &&
        ((i = Je(o[1])),
        wr(),
        (t = nn(t, u, s, 1, o, i, r, e, sn, Ha, null, Oa)),
        xr());
    },
    i(o) {
      if (!n) {
        for (let u = 0; u < i.length; u += 1) Ve(t[u]);
        n = !0;
      }
    },
    o(o) {
      for (let u = 0; u < t.length; u += 1) Ge(t[u]);
      n = !1;
    },
    d(o) {
      o && H(e);
...
function Ri(a, e) {
  try {
    return Zl.renderToString(a, { throwOnError: !1, displayMode: e });
  } catch {
    const r = e ? "pre" : "code";
...
const Xo = {
    ...
    renderer: (a) => `<div class="math math-block">${Ri(a.text, !0)}</div>`,
  },
  Wo = {
    name: "mathInline",
    level: "inline",
    ...
    renderer: (a) => `<span class="math math-inline">${Ri(a.text, !1)}</span>`,
  },
  Zo = {
    link(a, e, t) {
  ...
  Jo = {
    ...
    renderer(a) {
          ...
          i =
            ...
            (n.endsWith(".webm")
              ...
              : n.endsWith(".ogg")
                ? "video/ogg"
                : "video/mp4"),
          s = a.attrs.freeze || "10000";
        r += `<video class="block mx-auto autoplay-on-fullview md-video" aria-label="${a.alt || ""}"`;
        const o = Object.prototype.hasOwnProperty.call(a.attrs, "playsinline");
      ...
      return (
        a.title &&
          (r += `<div class='text-center text-gray-500 mb-4 md:px-8 lg:px-12 text-sm'>${ie.parse(a.title, { smartypants: !0 })}</div>`),
        r
      );
    },
  };
ie.use({ gfm: !0, extensions: [Jo, Xo, Wo], renderer: Zo });
const rr = /:::jumpbox\s+id="([^"]+)"(?:\s+label="([^"]+)")?\s*:::/gm,
  Pa = /:::takeaway_begin:::/gm,
  ar = /:::takeaway_end:::/gm,
  Qo = /:::small_begin:::/gm,
  nr = /:::small_end:::/gm;
function q0(a) {
  return ie.parse(a, { smartypants: !0 });
}
function Ko(a, e, t) {
  let r,
    { source: n } = e,
  ...
  function s(u) {
    const f = Array.from(
      u.querySelectorAll("video.autoplay-on-fullview"),
    ).filter((g) => !g.dataset._wired);
    if (f.length === 0) return;
    for (const g of f) {
      (g.controls = !1), (g.dataset._wired = "1");
      let w = !1;
      const M = () => {
        (w = !0), window.removeEventListener("touchstart", M);
      };
      window.addEventListener("touchstart", M, { passive: !0, once: !0 });
      const x = () => {
          w || (g.controls = !0);
        },
        S = () => {
      ...
      g.addEventListener("mouseenter", x),
      ...
      const D = () => {
        ...
        A = () => {
          const N = parseInt(g.dataset.freezeMs || "10000", 10);
          D(),
            (z = window.setTimeout(() => {
              try {
                g.currentTime = 0;
      ...
      ["play", "pause", "seeking", "emptied", "abort"].map((N) =>
        g.addEventListener(N, D),
      ),
        g.addEventListener("ended", A),
        (g._cleanupVideo = () => {
          g.removeEventListener("mouseenter", x),
            g.removeEventListener("mouseleave", S),
            g.removeEventListener("focus", x),
            g.removeEventListener("blur", S),
            g.removeEventListener("ended", A),
            D();
        });
    }
    if (!s._io) {
      const g = new IntersectionObserver(
        (w) => {
          for (const M of w) {
            const x = M.target,
              S = x._clearRestartTimer;
            if ((S && S(), M.intersectionRatio >= 1)) {
              const z = x.play();
              z && typeof z.catch == "function" && z.catch(() => {});
            } else x.pause();
          }
        },
        { threshold: 1 },
  ...
  bt(() => {
    ...
    tn(() => {
      ...
      const u = s._io;
      i &&
        i.querySelectorAll("video.autoplay-on-fullview").forEach((m) => {
          u.unobserve(m);
          const f = m._cleanupVideo;
          f && f();
        });
    });
  function o(u) {
      ...
      a.$$.dirty & 4 &&
        t(
          ...
          (r = (() => {
            ...
            let f = 0;
            for (; f < n.length; ) {
              (rr.lastIndex = f), (Pa.lastIndex = f);
              const p = rr.exec(n),
                g = Pa.exec(n),
                w = Qo.exec(n);
              if (!p && !g && !w) {
                f < n.length && m.push({ type: "text", content: n.slice(f) });
                break;
              }
              const M = p ? p.index : 1 / 0,
                x = g ? g.index : 1 / 0,
                S = w ? w.index : 1 / 0;
              if (M <= x && M <= S) {
                M > f && m.push({ type: "text", content: n.slice(f, M) });
                const z = p[1],
                  D = (u = p[2]) !== null && u !== void 0 ? u : z;
                m.push({ type: "jumpbox", id: z, label: D }),
                  (f = rr.lastIndex);
              } else if (x <= M && x <= S) {
                const z = g.index,
                  D = z + g[0].length;
                z > f && m.push({ type: "text", content: n.slice(f, z) }),
                  (ar.lastIndex = D);
                const A = ar.exec(n);
                if (!A) {
                  m.push({ type: "text", content: n.slice(z, D) }), (f = D);
                  continue;
                }
                const N = n.slice(D, A.index).trim();
                m.push({ type: "takeaway", content: N }), (f = ar.lastIndex);
              } else {
                const z = w.index,
                  D = z + w[0].length;
                z > f && m.push({ type: "text", content: n.slice(f, z) }),
                ...
                const N = n.slice(D, A.index).trim();
                m.push({ type: "small", content: N }), (f = nr.lastIndex);
              }
            }
            return m;
          })()),
...
class Ii extends A0 {
  constructor(e) {
    super(), D0(this, e, Ko, Yo, T0, { source: 2 });
  }
}
function Ua(a, e, t) {
  const r = a.slice();
...
function Va(a) {
  let e,
    t = Je(a[0]),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = Ga(Ua(a, t, n));
  return {
    c() {
    ...
    p(n, i) {
      if (i & 37) {
        ...
        for (s = 0; s < t.length; s += 1) {
          ...
          r[s]
            ? r[s].p(o, i)
            : ((r[s] = Ga(o)), r[s].c(), r[s].m(e.parentNode, e));
        }
  ...
  return {
    ...
    h() {
      E(e, "href", (t = `#${a[16].id}`)),
        ...
        E(e, "style", (n = `top: calc(${a[5](a[16]) * 100}% - 1px);`)),
        E(e, "aria-label", (i = a[16].label)),
        E(e, "data-label", (s = a[16].label));
    },
    m(o, u) {
      we(o, e, u);
    },
    p(o, u) {
      u & 1 && t !== (t = `#${o[16].id}`) && E(e, "href", t),
        u & 5 &&
          r !==
            (r =
              Qr(
        ...
        u & 1 &&
          ...
          E(e, "style", n),
        u & 1 && i !== (i = o[16].label) && E(e, "aria-label", i),
        u & 1 && s !== (s = o[16].label) && E(e, "data-label", s);
    },
    d(o) {
      o && H(e);
    },
...
function e1(a) {
  ...
  return {
    ...
    h() {
      E(r, "class", "gradient svelte-1n1du4b"),
        E(
          r,
          "style",
          (n = a[4] ? `clip-path: inset(0 0 ${100 - a[1] * 100}% 0);` : ""),
        ),
        E(t, "class", "track svelte-1n1du4b"),
        E(e, "class", "scroll-meter svelte-1n1du4b"),
        E(e, "aria-hidden", "true"),
        yt(e, "ready", a[3]);
    },
    m(o, u) {
      we(o, e, u), W(e, t), W(t, r), W(t, i), s && s.m(t, null);
    },
    p(o, [u]) {
      u & 18 &&
        n !==
...
function r1(a, e, t) {
  ...
  function w() {
    ...
    const A = u ? u.querySelectorAll(n) : document.querySelectorAll(n);
    t(
      0,
      (i = Array.from(A)
        .filter((N) => t1(N))
  ...
  function M() {
    ...
    if (u) {
      ...
      t(1, (s = Math.min(1, Math.max(0, (A - O) / Y))));
    } else {
      const Y = Math.max(
        document.documentElement.scrollHeight - window.innerHeight,
        1,
      );
      t(1, (s = Math.min(1, Math.max(0, (A - 0) / Y))));
    }
    const N = window.scrollY + 8;
    let I = -1;
    for (let O = 0; O < i.length && i[O].top <= N; O++) I = O;
    t(2, (o = I));
  }
  function x(A) {
    if (!u) {
      ...
      return Math.min(1, Math.max(0, A.top / Q));
    }
    const N = g(u),
      I = u.getBoundingClientRect().height,
      O = N + I;
    return Math.min(1, Math.max(0, (A.top - N) / Math.max(O - N, 1)));
  }
  let S,
    z,
    D = null;
  return (
    bt(() => {
      if (
        ...
        A && ((D = new ResizeObserver(() => w())), D.observe(A));
      }
    }),
    tn(() => {
    ...
    (a.$$set = (A) => {
      "containerSelector" in A && t(6, (r = A.containerSelector)),
        "headingsSelector" in A && t(7, (n = A.headingsSelector));
    }),
    [i, s, o, m, p, x, r, n]
  );
}
class a1 extends A0 {
  constructor(e) {
    super(),
      D0(this, e, r1, e1, T0, { containerSelector: 6, headingsSelector: 7 });
  }
}
function ja(a, e, t) {
  const r = a.slice();
...
function Xa(a) {
  ...
  return {
    ...
    l(i) {
      ...
      var s = ne(e);
      (t = te(s, "SOURCE", { src: !0, type: !0 })), s.forEach(H), this.h();
    },
    h() {
      N0(t.src, (r = a[0].image_after)) || E(t, "src", r),
        E(t, "type", "video/mp4"),
        E(
          e,
          "class",
        ...
        E(e, "preload", "metadata"),
        (e.muted = !0),
        (e.loop = !0),
        (e.playsInline = !0),
        E(e, "aria-hidden", "true"),
        E(e, "tabindex", "-1"),
        E(e, "poster", (n = a[0].image_before));
    },
    m(i, s) {
      we(i, e, s), W(e, t), a[8](e);
    },
    p(i, s) {
      s & 1 && !N0(t.src, (r = i[0].image_after)) && E(t, "src", r),
        s & 2 && Ot(e, "opacity", i[1] ? 1 : 0),
        s & 1 && n !== (n = i[0].image_before) && E(e, "poster", n);
    },
    d(i) {
      i && H(e), a[8](null);
    },
...
function Wa(a) {
  let e,
    t = Je(a[0].resources),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = Za(Ya(a, t, n));
  return {
    c() {
      e = ee("div");
      for (let n = 0; n < r.length; n += 1) r[n].c();
    ...
    h() {
      E(e, "class", "flex flex-wrap gap-2");
    },
    m(n, i) {
      we(n, e, i);
    ...
    p(n, i) {
      if (i & 1) {
        ...
        for (s = 0; s < t.length; s += 1) {
          const o = Ya(n, t, s);
          r[s] ? r[s].p(o, i) : ((r[s] = Za(o)), r[s].c(), r[s].m(e, null));
        }
        for (; s < r.length; s += 1) r[s].d(1);
        r.length = t.length;
      }
...
function Za(a) {
  ...
  return {
    c() {
      (e = ee("a")), (r = G0(t)), (n = _e()), this.h();
    },
    l(s) {
      e = te(s, "A", { href: !0, target: !0, class: !0 });
      var o = ne(e);
      (r = j0(o, t)), (n = Be(o)), o.forEach(H), this.h();
    },
    h() {
      E(e, "href", (i = a[17])),
        E(e, "target", "_blank"),
    ...
    m(s, o) {
      we(s, e, o), W(e, r), W(e, n);
    },
    p(s, o) {
      o & 1 && t !== (t = s[16] + "") && ir(r, t),
        o & 1 && i !== (i = s[17]) && E(e, "href", i);
    },
    d(s) {
      s && H(e);
    },
...
function Ja(a) {
  let e,
    t = Je(a[0].subimages),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = Qa(ja(a, t, n));
  return {
    c() {
      e = ee("div");
      for (let n = 0; n < r.length; n += 1) r[n].c();
    ...
    h() {
      E(e, "class", "grid grid-cols-3 gap-4 md:gap-8 lg:gap-12 mt-4");
    },
    m(n, i) {
      we(n, e, i);
      for (let s = 0; s < r.length; s += 1) r[s] && r[s].m(e, null);
    ...
    p(n, i) {
      if (i & 1) {
        ...
        for (s = 0; s < t.length; s += 1) {
          const o = ja(n, t, s);
          r[s] ? r[s].p(o, i) : ((r[s] = Qa(o)), r[s].c(), r[s].m(e, null));
        }
        for (; s < r.length; s += 1) r[s].d(1);
        r.length = t.length;
      }
...
function Qa(a) {
  ...
  return {
    ...
    h() {
      N0(t.src, (r = a[13])) || E(t, "src", r),
        E(t, "alt", (n = a[0].title + " subimage")),
        E(e, "class", "col-span-full md:col-span-1");
    },
    m(s, o) {
      we(s, e, o), W(e, t), W(e, i);
    },
    p(s, o) {
      o & 1 && !N0(t.src, (r = s[13])) && E(t, "src", r),
        o & 1 && n !== (n = s[0].title + " subimage") && E(t, "alt", n);
    },
    d(s) {
      s && H(e);
    },
...
function n1(a) {
  ...
  let e,
    ...
    F,
    X = a[2] && Xa(a);
  O = new Ii({ props: { source: a[0].content } });
  let C = ((ke = a[0].resources) == null ? void 0 : ke.length) && Wa(a),
    U = a[0].subimages && Ja(a);
  return {
    c() {
      (e = ee("div")),
        (t = ee("div")),
    ...
    l(re) {
      ...
      n = te(pe, "DIV", { class: !0 });
      var ze = ne(n);
      (i = te(ze, "IMG", { src: !0, alt: !0, class: !0 })),
        (u = Be(ze)),
        X && X.l(ze),
        ze.forEach(H),
        pe.forEach(H),
      ...
      p = te(ge, "H3", { class: !0 });
      var ve = ne(p);
      g = te(ve, "A", { class: !0, href: !0, target: !0 });
      var $e = ne(g);
      (M = j0($e, w)),
        $e.forEach(H),
        (S = Be(ve)),
    ...
    h() {
      N0(i.src, (s = a[4])) || E(i, "src", s),
        E(i, "alt", (o = a[0].title + " preview image")),
        E(i, "class", "w-full block"),
        yt(i, "border", a[0].image_border),
        E(n, "class", "relative w-full max-w-80 mx-auto"),
        E(r, "class", "col-span-4 md:col-span-1"),
        E(g, "class", "link-no-underline mr-1"),
        E(g, "href", (x = a[0].link)),
        E(g, "target", "_blank"),
        E(
          z,
        ...
        E(p, "class", "text-black text-lg font-semibold mb-2 no-meter"),
        E(I, "class", "text-sm reduced-spacing"),
        E(f, "class", "col-span-4 md:col-span-3"),
        E(t, "class", "grid grid-cols-4 gap-4"),
        E(e, "role", "group"),
        E(
          e,
          "class",
    ...
    m(re, se) {
      we(re, e, se),
        ...
        (K = !0),
        $ ||
          ((F = [Kr(e, "mouseenter", a[9]), Kr(e, "mouseleave", a[10])]),
          ($ = !0));
    },
    p(re, [se]) {
      var pe;
      (!K || (se & 16 && !N0(i.src, (s = re[4])))) && E(i, "src", s),
        (!K || (se & 1 && o !== (o = re[0].title + " preview image"))) &&
          E(i, "alt", o),
        (!K || se & 1) && yt(i, "border", re[0].image_border),
        re[2]
          ? X
            ? X.p(re, se)
            : ((X = Xa(re)), X.c(), X.m(n, null))
          : X && (X.d(1), (X = null)),
        (!K || se & 1) && w !== (w = re[0].title + "") && ir(M, w),
        (!K || (se & 1 && x !== (x = re[0].link))) && E(g, "href", x),
        (!K || se & 1) && D !== (D = Fa("%B %Y", re[0].date) + "") && ir(A, D);
      const Se = {};
      se & 1 && (Se.source = re[0].content),
        O.$set(Se),
        (pe = re[0].resources) != null && pe.length
          ? C
            ? C.p(re, se)
            : ((C = Wa(re)), C.c(), C.m(f, null))
          : C && (C.d(1), (C = null)),
        re[0].subimages
          ? U
            ? U.p(re, se)
            : ((U = Ja(re)), U.c(), U.m(e, null))
          : U && (U.d(1), (U = null)),
        (!K ||
          (se & 1 &&
            Z !==
    ...
    i(re) {
      K || (Ve(O.$$.fragment, re), (K = !0));
    },
    o(re) {
      Ge(O.$$.fragment, re), (K = !1);
    },
    d(re) {
      re && H(e), X && X.d(), z0(O), C && C.d(), U && U.d(), ($ = !1), Hi(F);
    },
  };
}
function i1(a, e, t) {
  ...
  const g = () => {
      ...
      f("play() called", {
        ...
        M.then(() => f("play() resolved")).catch((x) =>
          f(
            "play() rejected",
...
In Figure 4, we observed that for small models, larger batch sizes worsened generalization; for large models, larger batch sizes helped. (See Appendix B of [our new paper](https://arxiv.org/abs/2508.14881) for more details on constructing the validation dataset). It’s helpful to look at these curves over the course of training, since in the practical implementation of TD-learning, value functions rarely fully fit the moving TD-targets.
...
function en(a, e) {
  let t, r, n, i, s;
  return (
    (r = new s1({ props: { data: e[3][e[7]], stars: e[0] } })),
    {
      key: a,
      first: null,
      c() {
        (t = ee("section")), x0(r.$$.fragment), (n = _e()), this.h();
      },
      l(o) {
        t = te(o, "SECTION", { id: !0, class: !0 });
        var u = ne(t);
        k0(r.$$.fragment, u), (n = Be(u)), u.forEach(H), this.h();
      },
      h() {
        E(t, "id", (i = vr(e[7]))),
          E(t, "class", "svelte-1w2o5k5"),
          (this.first = t);
      },
      m(o, u) {
        we(o, t, u), S0(r, t, null), W(t, n), (s = !0);
      },
      p(o, u) {
        e = o;
        const m = {};
        u & 6 && (m.data = e[3][e[7]]),
          u & 1 && (m.stars = e[0]),
          r.$set(m),
          (!s || (u & 6 && i !== (i = vr(e[7])))) && E(t, "id", i);
      },
      i(o) {
        s || (Ve(r.$$.fragment, o), (s = !0));
      },
      o(o) {
        Ge(r.$$.fragment, o), (s = !1);
      },
...
function o1(a) {
  ...
  (e = new Wi({
    ...
    (n = new a1({ props: { containerSelector: "#article .md-output" } }));
  let M = Je(a[2]);
  const x = (S) => S[7];
  ...
  return (
    (g = new Ii({ props: { source: l1 } })),
    {
      c() {
        ...
        (f = _e()), (p = ee("div")), x0(g.$$.fragment), this.h();
      },
      l(S) {
        k0(e.$$.fragment, S), (t = Be(S)), (r = te(S, "DIV", {}));
        var z = ne(r);
        k0(n.$$.fragment, z), (i = Be(z)), (s = te(z, "DIV", { class: !0 }));
        var D = ne(s);
        o = te(D, "DIV", { class: !0 });
        var A = ne(o);
        for (let I = 0; I < u.length; I += 1) u[I].l(A);
        A.forEach(H),
          D.forEach(H),
          (f = Be(z)),
          (p = te(z, "DIV", { class: !0 }));
        var N = ne(p);
        k0(g.$$.fragment, N), N.forEach(H), z.forEach(H), this.h();
      },
      h() {
        E(o, "class", "space-y-2"),
          E(s, "class", "layout-md text-lg space-y-12"),
          E(p, "class", "layout-md text-lg space-y-12");
      },
      m(S, z) {
        S0(e, S, z),
          we(S, t, z),
          ...
          W(r, s),
          W(s, o);
        for (let D = 0; D < u.length; D += 1) u[D] && u[D].m(o, null);
        W(r, f), W(r, p), S0(g, p, null), (w = !0);
      },
      p(S, [z]) {
        z & 15 &&
          ((M = Je(S[2])),
          wr(),
          (u = nn(u, z, x, 1, S, M, m, o, sn, en, null, Ka)),
          xr());
      },
      i(S) {
        if (!w) {
          Ve(e.$$.fragment, S), Ve(n.$$.fragment, S);
          for (let z = 0; z < M.length; z += 1) Ve(u[z]);
          Ve(g.$$.fragment, S), (w = !0);
        }
      },
      o(S) {
        Ge(e.$$.fragment, S), Ge(n.$$.fragment, S);
        for (let z = 0; z < u.length; z += 1) Ge(u[z]);
        Ge(g.$$.fragment, S), (w = !1);
      },
      d(S) {
        S && (H(t), H(r)), z0(e, S), z0(n);
...
function u1(a, e, t) {
  ...
  var o =
    ...
    function (f, p, g, w) {
      ...
      return new (g || (g = Promise))(function (x, S) {
        function z(N) {
          try {
            A(w.next(N));
          } catch (I) {
        ...
        function A(N) {
          N.done ? x(N.value) : M(N.value).then(z, D);
        }
        A((w = w.apply(f, p || [])).next());
      });
    };
  ...
  return (
    bt(() =>
      o(void 0, void 0, void 0, function* () {
        ...
        t(0, (m = {}));
        for (const g of p) t(0, (m[g.full_name] = g.stargazers_count), m);
      }),
    ),
    (a.$$.update = () => {
      a.$$.dirty & 17 &&
        t(
          ...
          (i = [...n].sort((f, p) => {
            var g, w;
            const M =
              (g = m == null ? void 0 : m[u[f].repo]) !== null && g !== void 0
                ? g
                : 0;
            return (
