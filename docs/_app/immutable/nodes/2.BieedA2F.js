...
var Fi = (a, e, t) =>
  e in a
    ? $i(a, e, { enumerable: !0, configurable: !0, writable: !0, value: t })
    : (a[e] = t);
var he = (a, e, t) => (Fi(a, typeof e != "symbol" ? e + "" : e, t), t),
  Oi = (a, e, t) => {
...
var nt = (a, e, t) => (Oi(a, e, "access private method"), t);
import {
  s as T0,
  n as Fe,
  o as bt,
...
import { e as Je, u as sn, o as ln } from "../chunks/each.BoQ2FUBB.js";
import { p as Gi } from "../chunks/stores.DWJQ43d4.js";
var on = "Compute-Optimal Scaling for Value-Based Deep RL",
  un = "https://arxiv.org/abs/2508.14881",
  hn = new Date(175608e7),
  cn = !0,
  mn = "/assets/images/model_scaling_before.png",
  dn = "/assets/images/model_scaling_3d.mp4",
  fn = [
  ...
  pn = `[Preston Fu](https://www.prestonfu.com/)\\*,
...
var vn = "Value-Based Deep RL Scales Predictably",
  bn = "https://arxiv.org/abs/2502.04327",
  yn = new Date(17388e8),
  wn = !0,
  xn = "/assets/images/qscaled_before.png",
  kn = "/assets/images/qscaled_after.gif",
  Sn = [
  ...
  zn = `[Oleh Rybkin](https://olehrybkin.com/),
[Michal Nauman](https://scholar.google.com/citations?user=GnEVRtQAAAAJ&hl=en),
...
function Xi(a) {
  ...
  return (
    (document.title = e = a[0]),
    {
      ...
      l(s) {
        const o = Vi("svelte-1u7ey3", document.head);
      ...
      h() {
        q(t, "name", "description"),
          q(t, "content", a[2]),
          q(r, "property", "og:title"),
          q(r, "content", (n = a[1] ?? a[0])),
          q(i, "property", "og:description"),
          q(i, "content", a[2]);
      },
      m(s, o) {
...
class Zi extends A0 {
  constructor(e) {
    super(), D0(this, e, Wi, Xi, T0, { title: 0, ogTitle: 1, description: 2 });
  }
}
class Re {
  constructor(e, t, r) {
...
class $e {
  ...
  range(e, t) {
    return new $e(t, Re.range(this, e));
  }
}
class C {
  constructor(e, t) {
...
var Ji = function (e, t) {
  ...
  rs = /[&><"']/g;
function as(a) {
  return String(a).replace(rs, (e) => ts[e]);
}
var Tn = function a(e) {
  ...
  constructor(e) {
    ...
    for (var t in gt)
      if (gt.hasOwnProperty(t)) {
        var r = gt[t];
        this[t] =
          e[t] !== void 0 ? (r.processor ? r.processor(e[t]) : e[t]) : ls(r);
      }
  }
...
var Mr = 0,
  ...
  os = [Y0, Le, Y0, Le, N0, Te, N0, Te],
  us = [Le, Le, Le, Le, Te, Te, Te, Te],
  hs = [E0, a0, Y0, Le, N0, Te, N0, Te],
  cs = [a0, a0, Le, Le, Te, Te, Te, Te],
  ms = [wt, wt, a0, a0, Le, Le, Te, Te],
  ds = [Mr, wt, E0, a0, E0, a0, E0, a0],
  G = { DISPLAY: je[Mr], TEXT: je[E0], SCRIPT: je[Y0], SCRIPTSCRIPT: je[N0] },
  sr = [
    {
      name: "latin",
      blocks: [
...
function Tr(a, e, t) {
  ...
  var r = a.charCodeAt(0),
    n = Ye[e][r];
  if (
    (!n && a[0] in ra && ((r = ra[a[0]].charCodeAt(0)), (n = Ye[e][r])),
    !n && t === "text" && An(r) && (n = Ye[e][77]),
    n)
  )
...
var As = [
  ...
  aa = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
  na = function (e, t) {
    return t.size < 2 ? e : As[e - 1][t.size - 1];
  };
class r0 {
  constructor(e) {
    (this.style = void 0),
      ...
      (this.sizeMultiplier = aa[this.size - 1]),
  ...
  havingStyle(e) {
    return this.style === e
      ? this
      : this.extend({ style: e, size: na(this.textSize, e) });
  }
  havingCrampedStyle() {
  ...
  havingSize(e) {
    return this.size === e && this.textSize === e
      ...
      : this.extend({
          ...
          size: e,
          textSize: e,
          sizeMultiplier: aa[e - 1],
        });
  }
  havingBaseStyle(e) {
    e = e || this.style.text();
    var t = na(r0.BASESIZE, e);
  ...
  fontMetrics() {
    return (
      this._fontMetrics || (this._fontMetrics = Ts(this.size)),
      this._fontMetrics
    );
  }
  getColor() {
...
var lr = {
  ...
  Dn = function (e) {
    return (
      typeof e != "string" && (e = e.unit), e in lr || e in Ds || e === "ex"
    );
  },
  de = function (e, t) {
    var r;
  ...
  Cn = function (e) {
    ...
    for (var i in this.attributes)
      if (this.attributes.hasOwnProperty(i)) {
        if (_s.test(i)) throw new C("Invalid attribute name '" + i + "'");
...
class Oe {
  constructor(e, t, r, n, i, s, o, u) {
    (this.text = void 0),
      ...
      (this.style = u || {}),
      (this.maxFontSize = 0);
    var m = fs(this.text.charCodeAt(0));
    m && this.classes.push(m + "_fallback"),
      /[îïíì]/.test(this.text) && (this.text = Cs[this.text]);
  }
  hasClass(e) {
    return P.contains(this.classes, e);
  }
  ...
  toNode() {
    ...
    return (
      this.alternate
        ...
        : t.setAttribute("d", ta[this.pathName]),
      t
    );
  }
  toMarkup() {
    return this.alternate
      ...
      : '<path d="' + P.escape(ta[this.pathName]) + '"/>';
  }
}
class or {
  constructor(e) {
...
var Is = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
  Es = { "accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1 },
  ue = { math: {}, text: {} };
...
l(h, v, w, "®", "\\circledR");
l(A, v, w, "®", "\\circledR");
l(h, v, w, "∡", "\\measuredangle", !0);
l(h, v, w, "∄", "\\nexists");
l(h, v, w, "℧", "\\mho");
l(h, v, w, "Ⅎ", "\\Finv", !0);
l(h, v, w, "⅁", "\\Game", !0);
l(h, v, w, "‵", "\\backprime");
l(h, v, w, "▲", "\\blacktriangle");
l(h, v, w, "▼", "\\blacktriangledown");
l(h, v, w, "■", "\\blacksquare");
l(h, v, w, "⧫", "\\blacklozenge");
l(h, v, w, "★", "\\bigstar");
l(h, v, w, "∢", "\\sphericalangle", !0);
l(h, v, w, "∁", "\\complement", !0);
l(h, v, w, "ð", "\\eth", !0);
l(A, c, w, "ð", "ð");
l(h, v, w, "╱", "\\diagup");
l(h, v, w, "╲", "\\diagdown");
...
l(h, v, $, "⋒", "\\Cap", !0);
l(h, v, $, "⋓", "\\Cup", !0);
l(h, v, $, "⩞", "\\doublebarwedge", !0);
l(h, v, $, "⊟", "\\boxminus", !0);
l(h, v, $, "⊞", "\\boxplus", !0);
l(h, v, $, "⋇", "\\divideontimes", !0);
l(h, v, $, "⋉", "\\ltimes", !0);
l(h, v, $, "⋊", "\\rtimes", !0);
l(h, v, $, "⋋", "\\leftthreetimes", !0);
l(h, v, $, "⋌", "\\rightthreetimes", !0);
l(h, v, $, "⋏", "\\curlywedge", !0);
l(h, v, $, "⋎", "\\curlyvee", !0);
l(h, v, $, "⊝", "\\circleddash", !0);
l(h, v, $, "⊛", "\\circledast", !0);
...
l(h, c, qe, "{", "\\{");
l(A, c, w, "{", "\\{");
l(A, c, w, "{", "\\textbraceleft");
l(h, c, Ae, "}", "\\}");
l(A, c, w, "}", "\\}");
l(A, c, w, "}", "\\textbraceright");
l(h, c, qe, "{", "\\lbrace");
l(h, c, Ae, "}", "\\rbrace");
l(h, c, qe, "[", "\\lbrack", !0);
l(A, c, w, "[", "\\lbrack", !0);
...
l(h, c, w, "∥", "\\Vert");
l(A, c, w, "∥", "\\textbardbl");
l(A, c, w, "~", "\\textasciitilde");
l(A, c, w, "\\", "\\textbackslash");
l(A, c, w, "^", "\\textasciicircum");
l(h, c, b, "↑", "\\uparrow", !0);
l(h, c, b, "⇑", "\\Uparrow", !0);
l(h, c, b, "↓", "\\downarrow", !0);
l(h, c, b, "⇓", "\\Downarrow", !0);
...
l(A, c, w, "—", "\\textemdash");
l(A, c, w, "‘", "`", !0);
l(A, c, w, "‘", "\\textquoteleft");
l(A, c, w, "’", "'", !0);
l(A, c, w, "’", "\\textquoteright");
l(A, c, w, "“", "``", !0);
l(A, c, w, "“", "\\textquotedblleft");
l(A, c, w, "”", "''", !0);
l(A, c, w, "”", "\\textquotedblright");
l(h, c, w, "°", "\\degree", !0);
l(A, c, w, "°", "\\degree");
l(A, c, w, "°", "\\textdegree", !0);
l(h, c, w, "£", "\\pounds");
l(h, c, w, "£", "\\mathsterling", !0);
l(A, c, w, "£", "\\pounds");
l(A, c, w, "£", "\\textsterling", !0);
l(h, v, w, "✠", "\\maltese");
l(A, v, w, "✠", "\\maltese");
var sa = '0123456789/@."';
for (var Pt = 0; Pt < sa.length; Pt++) {
  var la = sa.charAt(Pt);
  l(h, c, w, la, la);
}
var oa = '0123456789!@*()-=+";:?/.,';
for (var Ut = 0; Ut < oa.length; Ut++) {
  var ua = oa.charAt(Ut);
  l(A, c, w, ua, ua);
}
...
for (var Me = 0; Me < xt.length; Me++) {
  var fe = xt.charAt(Me);
  (Y = String.fromCharCode(55349, 56320 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56372 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56424 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56580 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56684 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56736 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56788 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56840 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    (Y = String.fromCharCode(55349, 56944 + Me)),
    l(h, c, V, fe, Y),
    l(A, c, w, fe, Y),
    Me < 26 &&
      ((Y = String.fromCharCode(55349, 56632 + Me)),
      l(h, c, V, fe, Y),
      l(A, c, w, fe, Y),
      (Y = String.fromCharCode(55349, 56476 + Me)),
      l(h, c, V, fe, Y),
      l(A, c, w, fe, Y));
}
Y = "𝕜";
...
for (var y0 = 0; y0 < 10; y0++) {
  var m0 = y0.toString();
  (Y = String.fromCharCode(55349, 57294 + y0)),
    l(h, c, V, m0, Y),
    l(A, c, w, m0, Y),
    (Y = String.fromCharCode(55349, 57314 + y0)),
    l(h, c, V, m0, Y),
    l(A, c, w, m0, Y),
    (Y = String.fromCharCode(55349, 57324 + y0)),
    l(h, c, V, m0, Y),
    l(A, c, w, m0, Y),
    (Y = String.fromCharCode(55349, 57334 + y0)),
    l(h, c, V, m0, Y),
    l(A, c, w, m0, Y);
}
var ur = "ÐÞþ";
...
var ot = [
  ...
  $s = function (e, t, r) {
    var n = e.mode,
      ...
      m = "",
      f = "";
    if ((i.charCodeAt(0) === 55349 && ([m, f] = qs(i, n)), m.length > 0))
      return Ue(i, m, n, t, s.concat(f));
    if (u) {
      var p, g;
      if (u === "boldsymbol") {
        var y = Ls(i, n, t, s, r);
        (p = y.fontName), (g = [y.fontClass]);
      } else
        o
          ? ((p = qn[u].fontName), (g = [u]))
      ...
      if (Rn.hasOwnProperty(i) && p.slice(0, 10) === "Typewriter") {
        for (var k = [], x = 0; x < i.length; x++)
          k.push(Ue(i[x], p, n, t, s.concat(g)));
        return En(k);
      }
    }
    if (r === "mathord")
    ...
    if (r === "textord") {
      var z = ue[n][i] && ue[n][i].font;
      if (z === "ams") {
        var M = ut("amsrm", t.fontWeight, t.fontShape);
        return Ue(i, M, n, t, s.concat("amsrm", t.fontWeight, t.fontShape));
      } else if (z === "main" || !z) {
        var B = ut("textrm", t.fontWeight, t.fontShape);
        return Ue(i, B, n, t, s.concat(t.fontWeight, t.fontShape));
      } else {
        var T = ut(z, t.fontWeight, t.fontShape);
        return Ue(i, T, n, t, s.concat(T, t.fontWeight, t.fontShape));
      }
  ...
  Gs = function (e, t) {
    for (
      var { children: r, depth: n } = Vs(e), i = 0, s = 0;
      s < r.length;
      s++
    ) {
      var o = r[s];
    ...
    var m = De(["pstrut"], []);
    m.style.height = E(i);
    for (var f = [], p = n, g = n, y = n, k = 0; k < r.length; k++) {
      var x = r[k];
      if (x.type === "kern") y += x.size;
      else {
        var z = x.elem,
          M = x.wrapperClasses || [],
          B = x.wrapperStyle || {},
          T = De(M, [m, z], void 0, B);
        (T.style.top = E(-i - y - z.depth)),
          x.marginLeft && (T.style.marginLeft = x.marginLeft),
          x.marginRight && (T.style.marginRight = x.marginRight),
          f.push(T),
          (y += z.height + z.depth);
      }
      (p = Math.min(p, y)), (g = Math.max(g, y));
    }
    var _ = De(["vlist"], f);
    _.style.height = E(g);
    var R;
    if (p < 0) {
      var F = De([], []),
        j = De(["vlist"], [F]);
      j.style.height = E(-p);
      var Z = De(["vlist-s"], [new Oe("​")]);
      R = [De(["vlist-r"], [_, Z]), De(["vlist-r"], [j])];
    } else R = [De(["vlist-r"], [_])];
    var J = De(["vlist-t"], R);
    return (
      R.length === 2 && J.classes.push("vlist-t2"),
      (J.height = g),
      (J.depth = -p),
      J
    );
  ...
  js = (a, e) => {
    var t = De(["mspace"], [], e),
      r = de(a, e);
    return (t.style.marginRight = E(r)), t;
  },
  ut = function (e, t, r) {
    var n = "";
    switch (e) {
  ...
  Ys = function (e, t) {
    var [r, n, i] = Nn[e],
      ...
      u = In(["overlay"], [o], t);
    return (u.height = i), (u.style.height = E(i)), (u.style.width = E(n)), u;
  },
  S = {
    fontMap: qn,
    makeSymbol: Ue,
...
var zt = function (e) {
  ...
  s0 = S.makeSpan,
  Zs = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
  ...
  xe = function (e, t, r, n) {
    ...
    if ((S.tryCombineChars(i), !r)) return i;
    var m = t;
    if (e.length === 1) {
      var f = e[0];
      f.type === "sizing"
        ? (m = t.havingSize(f.size))
        : f.type === "styling" && (m = t.havingStyle(Qs[f.style]));
    }
    ...
    return (
      ca(
        ...
        (k, x) => {
          var z = x.classes[0],
            M = k.classes[0];
          z === "mbin" && P.contains(Js, M)
            ? (x.classes[0] = "mord")
            : M === "mbin" && P.contains(Zs, z) && (k.classes[0] = "mord");
        },
        { node: p },
        g,
        y,
      ...
      ca(
        ...
        (k, x) => {
          var z = hr(x),
            M = hr(k),
            B = z && M ? (k.hasClass("mtight") ? Ws[z][M] : Xs[z][M]) : null;
          if (B) return S.makeGlue(B, m);
        },
        { node: p },
        g,
        y,
  ...
  hr = function (e, t) {
    return e ? (t && (e = el(e, t)), Ks[e.classes[0]] || null) : null;
  },
  X0 = function (e, t) {
...
function ht(a, e) {
  var t = s0(["base"], a, e),
    r = s0(["strut"]);
  return (
    (r.style.height = E(t.height + t.depth)),
    t.depth && (r.style.verticalAlign = E(-t.depth)),
...
function cr(a, e) {
  ...
  if ((f.setAttribute("aria-hidden", "true"), m)) {
    var p = m.children[0];
    (p.style.height = E(f.height + f.depth)),
      f.depth && (p.style.verticalAlign = E(-f.depth));
  }
  return f;
}
function Fn(a) {
...
var D = { MathNode: Ee, TextNode: Xe, SpaceNode: tl, newDocumentFragment: Fn },
  He = function (e, t, r) {
    return (
      ue[t][e] &&
        ue[t][e].replace &&
  ...
  Br = function (e, t) {
    ...
    var s = S.fontMap[r].fontName;
    return Tr(i, s, n) ? S.fontMap[r].variant : null;
  };
function jt(a) {
  if (!a) return !1;
...
var On = function (e) {
  ...
  rl = function (e, t, r) {
    var n = On(r),
      i;
    if (r.output === "mathml") return ma(e, t, n, r.displayMode, !0);
    if (r.output === "html") {
      var s = cr(e, n);
      i = S.makeSpan(["katex"], [s]);
    } else {
      var o = ma(e, t, n, r.displayMode, !1),
        u = cr(e, n);
  ...
  il = function (e) {
    var t = new D.MathNode("mo", [new D.TextNode(nl[e.replace(/^\\/, "")])]);
      ...
      if (P.contains(["widehat", "widecheck", "widetilde", "utilde"], u)) {
        ...
        if (f > 5)
          u === "widehat" || u === "widecheck"
            ? ((p = 420), (o = 2364), (y = 0.42), (g = u + "4"))
            : ((p = 312), (o = 2340), (y = 0.34), (g = "tilde4"));
        else {
          var k = [1, 1, 2, 2, 3, 3][f];
          u === "widehat" || u === "widecheck"
            ? ((o = [0, 1062, 2364, 2364, 2364][k]),
              (p = [0, 239, 300, 360, 420][k]),
              (y = [0, 0.24, 0.3, 0.3, 0.36, 0.42][k]),
              (g = u + k))
            : ((o = [0, 600, 1033, 2339, 2340][k]),
              (p = [0, 260, 286, 306, 312][k]),
              (y = [0, 0.26, 0.286, 0.3, 0.306, 0.34][k]),
              (g = "tilde" + k));
        }
        var x = new p0(g),
          z = new i0([x], {
        ...
        return { span: S.makeSvgSpan([], [z], t), minWidth: 0, height: y };
      } else {
        var M = [],
          B = sl[u],
          [T, _, R] = B,
        ...
        if (j === 1) {
          ...
          (Z = ["halfarrow-left", "halfarrow-right"]),
            (J = ["xMinYMin", "xMaxYMin"]);
        else if (j === 3)
          (Z = ["brace-left", "brace-center", "brace-right"]),
        ...
        for (var N = 0; N < j; N++) {
          var O = new p0(T[N]),
            X = new i0([O], {
              ...
              height: E(F),
              viewBox: "0 0 " + o + " " + R,
              preserveAspectRatio: J[N] + " slice",
            }),
            I = S.makeSvgSpan([Z[N]], [X], t);
          if (j === 1) return { span: I, minWidth: _, height: F };
          (I.style.height = E(F)), M.push(I);
        }
        return { span: S.makeSpan(["stretchy"], M, t), minWidth: _, height: F };
      }
    }
  ...
  ul = function (e, t, r, n, i) {
    ...
    if (/fbox|color|angl/.test(t)) {
      if (((s = S.makeSpan(["stretchy", t], [], i)), t === "fbox")) {
      ...
      var f = new i0(m, { width: "100%", height: E(o) });
      s = S.makeSvgSpan([], [f], i);
    }
    return (s.height = o), (s.style.height = E(o)), s;
  },
  l0 = { encloseSpan: ul, mathMLnode: il, svgSpan: ol };
function Q(a, e) {
  if (!a || a.type !== e)
    throw new Error(
...
var Rr = (a, e) => {
    ...
    if (r.isStretchy)
      ...
      var y, k;
      r.label === "\\vec"
        ? ((y = S.staticSvg("vec", e)), (k = S.svgData.vec[1]))
        : ((y = S.makeOrd({ mode: r.mode, text: r.label }, e, "textord")),
          (y = ia(y)),
          (y.italic = 0),
          (k = y.width),
          f && (p += y.depth)),
        (g = S.makeSpan(["accent-body"], [y]));
    ...
    var M = S.makeSpan(["mord", "accent"], [g], e);
    return n
      ? ((n.children[0] = M),
  ...
  Pn = (a, e) => {
    var t = a.isStretchy
        ...
        : new D.MathNode("mo", [He(a.label, a.mode)]),
      r = new D.MathNode("mover", [oe(a.base, e), t]);
...
L({
  ...
  mathmlBuilder: (a, e) => {
    var t = l0.mathMLnode(a.label),
      r = new D.MathNode("munder", [oe(a.base, e), t]);
...
L({
  ...
  mathmlBuilder(a, e) {
    ...
    if (a.body) {
      ...
      } else r = new D.MathNode("mover", [t, n]);
    } else if (a.below) {
      var s = ct(oe(a.below, e));
      r = new D.MathNode("munder", [t, s]);
    } else (r = ct()), (r = new D.MathNode("mover", [t, r]));
    return r;
  },
});
var cl = S.makeSpan;
...
function Vn(a, e) {
  ...
  return (
    a.mclass === "minner"
      ? (t = new D.MathNode("mpadded", r))
      : a.mclass === "mord"
        ? a.isCharacterBox
          ? ((t = r[0]), (t.type = "mi"))
          : (t = new D.MathNode("mi", r))
        : (a.isCharacterBox
            ? ((t = r[0]), (t.type = "mo"))
            : (t = new D.MathNode("mo", r)),
          a.mclass === "mbin"
...
L({
  ...
  htmlBuilder(a, e) {
    var t = xe(a.body, e, !0),
      r = S.makeSpan([a.mclass], t, e);
    return (r.style.textShadow = "0.02em 0.01em 0.04px"), r;
  },
  mathmlBuilder(a, e) {
    var t = Ce(a.body, e),
      r = new D.MathNode("mstyle", t);
...
var ml = {
  ...
  da = () => ({ type: "styling", body: [], mode: "math", style: "display" }),
  fa = (a) => a.type === "textord" && a.text === "@",
  dl = (a, e) => (a.type === "mathord" || a.type === "atom") && a.text === e;
function fl(a, e, t) {
  var r = ml[a];
  switch (r) {
    case "\\\\cdrightarrow":
...
function pl(a) {
  ...
  for (
    ...
    if (t === "&" || t === "\\\\") a.consume();
      ...
      break;
    } else throw new C("Expected \\\\ or \\cr or \\end", a.nextToken);
  }
  for (var r = [], n = [r], i = 0; i < e.length; i++) {
    for (var s = e[i], o = da(), u = 0; u < s.length; u++)
      if (!fa(s[u])) o.body.push(s[u]);
      else {
        r.push(o), (u += 1);
        var m = Cr(s[u]).text,
          f = new Array(2);
        if (
          ...
          if ("<>AV".indexOf(m) > -1)
            for (var p = 0; p < 2; p++) {
              for (var g = !0, y = u + 1; y < s.length; y++) {
                if (dl(s[y], m)) {
                  (g = !1), (u = y);
                  break;
                }
          ...
          else throw new C('Expected one of "<>AV=|." after @', s[u]);
        var k = fl(m, f, a),
          x = { type: "styling", body: [k], mode: "math", style: "display" };
        r.push(x), (o = da());
      }
...
L({
  ...
  htmlBuilder(a, e) {
    var t = e.havingStyle(e.style.sup()),
      r = S.wrapFragment(ae(a.label, t, e), e);
    return (
      r.classes.push("cd-label-" + a.side),
      (r.style.bottom = E(0.8 - r.depth)),
      (r.height = 0),
      (r.depth = 0),
      r
    );
...
L({
  ...
  htmlBuilder(a, e) {
    var t = S.wrapFragment(ae(a.fragment, e), e);
...
L({
  ...
  handler(a, e) {
    for (
      var { parser: t } = a, r = Q(e[0], "ordgroup"), n = r.body, i = "", s = 0;
      s < n.length;
      s++
    ) {
      var o = Q(n[s], "textord");
    ...
    var u = parseInt(i),
      m;
    if (isNaN(u)) throw new C("\\@char has non-numeric argument " + i);
    if (u < 0 || u >= 1114111)
      throw new C("\\@char with invalid code point " + i);
    return (
      u <= 65535
  ...
  htmlBuilder(a, e) {
    ...
    return (
      a.newLine &&
        ...
        a.size && (t.style.marginTop = E(de(a.size, e)))),
      t
    );
  },
  mathmlBuilder(a, e) {
    ...
    return (
      a.newLine &&
        ...
        a.size && t.setAttribute("height", E(de(a.size, e)))),
      t
    );
  },
});
...
L({
  ...
  handler(a) {
    var { parser: e, funcName: t } = a,
      ...
      n = r.text;
    if (/^(?:[\\{}$&#^_]|EOF)$/.test(n))
      throw new C("Expected a control sequence", r);
    for (var i = 0, s, o = [[]]; e.gullet.future().text !== "{"; )
      if (((r = e.gullet.popToken()), r.text === "#")) {
        ...
        if (((r = e.gullet.popToken()), !/^[1-9]$/.test(r.text)))
          throw new C('Invalid argument number "' + r.text + '"');
        if (parseInt(r.text) !== i + 1)
          throw new C('Argument number "' + r.text + '" out of order');
        i++, o.push([]);
      } else {
        if (r.text === "EOF") throw new C("Expected a macro definition");
        o[i].push(r.text);
      }
...
L({
  ...
  handler(a) {
    var { parser: e, funcName: t } = a,
      r = Yn(e.gullet.popToken());
    e.gullet.consumeSpaces();
    var n = gl(e);
    return (
      Xn(e, r, n, t === "\\\\globallet"), { type: "internal", mode: e.mode }
    );
  },
});
L({
...
var H0 = function (e, t, r) {
  ...
  Ir = function (e, t, r, n) {
    var i = r.havingBaseStyle(t),
      s = S.makeSpan(n.concat(i.sizingClasses(r)), [e], r),
  ...
  vl = function (e, t, r, n, i, s) {
    var o = S.makeSymbol(e, "Main-Regular", i, n),
      u = Ir(o, t, n, s);
    return r && Wn(u, n, t), u;
  },
  bl = function (e, t, r, n) {
  ...
  Zn = function (e, t, r, n, i, s) {
    var o = bl(e, t, i, n),
      u = Ir(S.makeSpan(["delimsizing", "size" + t], [o], n), G.TEXT, n, s);
    return r && Wn(u, n, G.TEXT), u;
  },
  Yt = function (e, t, r) {
    var n;
  ...
  Xt = function (e, t, r) {
    var n = Ye["Size4-Regular"][e.charCodeAt(0)]
      ...
      i = new p0("inner", Ss(e, Math.round(1e3 * t))),
      s = new i0([i], {
        width: E(n),
        height: E(t),
        style: "width:" + E(n),
  ...
  Jn = function (e, t, r, n, i, s) {
    ...
    if (u !== null) {
      var F = H0(u, y, i);
      (_ = F.height + F.depth), (R = 2);
    }
    var j = x + T + _,
      Z = Math.max(0, Math.ceil((t - j) / (R * M))),
      J = j + Z * R * M,
    ...
    if (p.length > 0) {
      var X = J - x - T,
        I = Math.round(J * 1e3),
        U = zs(p, Math.round(X * 1e3)),
        ke = new p0(p, U),
        re = (g / 1e3).toFixed(3) + "em",
        se = (I / 1e3).toFixed(3) + "em",
        Se = new i0([ke], {
          width: re,
          height: se,
          viewBox: "0 0 " + g + " " + I,
        }),
        pe = S.makeSvgSpan([], [Se], n);
      (pe.height = I / 1e3),
        (pe.style.width = re),
        (pe.style.height = se),
        O.push({ type: "elem", elem: pe });
    } else {
      if ((O.push(Yt(f, y, i)), O.push(mt), u === null)) {
        var ze = J - x - T + 2 * dr;
        O.push(Xt(m, ze, n));
      } else {
        var ge = (J - x - T - _) / 2 + 2 * dr;
        O.push(Xt(m, ge, n)),
          O.push(mt),
          O.push(Yt(u, y, i)),
          O.push(mt),
      ...
      O.push(mt), O.push(Yt(o, y, i));
    }
    var ve = n.havingBaseStyle(G.TEXT),
      Ne = S.makeVList(
        { positionType: "bottom", positionData: N, children: O },
        ve,
      );
    return Ir(S.makeSpan(["delimsizing", "mult"], [Ne], ve), G.TEXT, n, s);
  },
  Wt = 80,
  Zt = 0.08,
  ...
  xl = function (e, t) {
    var r = t.havingBaseSizing(),
      n = ti("\\surd", e * r.sizeMultiplier, ei, r),
      i = r.sizeMultiplier,
  ...
  Sl = function (e, t, r, n, i) {
    if (
      (e === "<" || e === "\\lt" || e === "⟨"
        ? (e = "\\langle")
        : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle"),
      P.contains(Qn, e) || P.contains(Kn, e))
    )
      return Zn(e, t, !1, r, n, i);
    if (P.contains(kl, e)) return Jn(e, P0[t], !1, r, n, i);
  ...
  ri = function (e, t, r, n, i, s) {
    e === "<" || e === "\\lt" || e === "⟨"
      ? (e = "\\langle")
      : (e === ">" || e === "\\gt" || e === "⟩") && (e = "\\rangle");
    var o;
    P.contains(Kn, e) ? (o = zl) : P.contains(Qn, e) ? (o = ei) : (o = Ml);
    var u = ti(e, t, o, n);
    return u.type === "small"
      ? vl(e, u.style, r, n, i, s)
      : u.type === "large"
        ? Zn(e, u.size, r, n, i, s)
        : Jn(e, t, r, n, i, s);
  },
  Al = function (e, t, r, n, i, s) {
    var o = n.fontMetrics().axisHeight * n.sizeMultiplier,
      u = 901,
      m = 5 / n.fontMetrics().ptPerEm,
      f = Math.max(t - o, r + o),
      p = Math.max((f / 500) * u, 2 * f - m);
    return ri(e, p, !0, n, i, s);
  },
  n0 = {
    sqrtImage: xl,
    sizedDelim: Sl,
...
function It(a, e) {
  var t = Ct(a);
  if (t && P.contains(Dl, t.text)) return t;
  throw t
    ? new C("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", a)
    : new C("Invalid delimiter type '" + a.type + "'", a);
}
L({
  type: "delimsizing",
  names: [
  ...
  handler: (a, e) => {
    ...
    return {
      type: "delimsizing",
      mode: a.parser.mode,
      size: pa[a.funcName].size,
      mclass: pa[a.funcName].mclass,
      delim: t.text,
    };
  },
  htmlBuilder: (a, e) =>
  ...
  mathmlBuilder: (a) => {
    ...
    var r = E(n0.sizeToMaxHeight[a.size]);
...
L({
  ...
  mathmlBuilder: (a, e) => {
    ...
    var t = Ce(a.body, e);
    if (a.left !== ".") {
      var r = new D.MathNode("mo", [He(a.left, a.mode)]);
      r.setAttribute("fence", "true"), t.unshift(r);
    }
    if (a.right !== ".") {
      var n = new D.MathNode("mo", [He(a.right, a.mode)]);
...
L({
  ...
  handler: (a, e) => {
    ...
    if (!a.parser.leftrightDepth)
      throw new C("\\middle without preceding \\left", t);
...
var Er = (a, e) => {
    var t = S.wrapFragment(ae(a.body, e), e),
      r = a.label.slice(1),
      n = e.sizeMultiplier,
      i,
      s = 0,
    ...
    if (r === "sout")
      ...
      var g = Math.floor(1e3 * p * n),
        y = ws(g),
        k = new i0([new p0("phase", y)], {
          width: "400em",
          height: E(g / 1e3),
          viewBox: "0 0 400000 " + g,
          preserveAspectRatio: "xMinYMin slice",
        });
      (i = S.makeSvgSpan(["hide-tail"], [k], e)),
        (i.style.height = E(p)),
        (s = t.depth + u + m);
    } else {
      /cancel/.test(r)
      ...
      /box/.test(r)
        ? ((M = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
          (x = e.fontMetrics().fboxsep + (r === "colorbox" ? 0 : M)),
          (z = x))
        : r === "angl"
          ? ((M = Math.max(
            ...
            (x = 4 * M),
            (z = Math.max(0, 0.25 - t.depth)))
          : ((x = o ? 0.2 : 0), (z = x)),
        (i = l0.encloseSpan(t, r, x, z, e)),
        /fbox|boxed|fcolorbox/.test(r)
          ? ((i.style.borderStyle = "solid"), (i.style.borderWidth = E(M)))
          : r === "angl" &&
            M !== 0.049 &&
            ((i.style.borderTopWidth = E(M)),
            (i.style.borderRightWidth = E(M))),
        (s = t.depth + z),
        a.backgroundColor &&
      ...
      B = S.makeVList(
        {
          ...
          children: [
            { type: "elem", elem: t, shift: 0 },
            { type: "elem", elem: i, shift: s, wrapperClasses: T },
          ],
        },
        e,
      );
    ...
    return (
      /cancel/.test(r) && ((B.height = t.height), (B.depth = t.depth)),
      /cancel/.test(r) && !o
        ? S.makeSpan(["mord", "cancel-lap"], [B], e)
        : S.makeSpan(["mord"], [B], e)
    );
  },
  qr = (a, e) => {
...
var Et = (a) => {
  ...
  if (!e.displayMode)
    throw new C("{" + a.envName + "} can be used only in display mode.");
};
function Nr(a) {
...
function v0(a, e, t) {
  ...
  if (
    ...
    if (y == null) s = 1;
    else if (((s = parseFloat(y)), !s || s < 0))
      throw new C("Invalid \\arraystretch: " + y);
  }
  a.gullet.beginGroup();
  var k = [],
    x = [k],
  ...
  function _() {
    B &&
      (a.gullet.macros.get("\\df@tag")
        ? (B.push(a.subparse([new $e("\\df@tag")])),
          a.gullet.macros.set("\\df@tag", void 0, !0))
        : B.push(!!u && a.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (T(), M.push(va(a)); ; ) {
    var R = a.parseExpression(!1, m ? "\\end" : "\\\\");
    a.gullet.endGroup(),
      a.gullet.beginGroup(),
      (R = { type: "ordgroup", mode: a.mode, body: R }),
      t && (R = { type: "styling", mode: a.mode, style: t, body: [R] }),
      k.push(R);
    var F = a.fetch().text;
    if (F === "&") {
      if (p && k.length === p) {
        if (m || o) throw new C("Too many tab characters: &", a.nextToken);
      ...
      _(),
        k.length === 1 &&
          R.type === "styling" &&
          R.body[0].body.length === 0 &&
          (x.length > 1 || !f) &&
          x.pop(),
        M.length < x.length + 1 && M.push([]);
      break;
    } else if (F === "\\\\") {
      a.consume();
      var j = void 0;
      a.gullet.future().text !== " " && (j = a.parseSizeGroup(!0)),
        z.push(j ? j.value : null),
        _(),
        M.push(va(a)),
        (k = []),
        x.push(k),
        T();
    } else throw new C("Expected & or \\\\ or \\cr or \\end", a.nextToken);
  }
  return (
    a.gullet.endGroup(),
    a.gullet.endGroup(),
...
var Ke = function (e, t) {
    ...
    function _(rt) {
      for (var at = 0; at < rt.length; ++at)
        at > 0 && (T += 0.25), m.push({ pos: T, isDashed: rt[at] });
    }
    for (_(s[0]), r = 0; r < e.body.length; ++r) {
      var R = e.body[r],
        F = M,
        j = B;
      ...
      for (n = 0; n < R.length; ++n) {
        var J = ae(R[n], t);
        j < J.depth && (j = J.depth),
          F < J.height && (F = J.height),
          (Z[n] = J);
      }
      var K = e.rowGaps[r],
        N = 0;
      K && ((N = de(K, t)), N > 0 && ((N += B), j < N && (j = N), (N = 0))),
        e.addJot && (j += x),
        (Z.height = F),
        (Z.depth = j),
        (T += F),
    ...
    var O = T / 2 + t.fontMetrics().axisHeight,
      X = e.cols || [],
      I = [],
      U,
      ke,
    ...
    for (n = 0, ke = 0; n < o || ke < X.length; ++n, ++ke) {
      for (var ge = X[ke] || {}, ve = !0; ge.type === "separator"; ) {
        if (
          (ve ||
            ((U = S.makeSpan(["arraycolsep"], [])),
            (U.style.width = E(t.fontMetrics().doubleRuleSep)),
            I.push(U)),
          ge.separator === "|" || ge.separator === ":")
        ) {
          var Ne = ge.separator === "|" ? "solid" : "dashed",
            Pe = S.makeSpan(["vertical-separator"], [], t);
          (Pe.style.height = E(T)),
            (Pe.style.borderRightWidth = E(f)),
            (Pe.style.borderRightStyle = Ne),
            (Pe.style.margin = "0 " + E(-f / 2));
          var b0 = T - O;
          b0 && (Pe.style.verticalAlign = E(-b0)), I.push(Pe);
        } else throw new C("Invalid separator type: " + ge.separator);
        ke++, (ge = X[ke] || {}), (ve = !1);
      }
      if (!(n >= o)) {
        var u0 = void 0;
        ...
        for (r = 0; r < i; ++r) {
          ...
          if (tt) {
            ...
            (tt.depth = C0.depth),
              (tt.height = C0.height),
              h0.push({ type: "elem", elem: tt, shift: qi });
          }
        }
        (h0 = S.makeVList(
          ...
          (h0 = S.makeSpan(["col-align-" + (ge.align || "c")], [h0])),
          I.push(h0),
    ...
    if (((u = S.makeSpan(["mtable"], I)), m.length > 0)) {
      for (
        var Ni = S.makeLineSpan("hline", t, f),
          Li = S.makeLineSpan("hdashline", t, f),
          Lt = [{ type: "elem", elem: u, shift: 0 }];
        m.length > 0;
        ...
        var Jr = m.pop(),
          Qr = Jr.pos - O;
        Jr.isDashed
          ? Lt.push({ type: "elem", elem: Li, shift: Qr })
          : Lt.push({ type: "elem", elem: Ni, shift: Qr });
      }
      u = S.makeVList({ positionType: "individualShift", children: Lt }, t);
    }
    if (re.length === 0) return S.makeSpan(["mord"], [u], t);
    var $t = S.makeVList({ positionType: "individualShift", children: re }, t);
    return ($t = S.makeSpan(["tag"], [$t], t)), S.makeFragment([u, $t]);
  },
  _l = { c: "center ", l: "left ", r: "right " },
  e0 = function (e, t) {
    for (
      var r = [],
        n = new D.MathNode("mtd", [], ["mtr-glue"]),
      ...
      for (var o = e.body[s], u = [], m = 0; m < o.length; m++)
        u.push(new D.MathNode("mtd", [oe(o[m], t)]));
      e.tags &&
        e.tags[s] &&
        (u.unshift(n), u.push(n), e.leqno ? u.unshift(i) : u.push(i)),
        r.push(new D.MathNode("mtr", u));
    }
    var f = new D.MathNode("mtable", r),
      p =
        e.arraystretch === 0.5
          ? 0.1
          : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0);
    f.setAttribute("rowspacing", E(p));
    var g = "",
      y = "";
    if (e.cols && e.cols.length > 0) {
      var k = e.cols,
        ...
        M = 0,
        B = k.length;
      k[0].type === "separator" && ((g += "top "), (M = 1)),
        k[k.length - 1].type === "separator" && ((g += "bottom "), (B -= 1));
      for (var T = M; T < B; T++)
        k[T].type === "align"
          ? ((y += _l[k[T].align]), z && (x += "none "), (z = !0))
          : k[T].type === "separator" &&
            z &&
            ((x += k[T].separator === "|" ? "solid " : "dashed "), (z = !1));
      f.setAttribute("columnalign", y.trim()),
        /[sd]/.test(x) && f.setAttribute("columnlines", x.trim());
    }
    if (e.colSeparationType === "align") {
      for (var _ = e.cols || [], R = "", F = 1; F < _.length; F++)
        R += F % 2 ? "0em " : "1em ";
    ...
    var j = "",
      Z = e.hLinesBeforeRow;
    (g += Z[0].length > 0 ? "left " : ""),
      (g += Z[Z.length - 1].length > 0 ? "right " : "");
    for (var J = 1; J < Z.length - 1; J++)
      j += Z[J].length === 0 ? "none " : Z[J][0] ? "dashed " : "solid ";
    return (
      /[sd]/.test(j) && f.setAttribute("rowlines", j.trim()),
      g !== "" &&
        ((f = new D.MathNode("menclose", [f])),
        f.setAttribute("notation", g.trim())),
      e.arraystretch &&
        e.arraystretch < 1 &&
        ((f = new D.MathNode("mstyle", [f])),
  ...
  ii = function (e, t) {
    ...
    s.body.forEach(function (M) {
      for (var B = 1; B < M.length; B += 2) {
        var T = Q(M[B], "styling"),
          _ = Q(T.body[0], "ordgroup");
        _.body.unshift(m);
      }
      if (y) u < M.length && (u = M.length);
      else {
        var R = M.length / 2;
        if (o < R)
          throw new C(
            "Too many math in a row: " + ("expected " + o + ", but got " + R),
            M[0],
          );
      }
    });
    for (var k = 0; k < u; ++k) {
      var x = "r",
        z = 0;
      k % 2 === 1 ? (x = "l") : k > 0 && y && (z = 1),
        (r[k] = { type: "align", align: x, pregap: z, postgap: 0 });
    }
  ...
  handler(a, e) {
    var t = Ct(e[0]),
      ...
      n = r.map(function (s) {
        ...
        if (u === ":") return { type: "separator", separator: ":" };
        throw new C("Unknown column alignment: " + u, s);
      }),
      i = { cols: n, hskipBeforeAndAfter: !0, maxNumCols: n.length };
    return v0(a.parser, i, Lr(a.envName));
  },
  htmlBuilder: Ke,
  mathmlBuilder: e0,
});
Qe({
  ...
  handler(a) {
    ...
    var i = v0(a.parser, r, Lr(a.envName)),
...
L({
  ...
  handler(a, e) {
    throw new C(a.funcName + " valid only within array environment");
  },
});
var ba = ai;
L({
  ...
  handler(a, e) {
    var { parser: t, funcName: r } = a,
      n = e[0];
    if (n.type !== "ordgroup") throw new C("Invalid environment name", n);
    for (var i = "", s = 0; s < n.body.length; ++s)
      i += Q(n.body[s], "textord").text;
    if (r === "\\begin") {
      if (!ba.hasOwnProperty(i)) throw new C("No such environment: " + i, n);
      var o = ba[i],
      ...
      t.expect("\\end", !1);
      var g = t.nextToken,
        y = Q(t.parseFunction(), "environment");
      if (y.name !== i)
        throw new C(
...
var oi = (a, e) => {
  ...
  $r = (a, e) => {
    ...
    a.hasBarLine
      ? (a.barSize
          ? ((p = de(a.barSize, e)), (f = S.makeLineSpan("frac-line", e, p)))
          : (f = S.makeLineSpan("frac-line", e)),
        (p = f.height),
        (g = f.height))
    ...
    t.size === G.DISPLAY.size || a.size === "display"
      ...
      : (p > 0
          ? ((y = e.fontMetrics().num2), (k = g))
          : ((y = e.fontMetrics().num3), (k = 3 * g)),
        (x = e.fontMetrics().denom2));
    var z;
    if (f) {
      var B = e.fontMetrics().axisHeight;
      y - s.depth - (B + 0.5 * p) < k &&
        (y += k - (y - s.depth - (B + 0.5 * p))),
        B - 0.5 * p - (m.height - x) < k &&
          (x += k - (B - 0.5 * p - (m.height - x)));
      var T = -(B - 0.5 * p);
      z = S.makeVList(
        {
          positionType: "individualShift",
      ...
      var M = y - s.depth - (m.height - x);
      M < k && ((y += 0.5 * (k - M)), (x += 0.5 * (k - M))),
        (z = S.makeVList(
          {
            positionType: "individualShift",
            children: [
    ...
    (i = e.havingStyle(t)),
      (z.height *= i.sizeMultiplier / e.sizeMultiplier),
      (z.depth *= i.sizeMultiplier / e.sizeMultiplier);
    var _;
    t.size === G.DISPLAY.size
      ? (_ = e.fontMetrics().delim1)
      : t.size === G.SCRIPTSCRIPT.size
        ? (_ = e.havingStyle(G.SCRIPT).fontMetrics().delim2)
        : (_ = e.fontMetrics().delim2);
    var R, F;
    return (
      a.leftDelim == null
        ? (R = X0(e, ["mopen"]))
        : (R = n0.customSizedDelim(
            a.leftDelim,
            _,
            !0,
            e.havingStyle(t),
  ...
  Fr = (a, e) => {
    ...
    if (!a.hasBarLine) t.setAttribute("linethickness", "0px");
      ...
      t.setAttribute("linethickness", E(r));
    }
    var n = oi(a.size, e.style);
...
var wa = ["display", "text", "script", "scriptscript"],
  xa = function (e) {
    var t = null;
...
L({
  ...
  handler(a, e) {
    var { parser: t } = a,
      ...
      n = e[5],
      i = zt(e[0]),
      s = i.type === "atom" && i.family === "open" ? xa(i.text) : null,
      o = zt(e[1]),
      u = o.type === "atom" && o.family === "close" ? xa(o.text) : null,
      m = Q(e[2], "size"),
      f,
      p = null;
    ...
    } else (y = Q(y, "textord")), (g = wa[Number(y.text)]);
    return {
      type: "genfrac",
      mode: t.mode,
      numer: r,
...
L({
  ...
  mathmlBuilder(a, e) {
    return new D.MathNode("mrow", Ce(a.body, e));
  },
});
L({
  type: "html",
...
L({
  ...
  handler: (a, e, t) => {
    ...
    if (t[0])
      for (
        var u = Q(t[0], "raw").string, m = u.split(","), f = 0;
        f < m.length;
        f++
      ) {
        var p = m[f].split("=");
        if (p.length === 2) {
          ...
          switch (p[0].trim()) {
            ...
            case "totalheight":
              ...
              break;
            default:
              throw new C("Invalid key: '" + p[0] + "' in \\includegraphics.");
          }
        }
      }
    var y = Q(e[0], "url").url;
    return (
      ...
      r.settings.isTrusted({ command: "\\includegraphics", url: y })
        ? {
            type: "includegraphics",
            mode: r.mode,
            alt: o,
  ...
  htmlBuilder: (a, e) => {
    ...
    var i = { height: E(t + r) };
    n > 0 && (i.width = E(n)), r > 0 && (i.verticalAlign = E(-r));
    var s = new Bs(a.src, a.alt, i);
  ...
  mathmlBuilder: (a, e) => {
    ...
    if (
      (a.totalheight.number > 0 &&
        ((n = de(a.totalheight, e) - r), t.setAttribute("valign", E(-n))),
      t.setAttribute("height", E(r + n)),
      a.width.number > 0)
    ) {
      var i = de(a.width, e);
...
L({
  ...
  htmlBuilder: (a, e) => {
    var t;
    a.alignment === "clap"
      ? ((t = S.makeSpan([], [ae(a.body, e)])),
        (t = S.makeSpan(["inner"], [t], e)))
      : (t = S.makeSpan(["inner"], [ae(a.body, e)]));
    var r = S.makeSpan(["fix"], []),
      n = S.makeSpan([a.alignment], [t, r], e),
      i = S.makeSpan(["strut"]);
    return (
      (i.style.height = E(n.height + n.depth)),
      n.depth && (i.style.verticalAlign = E(-n.depth)),
      n.children.unshift(i),
      (n = S.makeSpan(["thinbox"], [n], e)),
      S.makeSpan(["mord", "vbox"], [n], e)
    );
  },
  mathmlBuilder: (a, e) => {
...
L({
  ...
  props: { numArgs: 0, allowedInText: !0, allowedInMath: !1 },
  handler(a, e) {
    throw new C("Mismatched " + a.funcName);
  },
});
var ka = (a, e) => {
  switch (e.style.size) {
...
var hi = (a, e, t, r, n, i, s) => {
    ...
    var z = [g];
    if (u && i !== 0 && !o) {
      var M = S.makeSpan(["mspace"], [], r);
      (M.style.marginRight = E(i)), z.unshift(M);
    }
    return S.makeSpan(["mop", "op-limits"], z, r);
  },
  ci = ["\\smallint"],
  F0 = (a, e) => {
    var t,
      ...
      i;
    a.type === "supsub"
      ? ((t = a.sup), (r = a.sub), (i = Q(a.base, "op")), (n = !0))
      : (i = Q(a, "op"));
    var s = e.style,
      o = !1;
    s.size === G.DISPLAY.size &&
      i.symbol &&
      !P.contains(ci, i.name) &&
      (o = !0);
    var u;
    if (i.symbol) {
      ...
      var y = xe(i.body, e, !0);
      y.length === 1 && y[0] instanceof Oe
        ? ((u = y[0]), (u.classes[0] = "mop"))
        : (u = S.makeSpan(["mop"], y, e));
    } else {
      for (var k = [], x = 1; x < i.name.length; x++)
        k.push(S.mathsym(i.name[x], i.mode, e));
      u = S.makeSpan(["mop"], k, e);
    }
    var z = 0,
      M = 0;
    return (
      (u instanceof Oe || i.name === "\\oiint" || i.name === "\\oiiint") &&
        !i.suppressBaseShift &&
        ((z = (u.height - u.depth) / 2 - e.fontMetrics().axisHeight),
        (M = u.italic)),
      n
        ? hi(u, t, r, e, s, M, z)
        : (z && ((u.style.position = "relative"), (u.style.top = E(z))), u)
    );
  },
  Q0 = (a, e) => {
    var t;
...
var mi = (a, e) => {
    var t,
      ...
      i;
    a.type === "supsub"
      ? ((t = a.sup), (r = a.sub), (i = Q(a.base, "operatorname")), (n = !0))
      : (i = Q(a, "operatorname"));
    var s;
    if (i.body.length > 0) {
      for (
      ...
      s = S.makeSpan(["mop"], u, e);
    } else s = S.makeSpan(["mop"], [], e);
    return n ? hi(s, t, r, e, e.style, 0, 0) : s;
  },
  Il = (a, e) => {
    for (
      ...
      if (!(i instanceof D.SpaceNode))
        if (i instanceof D.MathNode)
          switch (i.type) {
            ...
            case "mo": {
              var s = i.children[0];
              i.children.length === 1 && s instanceof D.TextNode
                ? (s.text = s.text
                    .replace(/\u2212/, "-")
                    .replace(/\u2217/, "*"))
                : (r = !1);
    ...
    var m = new D.MathNode("mo", [He("⁡", "text")]);
...
_0({
  ...
  htmlBuilder(a, e) {
    return a.semisimple
      ? S.makeFragment(xe(a.body, e, !1))
      : S.makeSpan(["mord"], xe(a.body, e, !0), e);
  },
  mathmlBuilder(a, e) {
...
L({
  ...
  htmlBuilder(a, e) {
    var t = ae(a.body, e.havingCrampedStyle()),
      r = S.makeLineSpan("overline-line", e),
...
L({
  ...
  htmlBuilder: (a, e) => {
    var t = S.makeSpan([], [ae(a.body, e.withPhantom())]);
  ...
  mathmlBuilder: (a, e) => {
    var t = Ce(be(a.body), e),
      r = new D.MathNode("mphantom", t),
      n = new D.MathNode("mpadded", [r]);
...
L({
  ...
  htmlBuilder: (a, e) => {
    var t = S.makeSpan(["inner"], [ae(a.body, e.withPhantom())]),
      r = S.makeSpan(["fix"], []);
...
L({
  ...
  htmlBuilder(a, e) {
    ...
    return (
      (t.style.borderRightWidth = E(r)),
      (t.style.borderTopWidth = E(n)),
      (t.style.bottom = E(i)),
      (t.width = r),
      (t.height = n + i),
      (t.depth = -i),
  ...
  mathmlBuilder(a, e) {
    var t = de(a.width, e),
      ...
      s = new D.MathNode("mspace");
    s.setAttribute("mathbackground", i),
      s.setAttribute("width", E(t)),
      s.setAttribute("height", E(r));
    var o = new D.MathNode("mpadded", [s]);
    return (
      n >= 0
        ? o.setAttribute("height", E(n))
        : (o.setAttribute("height", E(n)), o.setAttribute("depth", E(-n))),
      o.setAttribute("voffset", E(n)),
      o
    );
  },
});
...
L({
  ...
  handler: (a, e) => {
    ...
    return { type: "sizing", mode: n.mode, size: Sa.indexOf(r) + 1, body: i };
  },
  htmlBuilder: El,
  mathmlBuilder: (a, e) => {
    var t = e.havingSize(a.size),
      r = Ce(a.body, t),
      n = new D.MathNode("mstyle", r);
    return n.setAttribute("mathsize", E(t.sizeMultiplier)), n;
  },
});
L({
  type: "smash",
...
L({
  ...
  htmlBuilder(a, e) {
    ...
    if (a.index) {
      var k = e.havingStyle(G.SCRIPTSCRIPT),
        x = ae(a.index, k, e),
        z = 0.6 * (y.height - y.depth),
        M = S.makeVList(
          {
            positionType: "shift",
            positionData: -z,
        ...
        B = S.makeSpan(["root"], [M]);
      return S.makeSpan(["mord", "sqrt"], [B, y], e);
    } else return S.makeSpan(["mord", "sqrt"], [y], e);
  },
  mathmlBuilder(a, e) {
    var { body: t, index: r } = a;
    return r
      ? new D.MathNode("mroot", [oe(t, e), oe(r, e)])
      : new D.MathNode("msqrt", [oe(t, e)]);
  },
});
var za = {
  display: G.DISPLAY,
...
L({
  ...
  htmlBuilder(a, e) {
    ...
    return di(a.body, r, e);
  },
  mathmlBuilder(a, e) {
    var t = za[a.style],
      r = e.havingStyle(t),
      n = Ce(a.body, r),
      i = new D.MathNode("mstyle", n),
      s = {
        display: ["0", "true"],
        text: ["0", "false"],
        script: ["1", "false"],
...
var ql = function (e, t) {
  ...
  if (r)
    if (r.type === "op") {
      ...
      if (r.type === "accent") return P.isCharacterBox(r.base) ? Rr : null;
      if (r.type === "horizBrace") {
        var s = !e.sub;
        return s === r.isOver ? ui : null;
      } else return null;
    }
  else return null;
};
_0({
  ...
  htmlBuilder(a, e) {
    ...
    if (i) {
      ...
      (u = ae(i, k, e)),
        g ||
          (p =
            s.depth +
            (k.fontMetrics().subDrop * k.sizeMultiplier) / e.sizeMultiplier);
    }
    var x;
    e.style === G.DISPLAY
      ? (x = m.sup1)
    ...
    if (u) {
      ...
      (s instanceof Oe || T) && (B = E(-s.italic));
    }
    var _;
    if (o && u) {
      (f = Math.max(f, x, o.depth + 0.25 * m.xHeight)),
        (p = Math.max(p, m.sub2));
      var R = m.defaultRuleThickness,
        F = 4 * R;
      if (f - o.depth - (u.height - p) < F) {
        p = F - (f - o.depth) + u.height;
        var j = 0.8 * m.xHeight - (f - o.depth);
        j > 0 && ((f += j), (p -= j));
      }
      var Z = [
        { type: "elem", elem: u, shift: p, marginRight: M, marginLeft: B },
        { type: "elem", elem: o, shift: -f, marginRight: M },
      ];
      _ = S.makeVList({ positionType: "individualShift", children: Z }, e);
    } else if (u) {
      p = Math.max(p, m.sub1, u.height - 0.8 * m.xHeight);
      var J = [{ type: "elem", elem: u, marginLeft: B, marginRight: M }];
      _ = S.makeVList(
        ...
        (_ = S.makeVList(
          {
            positionType: "shift",
            positionData: -f,
            children: [{ type: "elem", elem: o, marginRight: M }],
          },
          e,
        ));
    else throw new Error("supsub must have either sup or sub.");
    var K = hr(s, "right") || "mord";
    return S.makeSpan([K], [s, S.makeSpan(["msupsub"], [_])], e);
  },
  mathmlBuilder(a, e) {
    var t = !1,
      r,
...
_0({
  ...
  mathmlBuilder(a, e) {
    var t = new D.MathNode("mo", [He(a.text, a.mode)]);
    if (a.family === "bin") {
      var r = Br(a, e);
...
_0({
  ...
  mathmlBuilder(a, e) {
    var t = new D.MathNode("mi", [He(a.text, a.mode, e)]),
      r = Br(a, e) || "italic";
    return r !== fi[t.type] && t.setAttribute("mathvariant", r), t;
  },
});
_0({
  type: "textord",
  ...
  mathmlBuilder(a, e) {
    ...
    return (
      a.mode === "text"
        ...
        : /[0-9]/.test(a.text)
          ? (n = new D.MathNode("mn", [t]))
          : a.text === "\\prime"
            ? (n = new D.MathNode("mo", [t]))
            : (n = new D.MathNode("mi", [t])),
      r !== fi[n.type] && n.setAttribute("mathvariant", r),
      n
    );
  },
});
  ...
  htmlBuilder(a, e) {
    if (er.hasOwnProperty(a.text)) {
      ...
      if (Kt.hasOwnProperty(a.text))
        return S.makeSpan(["mspace", Kt[a.text]], [], e);
      throw new C('Unknown type of space "' + a.text + '"');
    }
  },
  mathmlBuilder(a, e) {
    var t;
    if (er.hasOwnProperty(a.text))
      ...
      if (Kt.hasOwnProperty(a.text)) return new D.MathNode("mspace");
      throw new C('Unknown type of space "' + a.text + '"');
    }
    return t;
  },
...
_0({
  ...
  mathmlBuilder(a, e) {
    var t = new D.MathNode("mtable", [
      new D.MathNode("mtr", [
        Ma(),
        new D.MathNode("mtd", [g0(a.body, e)]),
        Ma(),
        new D.MathNode("mtd", [g0(a.tag, e)]),
      ]),
    ]);
...
var Ta = {
  ...
  Da = (a, e) => {
    var t = a.font;
    if (t) {
      if (Ta[t]) return e.withTextFontFamily(Ta[t]);
      if (Aa[t]) return e.withTextFontWeight(Aa[t]);
      if (t === "\\emph")
...
L({
  ...
  htmlBuilder(a, e) {
    var t = ae(a.body, e),
      r = S.makeLineSpan("underline-line", e),
      n = e.fontMetrics().defaultRuleThickness,
      i = S.makeVList(
        {
          positionType: "top",
...
L({
  ...
  htmlBuilder(a, e) {
    for (
      var t = _a(a), r = [], n = e.havingStyle(e.style.text()), i = 0;
      i < t.length;
      i++
    ) {
      var s = t[i];
      s === "~" && (s = "\\textasciitilde"),
        r.push(
          S.makeSymbol(s, "Typewriter-Regular", a.mode, n, ["mord", "texttt"]),
        );
    }
    return S.makeSpan(
  ...
  mathmlBuilder(a, e) {
    var t = new D.TextNode(_a(a)),
      r = new D.MathNode("mtext", [t]);
    return r.setAttribute("mathvariant", "monospace"), r;
  },
});
var _a = (a) => a.body.replace(/ /g, a.star ? "␣" : " "),
  d0 = Ln,
  pi = `[ \r
	]`,
  Ll = "\\\\[a-zA-Z@]+",
...
class Ba {
  constructor(e, t) {
    (this.input = void 0),
      ...
      (this.input = e),
      (this.settings = t),
      (this.tokenRegex = new RegExp(Pl, "g")),
      (this.catcodes = { "%": 14, "~": 13 });
  }
  setCatcode(e, t) {
    this.catcodes[e] = t;
  ...
  lex() {
    ...
    if (t === e.length) return new $e("EOF", new Re(this, t, t));
    var r = this.tokenRegex.exec(e);
    if (r === null || r.index !== t)
      throw new C(
        "Unexpected character: '" + e[t] + "'",
        new $e(e[t], new Re(this, t, t + 1)),
      );
    var n = r[6] || r[3] || (r[2] ? "\\ " : " ");
...
`,
    ...
    return new $e(n, new Re(this, t, this.tokenRegex.lastIndex));
  }
}
class Ul {
  constructor(e, t) {
...
d("\\char", function (a) {
  ...
  if (e.text === "'") (t = 8), (e = a.popToken());
    ...
    if (((e = a.popToken()), e.text[0] === "\\")) r = e.text.charCodeAt(1);
      ...
      if (e.text === "EOF") throw new C("\\char` missing argument");
...
var Or = (a, e, t, r) => {
  ...
  if (((n = a.consumeArg().tokens), n.length === 1 && n[0].text === "[")) {
    ...
    if (!u.match(/^\s*[0-9]+\s*$/))
      throw new C("Invalid number of arguments: " + u);
    (o = parseInt(u)), (n = a.consumeArg().tokens);
  }
  return (s && r) || a.macros.set(i, { tokens: n, numArgs: o }), "";
};
d("\\newcommand", (a) => Or(a, !1, !0, !1));
d("\\renewcommand", (a) => Or(a, !0, !1, !1));
d("\\providecommand", (a) => Or(a, !0, !0, !0));
d("\\message", (a) => {
...
d("\\tag@literal", (a) => {
  if (a.macros.get("\\df@tag")) throw new C("Multiple \\tag");
...
var gi = E(Ye["Main-Regular"][84][1] - 0.7 * Ye["Main-Regular"][65][1]);
d(
  "\\LaTeX",
  "\\textrm{\\html@mathml{" +
    ("L\\kern-.36em\\raisebox{" + gi + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{LaTeX}}",
);
d(
  "\\KaTeX",
  "\\textrm{\\html@mathml{" +
    ("K\\kern-.17em\\raisebox{" + gi + "}{\\scriptstyle A}") +
    "\\kern-.15em\\TeX}{KaTeX}}",
);
...
var vi = (a) => (e) => {
  ...
  var u = (p) => (g) => {
    ...
    if (!p && n.length) {
      var k = g.future();
      k.text === "|" && (g.popToken(), (y = !0));
    }
    return { tokens: y ? n : r, numArgs: 0 };
  };
...
class Gl {
  constructor(e, t, r) {
    (this.settings = void 0),
      ...
      this.feed(e),
      (this.macros = new Ul(Vl, t.macros)),
      (this.mode = r),
      (this.stack = []);
  }
  feed(e) {
  ...
  scanArgument(e) {
    ...
    return (
      this.pushToken(new $e("EOF", r.loc)), this.pushTokens(n), t.range(r, "")
    );
  }
  consumeSpaces() {
    for (;;) {
  ...
  consumeArgs(e, t) {
    if (t) {
      ...
      for (var r = t[0], n = 0; n < r.length; n++) {
        var i = this.popToken();
        if (r[n] !== i.text)
          throw new C("Use of the macro doesn't match its definition", i);
      }
    }
    for (var s = [], o = 0; o < e; o++)
  ...
  expandOnce(e) {
    ...
    if (n.numArgs) {
      ...
      for (var o = i.length - 1; o >= 0; --o) {
        ...
        if (u.text === "#") {
          if (o === 0)
            throw new C("Incomplete placeholder at end of macro body", u);
          if (((u = i[--o]), u.text === "#")) i.splice(o + 1, 1);
          else if (/^[1-9]$/.test(u.text)) i.splice(o, 2, ...s[+u.text - 1]);
          else throw new C("Not a valid argument number", u);
        }
      }
    }
  ...
  expandMacro(e) {
    return this.macros.has(e) ? this.expandTokens([new $e(e)]) : void 0;
  }
  expandTokens(e) {
    var t = [],
      r = this.stack.length;
    ...
    if (typeof n == "string") {
      ...
      if (n.indexOf("#") !== -1)
        for (var s = n.replace(/##/g, ""); s.indexOf("#" + (i + 1)) !== -1; )
          ++i;
      for (
        var o = new Ba(n, this.settings), u = [], m = o.lex();
        m.text !== "EOF";
...
class qt {
  constructor(e, t) {
    (this.mode = void 0),
      ...
      (this.mode = "math"),
      (this.gullet = new Gl(e, t, this.mode)),
      (this.settings = t),
  ...
  parseExpression(e, t) {
    for (var r = []; ; ) {
      ...
      var n = this.fetch();
      if (
        qt.endOfExpression.indexOf(n.text) !== -1 ||
        (t && n.text === t) ||
  ...
  handleInfixNodes(e) {
    for (var t = -1, r, n = 0; n < e.length; n++)
      if (e[n].type === "infix") {
        if (t !== -1)
          throw new C("only one infix operator per group", e[n].token);
  ...
  handleSupSubscript(e) {
    ...
    if (!n) throw new C("Expected group after '" + r + "'", t);
    return n;
  }
  ...
  parseAtom(e) {
    ...
    for (var r, n; ; ) {
      ...
      if (i.text === "\\limits" || i.text === "\\nolimits") {
        ...
        if (r) throw new C("Double superscript", i);
        r = this.handleSupSubscript("superscript");
      } else if (i.text === "_") {
        if (n) throw new C("Double subscript", i);
        ...
        var m = Ia.test(i.text),
          f = [];
        for (f.push(new $e(dt[i.text])), this.consume(); ; ) {
          var p = this.fetch().text;
          if (!dt[p] || Ia.test(p) !== m) break;
          f.unshift(new $e(dt[p])), this.consume();
        }
  ...
  parseFunction(e, t) {
    ...
    if (this.mode === "text" && !i.allowedInText)
      throw new C("Can't use function '" + n + "' in text mode", r);
    if (this.mode === "math" && i.allowedInMath === !1)
      throw new C("Can't use function '" + n + "' in math mode", r);
  ...
  parseGroupOfType(e, t, r) {
    switch (t) {
      ...
      case "primitive": {
        ...
        if (s == null) throw new C("Expected group as " + e, this.fetch());
        return s;
      }
      case "original":
      case null:
  ...
  parseRegexGroup(e, t) {
    ...
    if (i === "") throw new C("Invalid " + t + ": '" + r.text + "'", r);
    return r.range(n, i);
  }
  parseColorGroup(e) {
  ...
  parseSizeGroup(e) {
    ...
    if (!n) throw new C("Invalid size: '" + t.text + "'", t);
    var i = { number: +(n[1] + n[2]), unit: n[3] };
    if (!Dn(i)) throw new C("Invalid unit: '" + i.unit + "'", t);
  ...
  parseGroup(e, t) {
    ...
    if (n === "{" || n === "\\begingroup") {
      ...
      i == null && n[0] === "\\" && !bi.hasOwnProperty(n))
    ) {
      if (this.settings.throwOnError)
        throw new C("Undefined control sequence: " + n, r);
  ...
  parseSymbol() {
    ...
    if ((this.consume(), i))
      for (var p = 0; p < i[0].length; p++) {
        var g = i[0][p];
        if (!tr[g]) throw new C("Unknown accent ' " + g + "'", e);
        var y = tr[g][this.mode] || tr[g].text;
        if (!y)
          throw new C(
...
qt.endOfExpression = ["}", "\\endgroup", "\\end", "\\right", "&"];
var Pr = function (e, t) {
...
var jl = function (e, t) {
  ...
  wi = function (e, t, r) {
    ...
    var n = S.makeSpan(["katex-error"], [new Oe(t)]);
    return (
...
const ki = /[&<>"']/,
  ...
  Si = /[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,
  Kl = new RegExp(Si.source, "g"),
  eo = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  qa = (a) => eo[a];
function Ie(a, e) {
  if (e) {
    if (ki.test(a)) return a.replace(Ql, qa);
  } else if (Si.test(a)) return a.replace(Kl, qa);
  return a;
}
...
function le(a, e) {
  ...
  const r = {
    replace: (n, i) => {
      ...
      return (s = s.replace(ao, "$1")), (t = t.replace(n, s)), r;
    },
...
`),
          ...
          const M = new RegExp(
            ...
            T = new RegExp(`^ {0,${Math.min(3, y - 1)}}(?:\`\`\`|~~~)`),
            _ = new RegExp(`^ {0,${Math.min(3, y - 1)}}#`);
          for (; e; ) {
            const R = e.split(
              `
`,
            ...
            if (
              ...
              this.options.pedantic &&
                (g = g.replace(/^ {1,4}(?=( {4})*[^ ])/g, "  ")),
              T.test(g) || _.test(g) || M.test(g) || B.test(e))
            )
              break;
...
`),
      ...
      for (let f = 0; f < i.items.length; f++)
        if (
          ...
          const p = i.items[f].tokens.filter((y) => y.type === "space"),
...
const so = /^(?: *(?:\n|$))+/,
  ...
  Wr = {
    ...
    del: U0,
    emStrongLDelim: ko,
    emStrongRDelimAst: So,
    emStrongRDelimUnd: zo,
    escape: Ai,
    link: _o,
    nolink: Bi,
    punctuation: wo,
  ...
  Ro = {
    ...pr,
    br: le(Di).replace("{2,}", "*").getRegex(),
    text: le(pr.text)
      .replace("\\b_", "\\b_| {2,}\\n")
      .replace(/\{2,\}/g, "*")
      .getRegex(),
  },
  pt = { normal: Xr, gfm: go, pedantic: vo },
  O0 = { normal: Wr, gfm: pr, breaks: Ro, pedantic: Co };
class We {
  constructor(e) {
    he(this, "tokens");
    he(this, "options");
      ...
      switch (i.type) {
        ...
        case "heading": {
          ...
          r += this.renderer.heading(
            ...
            s.depth,
            ro(this.parseInline(s.tokens, this.textRenderer)),
          );
          continue;
        }
        case "code": {
        ...
        case "list": {
          ...
          for (let p = 0; p < s.items.length; p++) {
            ...
            let x = "";
            if (g.task) {
              const z = this.renderer.checkbox(!!y);
              m
                ? g.tokens.length > 0 && g.tokens[0].type === "paragraph"
                  ? ((g.tokens[0].text = z + " " + g.tokens[0].text),
                    g.tokens[0].tokens &&
                      g.tokens[0].tokens.length > 0 &&
                      g.tokens[0].tokens[0].type === "text" &&
                      (g.tokens[0].tokens[0].text =
                        z + " " + g.tokens[0].tokens[0].text))
                  : g.tokens.unshift({ type: "text", text: z + " " })
                : (x += z + " ");
            }
            (x += this.parse(g.tokens, m)),
              (f += this.renderer.listitem(x, k, !!y));
          }
  ...
  (gr = function (e, t) {
    return (r, n) => {
      ...
      this.defaults.async === !0 &&
        ...
        (s.async = !0));
      const o = nt(this, Dt, Ci).call(this, !!s.silent, !!s.async);
...
ie.options = ie.setOptions = function (a) {
  return M0.setOptions(a), (ie.defaults = M0.defaults), xi(ie.defaults), ie;
};
ie.getDefaults = Vr;
ie.defaults = B0;
ie.use = function (...a) {
  return M0.use(...a), (ie.defaults = M0.defaults), xi(ie.defaults), ie;
};
...
(function (a) {
  (function () {
    ...
    function n(x, z, M) {
      ...
      function Z(K, N, O, X) {
        for (
          var I = "", U = null, ke = !1, re = K.length, se = !1, Se = 0;
          Se < re;
          Se++
        ) {
          ...
          if (ke === !0) {
            ...
            switch (pe) {
              ...
              case 65:
                ...
                break;
              case 66:
                I += O.months[N.getMonth()];
                break;
              case 67:
                I += i(Math.floor(N.getFullYear() / 100), U);
                break;
              case 68:
                I += Z(O.formats.D, N, O, X);
                break;
              case 70:
                I += Z(O.formats.F, N, O, X);
                break;
              case 72:
                I += i(N.getHours(), U);
                break;
              case 73:
                ...
                break;
              case 76:
                I += s(Math.floor(X % 1e3));
                break;
              case 77:
                I += i(N.getMinutes(), U);
                break;
              case 80:
                I += N.getHours() < 12 ? O.am : O.pm;
                break;
              case 82:
                I += Z(O.formats.R, N, O, X);
                break;
              case 83:
                I += i(N.getSeconds(), U);
                break;
              case 84:
                I += Z(O.formats.T, N, O, X);
                break;
              case 85:
                I += i(u(N, "sunday"), U);
                break;
              ...
              case 90:
                ...
                break;
              case 97:
                I += O.shortDays[N.getDay()];
                break;
              case 98:
                I += O.shortMonths[N.getMonth()];
                break;
              case 99:
                I += Z(O.formats.c, N, O, X);
                break;
              case 100:
                I += i(N.getDate(), U);
                break;
              ...
              case 104:
                ...
                break;
              case 106:
                var ge = new Date(N.getFullYear(), 0, 1),
                  ve = Math.ceil(
                    (N.getTime() - ge.getTime()) / (1e3 * 60 * 60 * 24),
                  );
                I += s(ve);
                break;
              case 107:
...
`;
              ...
              case 111:
                var ve = N.getDate();
                O.ordinalSuffixes
                  ? (I += String(ve) + (O.ordinalSuffixes[ve - 1] || m(ve)))
                  : (I += String(ve) + m(ve));
                break;
              case 112:
                I += N.getHours() < 12 ? O.AM : O.PM;
              ...
              case 120:
                ...
                break;
              case 121:
                let C0 = N.getFullYear() % 100;
                I += i(C0, U);
                break;
              case 122:
                if (_ && T === 0) I += se ? "+00:00" : "+0000";
                else {
                  var Ne;
                  T !== 0
                    ? (Ne = T / (60 * 1e3))
                    : (Ne = -N.getTimezoneOffset());
                  var Pe = Ne < 0 ? "-" : "+",
                    b0 = se ? ":" : "",
                    u0 = Math.floor(Math.abs(Ne / 60)),
                    h0 = Math.abs(Ne % 60);
                  I += Pe + i(u0) + b0 + i(h0);
                }
                break;
      ...
      var J = j;
      return (
        (J.localize = function (K) {
          return new n(K || B, T, _);
        }),
        (J.localizeByIdentifier = function (K) {
          var N = e[K];
          return N
            ? J.localize(N)
            : (k('[WARNING] No locale found with identifier "' + K + '".'), J);
        }),
        (J.timezone = function (K) {
          var N = T,
            O = _,
            X = typeof K;
    ...
    function u(x, z) {
      ...
      var M = x.getDay();
      z === "monday" && (M === 0 ? (M = 6) : M--);
      var B = Date.UTC(x.getFullYear(), 0, 1),
        T = Date.UTC(x.getFullYear(), x.getMonth(), x.getDate()),
        _ = Math.floor((T - B) / 864e5),
        R = (_ + 7 - M) / 7;
      return Math.floor(R);
    }
    function m(x) {
      var z = x % 10,
        M = x % 100;
      if ((M >= 11 && M <= 13) || z === 0 || z >= 4) return "th";
      switch (z) {
        case 1:
          return "st";
        case 2:
    ...
    function g(x, z) {
      ...
      var M = x
        .toLocaleString(z, { timeZoneName: "short" })
        .match(/\s([\w]+)$/);
      return M && M[1];
    }
    function y(x) {
      var z = x.toString().match(/\(([\w\s]+)\)/);
      return z && z[1];
    }
    function k(x) {
      typeof console < "u" &&
  ...
  return {
    ...
    l(u) {
      ...
      (t = te(m, "SPAN", { class: !0, "data-svelte-h": !0 })),
        nn(t) !== "svelte-a7fxhe" && (t.textContent = r),
        (n = j0(m, " Our paper: ")),
        (i = te(m, "EM", {}));
      var f = ne(i);
...
function Fo(a, e, t) {
  ...
  const i = Object.entries(
    Object.assign({
      "../../projects/model_scaling.md": gn,
      "../../projects/utd_scaling.md": Mn,
    }),
  ).reduce((u, [m, f]) => {
    const p = vr(m) || m;
  ...
  return {
    ...
    l(u) {
      ...
      (t = te(m, "DIV", { class: !0, "data-svelte-h": !0 })),
        nn(t) !== "svelte-8vdxxn" && (t.textContent = r),
        (n = Be(m)),
        (i = te(m, "DIV", { class: !0 }));
      var f = ne(i);
      s = te(f, "DIV", { class: !0 });
      var p = ne(s);
      (o = wr(p, !1)), p.forEach(H), f.forEach(H), m.forEach(H), this.h();
    },
    h() {
      q(
        t,
        ...
        (o.a = null),
        q(s, "class", "md-output"),
        q(i, "class", "prose max-w-none mt-1"),
        q(
          e,
          "class",
...
class Uo extends A0 {
  constructor(e) {
    super(), D0(this, e, Po, Ho, T0, { html: 0 });
  }
}
function Ha(a, e, t) {
  const r = a.slice();
  return (r[7] = e[t]), (r[9] = t), r;
}
function Vo(a) {
  let e,
    t,
  ...
  return {
    c() {
      (e = ee("div")), (t = new yr(!1)), this.h();
    },
    l(n) {
      e = te(n, "DIV", { class: !0 });
      var i = ne(e);
      (t = wr(i, !1)), i.forEach(H), this.h();
    },
    h() {
      (t.a = null), q(e, "class", "md-output text-sm sm-block svelte-2uty9x");
    },
    m(n, i) {
      we(n, e, i), t.m(r, e);
    },
    p(n, i) {
      i & 2 && r !== (r = L0(n[7].content) + "") && t.p(r);
    },
    i: Fe,
    o: Fe,
    d(n) {
...
function Go(a) {
  let e, t;
  return (
    (e = new Uo({ props: { html: L0(a[7].content) } })),
    {
      c() {
        x0(e.$$.fragment);
      },
      ...
      p(r, n) {
        const i = {};
        n & 2 && (i.html = L0(r[7].content)), e.$set(i);
      },
      i(r) {
...
function jo(a) {
  let e, t;
  return (
    (e = new Oo({ props: { id: a[7].id, label: a[7].label } })),
    {
      c() {
        x0(e.$$.fragment);
      },
      ...
      p(r, n) {
        const i = {};
        n & 2 && (i.id = r[7].id), n & 2 && (i.label = r[7].label), e.$set(i);
      },
      i(r) {
        t || (Ve(e.$$.fragment, r), (t = !0));
      },
...
function Yo(a) {
  ...
  return {
    ...
    h() {
      (t.a = null), q(e, "class", "md-output svelte-2uty9x");
    },
    m(n, i) {
      we(n, e, i), t.m(r, e);
    },
...
function Xo(a) {
  ...
  return {
    ...
    h() {
      q(e, "class", "md-output space-y-6 svelte-2uty9x");
    },
    m(o, u) {
      we(o, e, u);
    ...
    p(o, [u]) {
      u & 2 &&
        ((i = Je(o[1])),
        xr(),
        (t = sn(t, u, s, 1, o, i, r, e, ln, Pa, null, Ha)),
        kr());
    },
    i(o) {
      if (!n) {
...
function Ii(a, e) {
  try {
    return Jl.renderToString(a, { throwOnError: !1, displayMode: e });
  } catch {
    const r = e ? "pre" : "code";
...
const Wo = {
    ...
    renderer: (a) => `<div class="math math-block">${Ii(a.text, !0)}</div>`,
  },
  Zo = {
    name: "mathInline",
    level: "inline",
    ...
    renderer: (a) => `<span class="math math-inline">${Ii(a.text, !1)}</span>`,
  },
  Jo = {
    link(a, e, t) {
...
const Qo = {
  ...
  renderer(a) {
    ...
    if (e || t) {
      ...
      r += `<video class="block mx-auto autoplay-on-fullview md-video unselectable" aria-label="${a.alt || ""}" id="fig-${br(a.alt || "")}"`;
      ...
      r += `<img src="${a.src}" alt="${a.alt}" id="fig-${br(a.alt)}" class="block mx-auto unselectable"`;
...
ie.use({ gfm: !0, extensions: [Qo, Wo, Zo], renderer: Jo });
const rr = /:::jumpbox\s+id="([^"]+)"(?:\s+label="([^"]+)")?\s*:::/gm,
  Ua = /:::takeaway_begin:::/gm,
  ar = /:::takeaway_end:::/gm,
  Ko = /:::small_begin:::/gm,
  nr = /:::small_end:::/gm;
function L0(a) {
...
function e1(a, e, t) {
  ...
  var n =
    ...
    function (f, p, g, y) {
      ...
      return new (g || (g = Promise))(function (x, z) {
        function M(_) {
          try {
            T(y.next(_));
          } catch (R) {
        ...
        function T(_) {
          _.done ? x(_.value) : k(_.value).then(M, B);
        }
        T((y = y.apply(f, p || [])).next());
      });
    };
  let { source: i } = e,
    s = null;
  function o(f) {
    const g = Array.from(
      f.querySelectorAll("video.autoplay-on-fullview"),
    ).filter((k) => !k.dataset._wired);
    if (g.length === 0) return;
    for (const k of g) {
      (k.controls = !1), (k.dataset._wired = "1");
      let x = !1;
      const z = () => {
        (x = !0), window.removeEventListener("touchstart", z);
      };
      window.addEventListener("touchstart", z, { passive: !0, once: !0 });
      const M = () => {
          x || (k.controls = !0);
        },
        B = () => {
      ...
      k.addEventListener("mouseenter", M),
        ...
        k.addEventListener("focus", M),
        k.addEventListener("blur", B);
      let T = null;
      const _ = () => {
          T !== null && (window.clearTimeout(T), (T = null));
        },
        R = () => {
          const F = parseInt(k.dataset.freezeMs || "10000", 10);
          _(),
            (T = window.setTimeout(() => {
              try {
                k.currentTime = 0;
              ...
              const j = k.play();
              j && typeof j.catch == "function" && j.catch(() => {});
            }, F));
        };
      ["play", "pause", "seeking", "emptied", "abort"].map((F) =>
        k.addEventListener(F, _),
      ),
        k.addEventListener("ended", R),
        (k._cleanupVideo = () => {
          k.removeEventListener("mouseenter", M),
            k.removeEventListener("mouseleave", B),
            k.removeEventListener("focus", M),
            k.removeEventListener("blur", B),
            k.removeEventListener("ended", R),
            _();
        });
    }
    if (!o._io) {
      const k = new IntersectionObserver(
        (x) => {
          for (const z of x) {
            const M = z.target,
              B = M._clearRestartTimer;
            if ((B && B(), z.intersectionRatio >= 1)) {
              const T = M.play();
    ...
    const y = o._io;
    g.forEach((k) => y.observe(k));
  }
  function u(f) {
    const p = Array.from(f.querySelectorAll("pre > code"));
    for (const g of p) {
      const y = g.parentElement;
      if (!y || y.dataset.copyable) continue;
      (y.dataset.copyable = "true"), (y.style.position = "relative");
      const k = document.createElement("button");
      (k.textContent = "Copy"),
        (k.className = "copy-btn"),
        k.addEventListener("click", () =>
          n(this, void 0, void 0, function* () {
            try {
              yield navigator.clipboard.writeText(g.innerText),
                (k.textContent = "Copied!"),
                setTimeout(() => (k.textContent = "Copy"), 1500);
            } catch {
              (k.textContent = "Error"),
                setTimeout(() => (k.textContent = "Copy"), 1500);
            }
  ...
  bt(() => {
    ...
    rn(() => {
      ...
      const f = o._io;
      s &&
        s.querySelectorAll("video.autoplay-on-fullview").forEach((p) => {
          f.unobserve(p);
          const g = p._cleanupVideo;
          g && g();
        });
    });
  function m(f) {
      ...
      a.$$.dirty & 4 &&
        t(
          ...
          (r = (() => {
            ...
            let g = 0;
            for (; g < i.length; ) {
              (rr.lastIndex = g), (Ua.lastIndex = g);
              const y = rr.exec(i),
                k = Ua.exec(i),
                x = Ko.exec(i);
              if (!y && !k && !x) {
                g < i.length && p.push({ type: "text", content: i.slice(g) });
                break;
              }
              const z = y ? y.index : 1 / 0,
                M = k ? k.index : 1 / 0,
                B = x ? x.index : 1 / 0;
              if (z <= M && z <= B) {
                z > g && p.push({ type: "text", content: i.slice(g, z) });
                const T = y[1],
                  _ = (f = y[2]) !== null && f !== void 0 ? f : T;
                p.push({ type: "jumpbox", id: T, label: _ }),
                  (g = rr.lastIndex);
              } else if (M <= z && M <= B) {
                const T = k.index,
                  _ = T + k[0].length;
                T > g && p.push({ type: "text", content: i.slice(g, T) }),
                  (ar.lastIndex = _);
                const R = ar.exec(i);
                if (!R) {
                  p.push({ type: "text", content: i.slice(T, _) }), (g = _);
                  continue;
                }
                const F = i.slice(_, R.index).trim();
                p.push({ type: "takeaway", content: F }), (g = ar.lastIndex);
              } else {
                const T = x.index,
                  _ = T + x[0].length;
                T > g && p.push({ type: "text", content: i.slice(g, T) }),
                ...
                const F = i.slice(_, R.index).trim();
                p.push({ type: "small", content: F }), (g = nr.lastIndex);
              }
            }
            return p;
          })()),
...
class Ei extends A0 {
  constructor(e) {
    super(), D0(this, e, e1, Xo, T0, { source: 2 });
  }
}
function Va(a, e, t) {
  const r = a.slice();
...
function Ga(a) {
  let e,
    t = Je(a[0]),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = ja(Va(a, t, n));
  return {
    c() {
    ...
    p(n, i) {
      if (i & 37) {
        ...
        for (s = 0; s < t.length; s += 1) {
          ...
          r[s]
            ? r[s].p(o, i)
            : ((r[s] = ja(o)), r[s].c(), r[s].m(e.parentNode, e));
        }
  ...
  return {
    ...
    h() {
      q(e, "href", (t = `#${a[16].id}`)),
        ...
        q(e, "style", (n = `top: calc(${a[5](a[16]) * 100}% - 1px);`)),
        q(e, "aria-label", (i = a[16].label)),
        q(e, "data-label", (s = a[16].label));
    },
    m(o, u) {
      we(o, e, u);
    },
    p(o, u) {
      u & 1 && t !== (t = `#${o[16].id}`) && q(e, "href", t),
        u & 5 &&
          r !==
            (r =
              Kr(
        ...
        u & 1 &&
          ...
          q(e, "style", n),
        u & 1 && i !== (i = o[16].label) && q(e, "aria-label", i),
        u & 1 && s !== (s = o[16].label) && q(e, "data-label", s);
    },
    d(o) {
      o && H(e);
    },
...
function t1(a) {
  ...
  return {
    ...
    h() {
      q(r, "class", "gradient svelte-lifq7d"),
        q(
          r,
          "style",
          (n = a[4] ? `clip-path: inset(0 0 ${100 - a[1] * 100}% 0);` : ""),
        ),
        q(t, "class", "track svelte-lifq7d"),
        q(e, "class", "scroll-meter svelte-lifq7d"),
        q(e, "aria-hidden", "true"),
        yt(e, "ready", a[3]);
    },
    m(o, u) {
...
function a1(a, e, t) {
  ...
  function g(T) {
    ...
    return window.scrollY + _.top;
  }
  function y() {
    u = document.querySelector(r);
    const T = u ? u.querySelectorAll(n) : document.querySelectorAll(n);
    t(
      0,
      (i = Array.from(T)
        .filter((_) => r1(_))
  ...
  function k() {
    ...
    if (u) {
      const F = g(u),
        j = Math.max(u.getBoundingClientRect().height - window.innerHeight, 1);
      t(1, (s = Math.min(1, Math.max(0, (T - F) / j))));
    } else {
      const j = Math.max(
        document.documentElement.scrollHeight - window.innerHeight,
        1,
      );
      t(1, (s = Math.min(1, Math.max(0, (T - 0) / j))));
    }
    const _ = window.scrollY + 8;
    let R = -1;
    for (let F = 0; F < i.length && i[F].top <= _; F++) R = F;
    t(2, (o = R));
  }
  function x(T) {
    if (!u) {
      const j = document.documentElement,
        Z = Math.max(j.scrollHeight - 0, 1);
      return Math.min(1, Math.max(0, T.top / Z));
    }
    const _ = g(u),
      R = u.getBoundingClientRect().height,
      F = _ + R;
    return Math.min(1, Math.max(0, (T.top - _) / Math.max(F - _, 1)));
  }
  let z,
    M,
    B = null;
  return (
    bt(() => {
      if (
        ...
        T && ((B = new ResizeObserver(() => y())), B.observe(T));
      }
    }),
    rn(() => {
    ...
    (a.$$set = (T) => {
      "containerSelector" in T && t(6, (r = T.containerSelector)),
        "headingsSelector" in T && t(7, (n = T.headingsSelector));
    }),
    [i, s, o, m, p, x, r, n]
  );
}
class n1 extends A0 {
  constructor(e) {
    super(),
      D0(this, e, a1, t1, T0, { containerSelector: 6, headingsSelector: 7 });
  }
}
function Ya(a, e, t) {
  const r = a.slice();
...
function Wa(a) {
  ...
  return {
    ...
    h() {
      q0(t.src, (r = a[0].image_after)) || q(t, "src", r),
        q(t, "type", "video/mp4"),
        q(
          e,
          "class",
        ...
        q(e, "preload", "metadata"),
        (e.muted = !0),
        (e.loop = !0),
        (e.playsInline = !0),
        q(e, "aria-hidden", "true"),
        q(e, "tabindex", "-1"),
        q(e, "poster", (n = a[0].image_before));
    },
    m(i, s) {
      we(i, e, s), W(e, t), a[8](e);
    },
    p(i, s) {
      s & 1 && !q0(t.src, (r = i[0].image_after)) && q(t, "src", r),
        s & 2 && Ot(e, "opacity", i[1] ? 1 : 0),
        s & 1 && n !== (n = i[0].image_before) && q(e, "poster", n);
    },
    d(i) {
      i && H(e), a[8](null);
    },
...
function Za(a) {
  let e,
    t = Je(a[0].resources),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = Ja(Xa(a, t, n));
  return {
    c() {
      e = ee("div");
      for (let n = 0; n < r.length; n += 1) r[n].c();
    ...
    h() {
      q(e, "class", "flex flex-wrap gap-2");
    },
    m(n, i) {
      we(n, e, i);
    ...
    p(n, i) {
      if (i & 1) {
        ...
        for (s = 0; s < t.length; s += 1) {
          const o = Xa(n, t, s);
          r[s] ? r[s].p(o, i) : ((r[s] = Ja(o)), r[s].c(), r[s].m(e, null));
        }
        for (; s < r.length; s += 1) r[s].d(1);
        r.length = t.length;
      }
...
function Qa(a) {
  let e,
    t = Je(a[0].subimages),
    r = [];
  for (let n = 0; n < t.length; n += 1) r[n] = Ka(Ya(a, t, n));
  return {
    c() {
      e = ee("div");
      for (let n = 0; n < r.length; n += 1) r[n].c();
    ...
    h() {
      q(e, "class", "grid grid-cols-3 gap-4 md:gap-8 lg:gap-12 mt-4");
    },
    m(n, i) {
      we(n, e, i);
      for (let s = 0; s < r.length; s += 1) r[s] && r[s].m(e, null);
    ...
    p(n, i) {
      if (i & 1) {
        ...
        for (s = 0; s < t.length; s += 1) {
          const o = Ya(n, t, s);
          r[s] ? r[s].p(o, i) : ((r[s] = Ka(o)), r[s].c(), r[s].m(e, null));
        }
        for (; s < r.length; s += 1) r[s].d(1);
        r.length = t.length;
      }
...
function Ka(a) {
  ...
  return {
    ...
    h() {
      q0(t.src, (r = a[13])) || q(t, "src", r),
        q(t, "alt", (n = a[0].title + " subimage")),
        q(e, "class", "col-span-full md:col-span-1");
    },
    m(s, o) {
      we(s, e, o), W(e, t), W(e, i);
    },
    p(s, o) {
      o & 1 && !q0(t.src, (r = s[13])) && q(t, "src", r),
        o & 1 && n !== (n = s[0].title + " subimage") && q(t, "alt", n);
    },
    d(s) {
      s && H(e);
    },
...
function i1(a) {
  ...
  let e,
    ...
    O,
    X = a[2] && Wa(a);
  F = new Ei({ props: { source: a[0].content } });
  let I = ((ke = a[0].resources) == null ? void 0 : ke.length) && Za(a),
    U = a[0].subimages && Qa(a);
  return {
    c() {
      (e = ee("div")),
        (t = ee("div")),
    ...
    h() {
      q0(i.src, (s = a[4])) || q(i, "src", s),
        q(i, "alt", (o = a[0].title + " preview image")),
        q(i, "class", "w-full block"),
        yt(i, "border", a[0].image_border),
        q(n, "class", "relative w-full max-w-80 mx-auto"),
        q(r, "class", "col-span-4 md:col-span-1"),
        q(g, "class", "link-no-underline mr-1"),
        q(g, "href", (x = a[0].link)),
        q(g, "target", "_blank"),
        q(
          M,
        ...
        q(p, "class", "text-black text-lg font-semibold mb-2 no-meter"),
        q(R, "class", "text-sm reduced-spacing"),
        q(f, "class", "col-span-4 md:col-span-3"),
        q(t, "class", "grid grid-cols-4 gap-4"),
        q(e, "role", "group"),
        q(
          e,
          "class",
    ...
    m(re, se) {
      we(re, e, se),
        ...
        (K = !0),
        N ||
          ((O = [ea(e, "mouseenter", a[9]), ea(e, "mouseleave", a[10])]),
          (N = !0));
    },
    p(re, [se]) {
      var pe;
      (!K || (se & 16 && !q0(i.src, (s = re[4])))) && q(i, "src", s),
        ...
        re[2]
          ? X
            ? X.p(re, se)
            : ((X = Wa(re)), X.c(), X.m(n, null))
          : X && (X.d(1), (X = null)),
        (!K || se & 1) && y !== (y = re[0].title + "") && ir(k, y),
        (!K || (se & 1 && x !== (x = re[0].link))) && q(g, "href", x),
        (!K || se & 1) && B !== (B = Oa("%B %Y", re[0].date) + "") && ir(T, B);
      const Se = {};
      se & 1 && (Se.source = re[0].content),
        ...
        (pe = re[0].resources) != null && pe.length
          ? I
            ? I.p(re, se)
            : ((I = Za(re)), I.c(), I.m(f, null))
          : I && (I.d(1), (I = null)),
        re[0].subimages
          ? U
            ? U.p(re, se)
            : ((U = Qa(re)), U.c(), U.m(e, null))
          : U && (U.d(1), (U = null)),
        (!K ||
          (se & 1 &&
            J !==
    ...
    i(re) {
      K || (Ve(F.$$.fragment, re), (K = !0));
    },
    o(re) {
      Ge(F.$$.fragment, re), (K = !1);
    },
    d(re) {
      re && H(e), X && X.d(), z0(F), I && I.d(), U && U.d(), (N = !1), Pi(O);
    },
  };
}
function s1(a, e, t) {
  ...
  return (
    (a.$$set = (k) => {
      "data" in k && t(0, (i = k.data)), "stars" in k && t(6, (s = k.stars));
    }),
    (a.$$.update = () => {
      a.$$.dirty & 129 &&
        t(
    ...
    [i, o, u, m, r, f, s, n, p, g, y]
  );
}
class l1 extends A0 {
  constructor(e) {
    super(), D0(this, e, s1, i1, T0, { data: 0, stars: 6 });
  }
}
const o1 = `In the era of large-scale AI, it is important to prototype new training methodologies at small scales before running at large scales or datasets. This workflow only works if the training outcomes are predictable — we need experimentation workflows for which results at small scale can reliably forecast behavior at large scale without running the full experiment. To build predictable workflows, the community has followed the path of estimating _scaling laws_: rules that fit the target performance metric as a function of resources (e.g., data, compute) available to the practitioner under the “right” design decisions for setting up training. Scaling laws can then inform practitioners how to most reliably obtain performance at scale. For example, [prior](https://arxiv.org/abs/2203.03466) [work](https://arxiv.org/abs/2001.08361) establishes that it is possible to estimate the best batch size and model width and depth from small-scale runs, and leverages this predictability to predict the best configuration for an extrapolated model size. _Can we build similar workflows for reinforcement learning (RL) algorithms?_ In this blog post, we explore whether we can derive scaling laws for online RL algorithms.
...
function tn(a, e) {
  let t, r, n, i, s;
  return (
    (r = new l1({ props: { data: e[3][e[7]], stars: e[0] } })),
    {
      key: a,
      first: null,
      c() {
...
function u1(a) {
  ...
  (e = new Zi({
    ...
    (n = new n1({ props: { containerSelector: "#article .md-output" } }));
  let k = Je(a[2]);
  const x = (z) => z[7];
    ...
    (g = new Ei({ props: { source: o1 } })),
    {
      c() {
        x0(e.$$.fragment),
          ...
          (s = ee("div")),
          (o = ee("div"));
        for (let z = 0; z < u.length; z += 1) u[z].c();
        (f = _e()), (p = ee("div")), x0(g.$$.fragment), this.h();
      },
      l(z) {
        k0(e.$$.fragment, z), (t = Be(z)), (r = te(z, "DIV", {}));
        var M = ne(r);
        k0(n.$$.fragment, M), (i = Be(M)), (s = te(M, "DIV", { class: !0 }));
        var B = ne(s);
        o = te(B, "DIV", { class: !0 });
        var T = ne(o);
        for (let R = 0; R < u.length; R += 1) u[R].l(T);
        T.forEach(H),
          B.forEach(H),
          (f = Be(M)),
          (p = te(M, "DIV", { class: !0 }));
        var _ = ne(p);
        k0(g.$$.fragment, _), _.forEach(H), M.forEach(H), this.h();
      },
      h() {
        q(o, "class", "space-y-2"),
          q(s, "class", "layout-md text-lg space-y-12"),
          q(p, "class", "layout-md text-lg space-y-12");
      },
      m(z, M) {
        S0(e, z, M),
          we(z, t, M),
          ...
          W(r, s),
          W(s, o);
        for (let B = 0; B < u.length; B += 1) u[B] && u[B].m(o, null);
        W(r, f), W(r, p), S0(g, p, null), (y = !0);
      },
      p(z, [M]) {
        M & 15 &&
          ((k = Je(z[2])),
          xr(),
          (u = sn(u, M, x, 1, z, k, m, o, ln, tn, null, en)),
          kr());
      },
      i(z) {
        if (!y) {
          Ve(e.$$.fragment, z), Ve(n.$$.fragment, z);
          for (let M = 0; M < k.length; M += 1) Ve(u[M]);
          Ve(g.$$.fragment, z), (y = !0);
        }
      },
      o(z) {
        Ge(e.$$.fragment, z), Ge(n.$$.fragment, z);
        for (let M = 0; M < u.length; M += 1) Ge(u[M]);
        Ge(g.$$.fragment, z), (y = !1);
      },
      d(z) {
        z && (H(t), H(r)), z0(e, z), z0(n);
        for (let M = 0; M < u.length; M += 1) u[M].d();
        z0(g);
      },
    }
  );
          ...
          (i = [...n].sort((f, p) => {
            ...
            const k =
              (g = m == null ? void 0 : m[u[f].repo]) !== null && g !== void 0
                ...
                : 0;
            return (
              ((y = m == null ? void 0 : m[u[p].repo]) !== null && y !== void 0
                ? y
                : 0) - k
            );
          })),
